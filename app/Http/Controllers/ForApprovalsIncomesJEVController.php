...
class ForApprovalsIncomesJEVController extends Controller
{   
    ...
    public function __construct(
        ...
        $this->carbon = $carbon;
        $this->slugs = 'for-approvals/journal-entries/incomes';
    }
    ...
    {   
        ...
        $data = '';
        return view('for-approvals.journal-entries.incomes.index')->with(compact('data'));
    }
    ...
    {           
        ...
        $result = $this->acctgAccountVoucherRepository->approval_docListItems($request, Auth::user()->id, 0);
    ...
    public function print(Request $request, $voucher)
    {
        ...
        if ($request->get('type') == 'payables') {
            $prepBy  = $res->payables_prepared->fullname;
            $prepDes = $res->payables_prepared->designation->description;
            $appBy   = $res->payables_approved->fullname;
            $appDes  = $res->payables_approved->designation->description;
        } else if ($request->get('type') == 'cash') {
            $prepBy  = $res->cash_prepared->fullname;
            $prepDes = $res->cash_prepared->designation->description;
            $appBy   = $res->cash_approved->fullname;
            $appDes  = $res->cash_approved->designation->description;
        } else if ($request->get('type') == 'cheque') {
            $prepBy  = $res->cheque_prepared->fullname;
            $prepDes = $res->cheque_prepared->designation->description;
            $appBy   = $res->cheque_approved->fullname;
            $appDes  = $res->cheque_approved->designation->description;
        } else if ($request->get('type') == 'collection') {
            $prepBy  = $res->collections_prepared->fullname;
            $prepDes = $res->collections_prepared->designation->description;
            $appBy   = $res->collections_approved->fullname;
            $appDes  = $res->collections_approved->designation->description;
        } else {
            $prepBy  = $res->others_prepared->fullname;
            $prepDes = $res->others_prepared->designation->description;
            $appBy   = $res->others_approved->fullname;
            $appDes  = $res->others_approved->designation->description;
        }
