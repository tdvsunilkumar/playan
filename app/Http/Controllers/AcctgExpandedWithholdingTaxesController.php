...
class AcctgExpandedWithholdingTaxesController extends Controller
{
    private AcctgExpandedWithholdingTaxesInterface $AcctgExpandedWithholdingTaxesRepository;
    private $carbon;
    private $slugs;

    public function __construct(AcctgExpandedWithholdingTaxesInterface $AcctgExpandedWithholdingTaxesRepository, Carbon $carbon) 
    {
        date_default_timezone_set('Asia/Manila');
        $this->acctgExpandedWithholdingTaxesRepository = $AcctgExpandedWithholdingTaxesRepository;
        $this->carbon = $carbon;
        $this->slugs = 'accounting/setup-data/expanded-withholding-taxes';
    }

    public function index(Request $request)
    {   
        $this->is_permitted($this->slugs, 'read');
        $gl_accounts = $this->acctgExpandedWithholdingTaxesRepository->allGLAccounts();
        return view('accounting.setup-data.expanded-withholding-taxes.index')->with(compact('gl_accounts'));
    }
    ...
    { 
        ...
        $result = $this->acctgExpandedWithholdingTaxesRepository->listItems($request);
    ...
    {       
        ...
        $rows = $this->acctgExpandedWithholdingTaxesRepository->validate($request->code);
        if ($rows > 0) {
            return response()->json([
                'title' => 'Oh snap!',
                'text' => 'You cannot create a expanded withholding tax with an existing code.',
        ...
        $group = $this->acctgExpandedWithholdingTaxesRepository->create($details);

        return response()->json(
            [
                'data' => $group,
                'title' => 'Well done!',
                'text' => 'The expanded withholding tax has been successfully saved.',
                'type' => 'success',
                'class' => 'btn-brand'
            ],
    ...
    {   
        $this->is_permitted($this->slugs, 'read'); 
        return response()->json([
            'data' => $this->acctgExpandedWithholdingTaxesRepository->find($id)
        ]);
    }
    ...
    {   
        ...
        $rows = $this->acctgExpandedWithholdingTaxesRepository->validate($request->code, $id);
        if ($rows > 0) {
            return response()->json([
                'title' => 'Oh snap!',
                'text' => 'You cannot update a expanded withholding tax with an existing code.',
                'label' => 'This is an existing code.',
                'type' => 'error',
                'class' => 'btn-danger',
                'column' => 'code'
        ...
        return response()->json([
            'data' => $this->acctgExpandedWithholdingTaxesRepository->update($id, $details),
            'title' => 'Well done!',
            'text' => 'The expanded withholding tax has been successfully updated.',
            'type' => 'success',
            'class' => 'btn-brand'
        ]);
    }
    ...
    {   
        ...
        return response()->json([
            'data' => $this->acctgExpandedWithholdingTaxesRepository->update($id, $details),
            'title' => 'Well done!',
            'text' => 'The expanded withholding tax has been successfully removed.',
            'type' => 'success',
            'class' => 'btn-brand'
        ]);
    }
    ...
    {   
        ...
        return response()->json([
            'data' => $this->acctgExpandedWithholdingTaxesRepository->update($id, $details),
            'title' => 'Well done!',
            'text' => 'The expanded withholding tax has been successfully restored.',
            'type' => 'success',
            'class' => 'btn-brand'
        ]);
    }
