...
use File;
use Carbon\Carbon;
class FireClientsController extends Controller
{
    public $data = [];
    public $postdata = [];
    ...
    public function __construct(){
        ...
        foreach ($this->_engClients->getBarangay() as $val) {
        ...
        $this->slugs = 'fire-protection-taxpayers';
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('fireClients.index',compact('isopen'));
    ...
    public function getList(Request $request){
        ...
        $data=$this->_engClients->getListFireSafety($request);
        $arr=array();
        $i="0";
        ...
        foreach ($data['data'] as $row){
            ...
            $checkclientisused = $this->_engClients->checkClientisused($row->id);
            ...
            $arr[$i]['action']='
                <div class="action-btn bg-warning ms-2">
                    ...
                    <a href="#" class="mx-3 btn btn-sm  align-items-center" data-url="'.url('/fireclients/store?id='.$row->id).'" data-ajax-popup="true"  data-size="lg" data-bs-toggle="tooltip" title="Edit"  data-title="Manage Taxpayers">
    ...
    public function ActiveInactive(Request $request){
        ...
        $data=array('is_fire_safety' => $is_activeinactive);
    ...
    public function store(Request $request){
        ...
        if($request->isMethod('post')){
            ...
            if($request->ajax()){
                ...
                return redirect()->route('fireclients.index')->with('success', __($success_msg));
            }
        ...
        return view('fireClients.create',compact('data','arrgetBrgyCode','arrgetCountries','arrgetClients'));
