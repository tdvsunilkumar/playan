...
use App\Models\LocalServer\Biometric;
use App\Models\LocalServer\Attendance;
use GuzzleHttp\Client;

class ScheduleLocalController extends Controller
{
    /**
    ...
    {
        try {
            $attendace = Attendance::where('hrba_copy',0)->get();
