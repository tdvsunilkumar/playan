...
class TreasuryPayablesVoucherController extends Controller
{
        ...
        Carbon $carbon) 
    {
        ...
        $this->carbon = $carbon;
        $this->slugs = 'treasury/journal-entries/payables';
    }
    ...
    {   
        ...
        return view('treasury.journal-entries.payables.index')->with(compact('segment', 'can_create', 'can_download', 'gl_accounts', 'uoms', 'evats', 'ewts', 'trans_types', 'vat_types'));
    }

    public function create(Request $request)
    {  
        $accounting_permission = array(
            'create' => $this->is_permitted('accounting/journal-entries/payables', 'create', 1),
            'read' => $this->is_permitted('accounting/journal-entries/payables', 'read', 1),
            'update' => $this->is_permitted('accounting/journal-entries/payables', 'update', 1),
            'delete' => $this->is_permitted('accounting/journal-entries/payables', 'delete', 1),
            'approve' => $this->is_permitted('accounting/journal-entries/payables', 'approve', 1),
            'disapprove' => $this->is_permitted('accounting/journal-entries/payables', 'disapprove', 1),
            'download' => $this->is_permitted('accounting/journal-entries/payables', 'download', 1)
        );
        ...
        return view('treasury.journal-entries.payables.create')->with(compact('approvers', 'segment', 'accounting_permission', 'treasury_permission', 'fund_codes', 'payees', 'payment_types', 'sl_accounts', 'sl_accountx', 'gl_accounts', 'uoms', 'evats', 'ewts', 'trans_types', 'vat_types'));
    }
    ...
    {  
        ...
        $segment = request()->segment(count(request()->segments()) - 2);
        $approvers = $this->acctgAccountVoucherRepository->get_voucher_approvers();
        return view('treasury.journal-entries.payables.view')->with(compact('approvers', 'segment', 'accounting_permission', 'treasury_permission', 'fund_codes', 'payees', 'payment_types', 'sl_accounts', 'sl_accountx', 'gl_accounts', 'uoms', 'evats', 'ewts', 'trans_types', 'vat_types'));
    }
    ...
    { 
        ...
        $res = $result->data->map(function($payment) use ($statusClass, $actions, $actions2, $actions3, $actions4) {
            ...
            return [
                ...
                'actions' => $statusClass[$payment->identityStatus]->action
            ];
        });
    ...
    {   
        if ($this->is_permitted('accounting/journal-entries/payables', 'delete', 1) > 0) {
            $details = array(
                'voucher_id' => NULL,
                'updated_at' => $this->carbon::now(),
                'updated_by' => Auth::user()->id
    ...
    {   
        if ($this->is_permitted('accounting/journal-entries/payables', 'update', 1) > 0) {
    ...
    {
        $this->is_permitted('accounting/journal-entries/payables', 'read'); 
        return response()->json([
    ...
    {
        if ($this->is_permitted('accounting/journal-entries/payables', 'approve', 1) > 0) {
            $timestamp = $this->carbon::now();
            $details = array(
                'status' => 'posted',
                'approved_at' => $timestamp,
    ...
    {
        if ($this->is_permitted('accounting/journal-entries/payables', 'disapprove', 1) > 0) {
            $timestamp = $this->carbon::now();
            $details = array(
                'status' => 'cancelled',
