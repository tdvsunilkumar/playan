...
class AcctgExpandedVatableTaxesRepository implements AcctgExpandedVatableTaxesInterface 
{
    public function find($id) 
    {
        return AcctgExpandedVatableTax::findOrFail($id);
    }
    
    public function validate($code, $id = '')
    {   
        if ($id !== '') {
            return AcctgExpandedVatableTax::where(['code' => $code])->where('id', '!=', $id)->count();
        } 
        return AcctgExpandedVatableTax::where(['code' => $code])->count();
    }

    public function create(array $details) 
    {
        return AcctgExpandedVatableTax::create($details);
    }

    public function update($id, array $newDetails) 
    {
        return AcctgExpandedVatableTax::whereId($id)->update($newDetails);
    }
    ...
    {   
        ...
        $res = AcctgExpandedVatableTax::select(['*'])
