...
class CreateSanitaryFeeAreamasterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sanitary_fee_areamaster', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sanitary_fee_areamaster');
    }
}
