...
class CreateEcoReceptionsListsDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eco_receptions_lists_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('eco_receptions_lists_details');
    }
}
