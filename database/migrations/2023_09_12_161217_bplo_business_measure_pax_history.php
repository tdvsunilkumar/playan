...
class BploBusinessMeasurePaxHistory extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bplo_business_measure_pax_history', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('buspx_id');
            $table->integer('buspx_year');
    ...
    {
        Schema::dropIfExists('bplo_business_measure_pax_history');
    }
}
