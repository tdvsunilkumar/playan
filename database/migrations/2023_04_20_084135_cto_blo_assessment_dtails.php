...
class CtoBloAssessmentDtails extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cto_bplo_assessment_details', function (Blueprint $table) {
            $table->id();
            $table->integer('cb_assesment_id')->default('0')->comment('cto_bplo_assessment.id');
            $table->integer('top_id')->default('0')->comment('Ref-Table: cto_bplo_top.id');
            ...
            $table->integer('assessment_period')->default('0');
            ...
            $table->integer('assess_is_posted')->length(1)->default('0')->nullable();
            $table->boolean('is_active')->length(1)->default(1);
    ...
    {
        Schema::dropIfExists('cto_bplo_assessment_details');
    }
}
