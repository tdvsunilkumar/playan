...
class CreateWelfareSwaStatusType extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('welfare_swa_status_type', function (Blueprint $table) {
            $table->id();
            $table->string('wsst_description');
            $table->integer('wsst_is_active')->length(1)->comment('if the status of the application type is active or not');
    ...
    {
        Schema::dropIfExists('welfare_swa_status_type');
    }
}
