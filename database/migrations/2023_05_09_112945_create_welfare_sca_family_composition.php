...
class CreateWelfareScaFamilyComposition extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('welfare_sca_family_composition', function (Blueprint $table) {
            $table->id();
            $table->integer('wsca_id')->comment('ref-Table: welfare_seniors_citizen_application.wsca_id');
            $table->integer('cit_id')->comment('ref-Table: welfare_seniors_citizen_application.cit_id');
    ...
    {
        Schema::dropIfExists('welfare_sca_family_composition');
    }
}
