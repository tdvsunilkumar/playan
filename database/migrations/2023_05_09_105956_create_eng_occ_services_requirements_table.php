...
class CreateEngOccServicesRequirementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eng_occ_services_requirements', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('eng_occ_services_requirements');
    }
}
