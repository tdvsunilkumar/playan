...
class BploBusinessPsicReqHistory extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bplo_business_psic_req_history', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('busn_psic_req_id');
    ...
    {
        Schema::dropIfExists('bplo_business_psic_req_history');
    }
}
