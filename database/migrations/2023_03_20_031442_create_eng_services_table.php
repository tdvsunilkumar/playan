...
class CreateEngServicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eng_services', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('is_main_service')->default(0);
    ...
    {
        Schema::dropIfExists('eng_services');
    }
}
