...
class CreateGarbageFeeAreamasterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('garbage_fee_areamaster', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('garbage_fee_areamaster');
    }
}
