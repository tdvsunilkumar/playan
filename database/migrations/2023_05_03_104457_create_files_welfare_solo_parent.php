...
class CreateFilesWelfareSoloParent extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('files_welfare_solo_parent', function (Blueprint $table) {
            $table->id();
            $table->integer('wspa_id')->length(11)->comment('ref-Table: welfare_solo_parent_application.wspa_id');
    ...
    {
        Schema::dropIfExists('files_welfare_solo_parent');
    }
}
