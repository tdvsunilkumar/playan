...
class BploBusinessPsicHistory extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bplo_business_psic_history', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('busn_psic_id');
            $table->integer('busp_tax_year');
    ...
    {
        Schema::dropIfExists('bplo_business_psic_history');
    }
}
