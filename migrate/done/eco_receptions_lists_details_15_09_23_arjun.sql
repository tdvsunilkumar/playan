...
--
-- Table structure for table `eco_receptions_lists_details`
--

CREATE TABLE `eco_receptions_lists_details` (
...
--
-- Indexes for table `eco_receptions_lists_details`
--
ALTER TABLE `eco_receptions_lists_details`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `eco_receptions_lists_details`
--
ALTER TABLE `eco_receptions_lists_details`
