...
--
-- Table structure for table `eco_service_type`
--

CREATE TABLE `eco_service_type` (
...
--
-- Indexes for table `eco_service_type`
--
ALTER TABLE `eco_service_type`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `eco_service_type`
--
ALTER TABLE `eco_service_type`
