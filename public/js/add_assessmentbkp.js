...
$(document).ready(function(){
	...
	for (var i = 0; i < totalPopup; i++) {
		...
		if ($(".bussiness_application_code"+i).length > 0) {
        $($(".bussiness_application_code"+i)).each(function (index, element) {
       ...
       if ($(".tax_type_code"+i).length > 0) {
        $($(".tax_type_code"+i)).each(function (index, element) {
            var id = $(element).attr('id');
            var multipleCancelButton = new Choices(
                '#' + id, {
                    removeItemButton: true,
...
function commonFunction(){
	...
	$(".btnPopupOpen").click(function(){
		...
		if(type=='edit'){
	        ...
	        $($(".bussiness_application_code"+mid)).each(function (index, element) {
	            var id = $(element).attr('id');
	            var multipleCancelButton = new Choices(
	                '#' + id, {
	                    removeItemButton: true,
	       ...
	       if ($(".tax_type_code"+mid).length > 0) {
	        $($(".tax_type_code"+mid)).each(function (index, element) {
	            var id = $(element).attr('id');
	            var multipleCancelButton = new Choices(
	                '#' + id, {
	                    removeItemButton: true,
...
function getClassifications(id){
    ...
    $.ajax({
        ...
        success: function(html){
			...
			// var currentid = $('#myModal'+mid).find(".classification_code").attr('id');
			// alert(currentid);
			// var currentidarr = currentid.split(".");
			// if(currentidarr[0] =='classification_code'){
		 ...
		 //        $($(".classification_code"+mid)).each(function (index, element) {
		 //            var id = $(element).attr('id');
		 //            var multipleCancelButton = new Choices(
		 //                '#' + id, {
		 //                    removeItemButton: true,
		 ...
		 //      }
		 //  }else{
		 //  	$('#myModal'+mid).find(".classification_code").attr('id','classification_codechange'+mid);
			// 	$('#myModal'+mid).find(".classification_code").addClass('classification_codechange'+mid);
			// 	if ($(".classification_codechange"+mid).length > 0) {
		 //        $($(".classification_codechange"+mid)).each(function (index, element) {
		 //            var id = $(element).attr('id');
		 //            var multipleCancelButton = new Choices(
		 //                '#' + id, {
		 //                    removeItemButton: true,
...
function getClassificationsonload(currid,i){
    ...
    $.ajax({
        ...
        success: function(html){
			...
			// $('#myModal'+i).find(".classification_code").attr('id','classification_code'+i);
			// $('#myModal'+i).find(".classification_code").addClass('classification_code'+i);
			// if ($(".classification_code"+i).length > 0) {
	  //       $($(".classification_code"+i)).each(function (index, element) {
	  //           var id = $(element).attr('id');
	  //           var multipleCancelButton = new Choices(
	  //               '#' + id, {
	  //                   removeItemButton: true,
...
function getActivityDrodown(id){
    ...
    $.ajax({
	  ...
	  //       $($(".activity_code"+mid)).each(function (index, element) {
	  //           var id = $(element).attr('id');
	  //           var multipleCancelButton = new Choices(
	  //               '#' + id, {
	  //                   removeItemButton: true,
...
function getActivityDrodownonload(currid,i){
    ...
    $.ajax({
        ...
        success: function(html){
			...
			// $('#myModal'+i).find(".activity_code").attr('id','activity_code'+i);
			// $('#myModal'+i).find(".activity_code").addClass('activity_code'+i);
			// if ($(".activity_code"+i).length > 0) {
	  //       $($(".activity_code"+i)).each(function (index, element) {
	  //           var id = $(element).attr('id');
	  //           var multipleCancelButton = new Choices(
	  //               '#' + id, {
	  //                   removeItemButton: true,
...
function applyInputpickerengfee(data,description,code,amount){
	$('#engneeringfee_description').inputpicker({
		...
		fields:[
			{name:'code',text:'Code'},
			{name:'amount',text:'Amount'},
			{name:'description',text:'Engnnering  Fees'}
		],
		headShow: true,
		fieldText : 'description',
		fieldValue: 'description',
