...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'health-safety-setup-data-service/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
			{ "data": "srno" },
        	{ "data": "tfoc_id" },
        	{ "data": "ho_service_name" },
        	{ "data": "ho_service_description" },
			{ "data": "ho_service_department" },
			{ "data": "top_transaction_type_id" },
			{ "data": "ho_service_form" },
        	{ "data": "ho_is_active" },
        	{ "data": "action" }
        ],
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   reverseButtons: true
	   	...
	   	if(result.isConfirmed){
		  	$.ajax({
			   url :DIR+'health-safety-setup-data-service/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
