$(document).ready(function(){
  ...
  datatablefunction();
    ...
    $(document).off('click','.showMultipleBillingDetails').on('click','.showMultipleBillingDetails',function(){
                var url = $(this).data('url');
                var title1 = 'Edit Multiple Property Billing';
                var title2 = 'Edit Multiple Property Billing';
    ...
    $('.addNewProperty').on('click',function(){
                var url = $(this).data('url');
                var title1 = 'Manage Multiple Property Billing';
                var title2 = 'Manage Multiple Property Billing';
                var title = (title1 != undefined) ? title1 : title2;
                var size = 'xll';
                loadMainForm(url, title, size,'commonModal');
     });
...
function datatablefunction()
{
    ...
    var table = $('#Jq_datatablelist').DataTable({ 
        ...
        "pageLength": 100,
        "ajax":{ 
            url :DIR+'billingform/getListmultiple', // json datasource
            type: "GET", 
            "data": {
