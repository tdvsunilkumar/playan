...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'ApplicationPaymentServices/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
			{ "data": "srno" },
			{ "data": "fpayment_app_name" },
			{ "data": "tfoc_id" },
        	{ "data": "ApplicableDept" },
			{ "data": "fpayment_remarks" },
        	{ "data": "action" }
        ],
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   reverseButtons: true
	   	...
	   	if(result.isConfirmed){
		  	$.ajax({
			   url :DIR+'ApplicationPaymentServices/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
