...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"searching": false,
		"order": [],
		"columnDefs": [{ orderable: false, targets: [0,2] },{ orderable: false, targets: [0,4] }],
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'locationclearance/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'cpdoservice/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
