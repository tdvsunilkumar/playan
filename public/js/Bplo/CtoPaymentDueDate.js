...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'CtoPaymentDueDate/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
			{ "data": "srno" },
        	{ "data": "type" },
        	{ "data": "due_1st_payment" },
        	{ "data": "due_semi_annual_2nd_sem" },
        	{ "data": "due_quarterly_2nd" },
        	{ "data": "due_quarterly_3rd" },
        	{ "data": "due_quarterly_4th" },
        	{ "data": "is_active" },
        	{ "data": "action" }
        ],
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   reverseButtons: true
	   	...
	   	if(result.isConfirmed){
		  	$.ajax({
			   url :DIR+'CtoPaymentDueDate/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
