...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'business-fee-master/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
			{ "data": "srno" },
        	{ "data": "fmaster_description" },
        	{ "data": "fmaster_shortname" },
        	{ "data": "fmaster_code" },
        	{ "data": "fmaster_status" },
        	{ "data": "action" }
        ],
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   reverseButtons: true
	   	...
	   	if(result.isConfirmed){
		  	$.ajax({
			   url :DIR+'BploBusinessType/FeesMasterActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
