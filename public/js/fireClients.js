...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"searching": false,
		"order": [],
		"columnDefs": [{ orderable: false, targets: [0,5] },{ orderable: false, targets: [0,4] }],
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'fireclients/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
...
function DeleteRecord(id){
	alert(id);
        ...
        swalWithBootstrapButtons.fire({
            ...
            {
               $.ajax({
			        url :DIR+'fireclients/delete', // json datasource
			        type: "POST", 
			        data: {
			          "id": id, 
			          "_token": $("#_csrf_token").val(),
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'fireclients/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
