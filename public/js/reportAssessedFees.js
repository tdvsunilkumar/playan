$(document).ready(function(){
	$("#btn_download_spreadsheet").click(function(){
		...
		window.location.href= DIR+"export-assessed-fees?from_date="+ from_date + "&to_date=" + to_date; 
	});	
...
function datatablefunction()
{
	...
	console.log(dropdown_html, 'test');
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"searching": false,
		"order": [],
		"columnDefs": [{ orderable: false, targets: [0,9,16,17,18] }],
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'reports-masterlists-assessed-fees/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
            ...
            { "data": "busn_type" },
            { "data": "no_emp" },
            { "data": "busp_capital_investment" },
            { "data": "busp_essential" },
            { "data": "busp_non_essential" },
            { "data": "busp_tax_essential" },
            { "data": "busp_tax_non_essential" },
        	{ "data": "sanitary_fee" },
        ],
