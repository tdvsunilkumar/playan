...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'real-property/property/class/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
			{ "data": "srno"},
        	{ "data": "pc_class_code" },
        	{ "data": "pc_class_description" },
			{ "data": "pc_class_no" },
        	{ "data": "pc_unit_value_option" },
        	{ "data": "pc_taxability_option" },
        	{ "data": "subclass" },
        	{ "data": "actualUs" },
        	{ "data": "is_active" },
            { "data": "action" }
...
function DeleteRecord(id){
	// alert(id);
        ...
        swalWithBootstrapButtons.fire({
            ...
            {
               $.ajax({
			        url :DIR+'real-property/property/class/delete', // json datasource
			        type: "POST", 
			        data: {
			          "id": id, 
			          "_token": $("#_csrf_token").val(),
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'real-property/property/class/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
