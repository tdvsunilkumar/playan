...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"searching": false,
		"order": [],
		"columnDefs": [{ orderable: false, targets: [0,4] },{ width: "500px", targets:[0,4] }],
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'social-welfare/assistance-type-requirements/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   reverseButtons: true
	   	...
	   	if(result.isConfirmed){
		  	$.ajax({
			   url :DIR+'social-welfare/assistance-type-requirements/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
