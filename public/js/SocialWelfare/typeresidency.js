...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'setup-data-type-of-residency/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
			{ "data": "srno" },
        	{ "data": "wstor_description" },
        	{ "data": "wstor_is_active" },
        	{ "data": "action" }
        ],
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   reverseButtons: true
	   	...
	   	if(result.isConfirmed){
		  	$.ajax({
			   url :DIR+'setup-data-type-of-residency/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
