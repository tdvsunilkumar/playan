...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'setup-data-type-of-occupation/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
        ...
        "columns": [
			{ "data": "srno" },
        	{ "data": "wptoo_description" },
        	{ "data": "wptoo_is_active" },
        	{ "data": "action" }
        ],
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   reverseButtons: true
	   	...
	   	if(result.isConfirmed){
		  	$.ajax({
			   url :DIR+'setup-data-type-of-occupation/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
