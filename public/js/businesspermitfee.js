...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'fees-master/business-permit-fee/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
        	...
        	{ "data": "bpt_permit_fee_amount" },
        	{ "data": "bpt_fee_option" },
        	{ "data": "bpt_tax_schedule" },
        	{ "data": "bpt_revenue_code" },
        	{ "data": "bpt_remarks" },
        	{ "data": "is_active" },
            { "data": "action" }
        ],
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'fees-master/business-permit-fee/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
