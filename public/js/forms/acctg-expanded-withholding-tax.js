!function($) {
    ...
    var ewtForm = function() {
        this.$body = $("body");
    };

    var $required = 0;

    ewtForm.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    ewtForm.prototype.init = function()
    {   
        /*
        | ---------------------------------
    ...
    //init ewtForm
    $.ewtForm = new ewtForm, $.ewtForm.Constructor = ewtForm

}(window.jQuery),

//initializing ewtForm
function($) {
    "use strict";
    $.ewtForm.init();
}(window.jQuery);
