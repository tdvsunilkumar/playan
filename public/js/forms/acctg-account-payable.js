!function($) {
    ...
    var accountPayableForm = function() {
        this.$body = $("body");
    };

    var $required = 0;

    accountPayableForm.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    accountPayableForm.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var _error  = $.accountPayableForm.validate(_form, 0);
    ...
    //init accountPayableForm
    $.accountPayableForm = new accountPayableForm, $.accountPayableForm.Constructor = accountPayableForm

}(window.jQuery),

//initializing accountPayableForm
function($) {
    "use strict";
    $.accountPayableForm.init();
}(window.jQuery);
