!function($) {
    ...
    {   
        // if (_purchaseType > 0) {
            ...
            console.log(_baseUrl + 'finance/obligation-requests/reload-items/' + _purchaseType);
            $.ajax({
                type: "GET",
                url: _baseUrl + 'finance/obligation-requests/reload-items/' + _purchaseType,
    ...
    {   
        // if (_item > 0) {
            ...
            console.log(_baseUrl + 'finance/obligation-requests/reload-uom/' + _item);
            $.ajax({
                type: "GET",
                url: _baseUrl + 'finance/obligation-requests/reload-uom/' + _item,
                success: function(response) {
                    console.log(response.data);
    ...
    {   
        // if (_department > 0) {
            ...
            console.log(_baseUrl + 'finance/obligation-requests/reload-divisions-employees/' + _department);
            $.ajax({
                type: "GET",
                url: _baseUrl + 'finance/obligation-requests/reload-divisions-employees/' + _department,
                success: function(response) {
    ...
    {   
        // if (_employee > 0) {
            ...
            console.log(_baseUrl + 'finance/obligation-requests/reload-designation/' + _employee);
            $.ajax({
                type: "GET",
                url: _baseUrl + 'finance/obligation-requests/reload-designation/' + _employee,
                success: function(response) {
                    console.log(response.data);
    ...
    {   
        ...
        console.log(_baseUrl + 'finance/obligation-requests/fetch-status/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'finance/obligation-requests/fetch-status/' + _id,
            success: function(response) {
    ...
    {   
        ...
        var _rows  = '';
        var _url = _baseUrl + 'finance/obligation-requests/view-alob-lines/' + _id + '?department=' + _department + '&division=' + _division + '&year=' + year;
        console.log(_url);
        $.ajax({
            type: 'GET',
            url: _url,
    ...
    {   
        ...
        console.log(_baseUrl + 'finance/obligation-requests/fetch-alob-status/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'finance/obligation-requests/fetch-alob-status/' + _id,
            success: function(response) {
                console.log(response);
                _status = response.status;
            },
    ...
    {   
        var _address = '';
        if (_id != '') {
            console.log(_baseUrl + 'finance/obligation-requests/fetch-payee-details/' + _id + '/' + _column);
            $.ajax({
                type: "GET",
                url: _baseUrl + 'finance/obligation-requests/fetch-payee-details/' + _id + '/' + _column,
                success: function(response) {
                    console.log(response);
    ...
    {
        var _url = _baseUrl + 'finance/obligation-requests/update/' + _id + '?department_id=' + _form.find('select[name="allob_department_id2"]').val() + '&division_id=' + _form.find('select[name="allob_division_id2"]').val() + '&payee_id=' + _form.find('select[name="payee_id2"]').val() + '&fund_code_id=' + _form.find('select[name="fund_code_id2"]').val() + '&address=' + _form.find('textarea[name="address2"]').val() + '&particulars=' + _form.find('textarea[name="particulars2"]').val() + '&budget_year=' + _form.find('select[name="budget_year2"]').val();
        console.log(_url);
        $.ajax({
            type: 'PUT',
            url: _url,
    ...
    {   
        ...
        console.log(_baseUrl + 'finance/obligation-requests/reload-division-via-department/' + $department);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'finance/obligation-requests/reload-division-via-department/' + $department,
            success: function(response) {
                console.log(response.data);
    ...
    obligation_requestForm.prototype.view_alob_lines2 = function(_id, _department, _division, year, _button)
    {   
        var _table = $('#available-alob-table'); _table.find('tbody').empty();
        var _modal = $('#view-alob-modal'); //_table.closest('.modal');
        var _rows  = '';
        var _url = _baseUrl + 'finance/obligation-requests/view-alob-lines2/' + _id + '?department=' + _department + '&division=' + _division + '&year=' + year;
        console.log(_url);
        $.ajax({
            type: 'GET',
            url: _url,
    ...
    {
        var _url = _baseUrl + 'finance/obligation-requests/update-row2/' + _id + '?breakdown=' + _breakdown + '&gl_account=' + _gl + '&allocated=' + _allocated;
        console.log(_url);
        $.ajax({
            type: 'PUT',
            url: _url,
    ...
    {   
        ...
        */
        this.$body.on('click', '#departmental-requisition-modal .send-btn', function (e){
            ...
            var _url    = _baseUrl + 'finance/obligation-requests/send/for-approval/' + _id;
            ...
            {   
                if (v1 == 'draft') {
                    if (_error != 0) {
                        ...
                        _self.prop('disabled', true).html('wait.....');
                        setTimeout(function () {
                            $.obligation_requestForm.view_alob_lines2(_id, _form.find('select[name="allob_department_id2"]').val(), _form.find('select[name="allob_division_id2"]').val(), _form.find('select[name="budget_year2"]').val(), _self);
                        }, 500 + 300 * (Math.random() * 5));
                    }
                } else {
                    Swal.fire({
