!function($) {
    ...
    designationForm.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    designationForm.prototype.validateScript = function ($form, $required)
    {
        $required = 0;
    ...
    designationForm.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var _form   = $('form[name="designationForm"]');
            ...
            var _error  = $.designationForm.validate(_form, 0);
            var _error2 = $.designationForm.validateScript(_form, 0);
    ...
    //init designationForm
    $.designationForm = new designationForm, $.designationForm.Constructor = designationForm

}(window.jQuery),

//initializing designationForm
function($) {
    "use strict";
    $.designationForm.init();
}(window.jQuery);
