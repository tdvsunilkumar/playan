!function($) {
    ...
    var menu_subModuleForm = function() {
        this.$body = $("body");
    };

    var $required = 0;

    menu_subModuleForm.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    menu_subModuleForm.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        this.$body.on('keyup', 'input[name="name"]', function (e) {
            ...
            var _group = _form.find('select[name="menu_module_id"]');
            var _text  = (_group.val() > 0) ? _form.find('select[name="menu_module_id"] option:selected').text().replace('&', 'and') + '-' : '';
        ...
        | ---------------------------------
        */
        this.$body.on('change', 'select[name="menu_module_id"]', function (e) {
            e.preventDefault();
            var _self  = $(this);
            var _form  = _self.closest('form');
        ...
        */
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var _form   = $('form[name="subModuleMenuForm"]');
            var _id     = $.menu_subModule.fetchID();
            ...
            var _error  = $.menu_subModuleForm.validate(_form, 0);
            ...
            if (_error != 0) {
                ...
                Swal.fire({
                    html: "Are you sure? <br/>the Sub-Module Menu with code ("+ _code +")<br/>will be saved.",
                    icon: "warning",
                    showCancelButton: !0,
                    buttonsStyling: !1,
    ...
    //init menu_subModuleForm
    $.menu_subModuleForm = new menu_subModuleForm, $.menu_subModuleForm.Constructor = menu_subModuleForm

}(window.jQuery),

//initializing menu_subModuleForm
function($) {
    "use strict";
    $.menu_subModuleForm.init();
}(window.jQuery);
