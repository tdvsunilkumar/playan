!function($) {
    ...
    acctg_ledger.prototype.required_fields = function() {
    ...
    acctg_ledger.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    acctg_ledger.prototype.preload_select3 = function()
    {
        if ( $('.select3') ) {
    ...
    acctg_ledger.prototype.reload_account_code = function(_type, _acctCode)
    {   
    ...
    acctg_ledger.prototype.reload_category_name = function(_category, _name)
    {   
    ...
    {   
        ...
        */
        this.$body.on('click', '.submit-btn', function (e){
            e.preventDefault();
            var _self   = $(this);
            var _form   = $('form[name="reportsAcctgLedgerForm"]');
