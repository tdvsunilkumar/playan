!function($) {
    ...
    var purchase_typeForm = function() {
        this.$body = $("body");
    };

    var $required = 0;

    purchase_typeForm.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    purchase_typeForm.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var _form   = $('form[name="purchaseTypeForm"]');
            ...
            var _error  = $.purchase_typeForm.validate(_form, 0);
    ...
    //init purchase_typeForm
    $.purchase_typeForm = new purchase_typeForm, $.purchase_typeForm.Constructor = purchase_typeForm

}(window.jQuery),

//initializing purchase_typeForm
function($) {
    "use strict";
    $.purchase_typeForm.init();
}(window.jQuery);
