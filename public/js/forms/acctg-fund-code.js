!function($) {
    ...
    var fund_codeForm = function() {
        this.$body = $("body");
    };

    var $required = 0;
    
    fund_codeForm.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    fund_codeForm.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var _form   = $('form[name="fundcodeForm"]');
            ...
            var _error  = $.fund_codeForm.validate(_form, 0);
    ...
    //init fund_codeForm
    $.fund_codeForm = new fund_codeForm, $.fund_codeForm.Constructor = fund_codeForm

}(window.jQuery),

//initializing fund_codeForm
function($) {
    "use strict";
    $.fund_codeForm.init();
}(window.jQuery);
