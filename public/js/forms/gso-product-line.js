!function($) {
    ...
    var product_lineForm = function() {
        this.$body = $("body");
    };

    var $required = 0;

    product_lineForm.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    product_lineForm.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var _form   = $('form[name="productLineForm"]');
            ...
            var _error  = $.product_lineForm.validate(_form, 0);
    ...
    //init product_lineForm
    $.product_lineForm = new product_lineForm, $.product_lineForm.Constructor = product_lineForm

}(window.jQuery),

//initializing product_lineForm
function($) {
    "use strict";
    $.product_lineForm.init();
}(window.jQuery);
