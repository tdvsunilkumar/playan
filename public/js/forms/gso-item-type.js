!function($) {
    ...
    var item_typeForm = function() {
        this.$body = $("body");
    };

    var $required = 0;

    item_typeForm.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    item_typeForm.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var _form   = $('form[name="itemTypeForm"]');
            ...
            var _error  = $.item_typeForm.validate(_form, 0);
    ...
    //init item_typeForm
    $.item_typeForm = new item_typeForm, $.item_typeForm.Constructor = item_typeForm

}(window.jQuery),

//initializing item_typeForm
function($) {
    "use strict";
    $.item_typeForm.init();
}(window.jQuery);
