!function($) {
    ...
    var citizen_codeForm = function() {
        this.$body = $("body");
    };

    var $required = 0;
    
    citizen_codeForm.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    citizen_codeForm.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var _form   = $('form[name="citizenForm"]');
            ...
            var _error  = $.citizen_codeForm.validate(_form, 0);
    ...
    //init citizen_codeForm
    $.citizen_codeForm = new citizen_codeForm, $.citizen_codeForm.Constructor = citizen_codeForm

}(window.jQuery),

//initializing citizen_codeForm
function($) {
    "use strict";
    $.citizen_codeForm.init();
}(window.jQuery);
