!function($) {
    ...
    paymentTypeForm.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    paymentTypeForm.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var _form   = $('form[name="paymentTypeForm"]');
            var _id     = $.paymentType.fetchID();
            var _method = (_id > 0) ? 'PUT' : 'POST';
            var _action = (_id > 0) ? _form.attr('action') + '/update/' + _id : _form.attr('action') + '/store';
            var _error  = $.paymentTypeForm.validate(_form, 0);
    ...
    //init paymentTypeForm
    $.paymentTypeForm = new paymentTypeForm, $.paymentTypeForm.Constructor = paymentTypeForm

}(window.jQuery),

//initializing paymentTypeForm
function($) {
    "use strict";
    $.paymentTypeForm.init();
}(window.jQuery);
