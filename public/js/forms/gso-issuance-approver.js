!function($) {
    ...
    {   
        ...
        $.ajax({
            type: "GET",
            url: _baseUrl + 'general-services/issuance/approver/reload-divisions-employees/' + _department,
            success: function(response) {
                console.log(response.employees);
                _employee.append('<option value="">select a approver</option>');  
    ...
    {   
        ...
        $.ajax({
            type: "GET",
            url: _baseUrl + 'general-services/issuance/approver/reload-designation/' + _employee,
            success: function(response) {
