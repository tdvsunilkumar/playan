!function($) {
    ...
    inventoryForm.prototype.reload_divisions_employees = function(_division, _employee, _designation, _department = 0)
    {   
        ...
        $.ajax({
            type: "GET",
            url: _baseUrl + 'general-services/inventory/reload-divisions-employees/' + _department,
    ...
    inventoryForm.prototype.reload_designation = function(_designation, _employee = 0)
    {   
    ...
    {   
        ...
        */
        this.$body.on('change', 'select[name="department_id"]', function (event) {
            var _self = $(this);
            $.inventoryForm.reload_divisions_employees($('select[name="division_id"]'), $('select[name="employee_id"]'), $('select[name="designation_id"]'), _self.val());
        });
        ...
        */
        this.$body.on('change', 'select[name="employee_id"]', function (event) {
            var _self = $(this);
            $.inventoryForm.reload_designation($('select[name="designation_id"]'), _self.val());
        });
        ...
        */
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var _form   = $('form[name="issuanceRequestForm"]');
