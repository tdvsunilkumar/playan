!function($) {
    ...
    var wasteMaterialForm = function() {
        this.$body = $("body");
    };

    var $required = 0;

    wasteMaterialForm.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    wasteMaterialForm.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var _self   = $(this);
            var _modal  = _self.closest('.modal');
            var _form   = _modal.find('form[name="wasteMaterialForm"]');
            ...
            var _error  = $.wasteMaterialForm.validate(_form, 0);
    ...
    //init wasteMaterialForm
    $.wasteMaterialForm = new wasteMaterialForm, $.wasteMaterialForm.Constructor = wasteMaterialForm

}(window.jQuery),

//initializing wasteMaterialForm
function($) {
    "use strict";
    $.wasteMaterialForm.init();
}(window.jQuery);
