!function($) {
    ...
    var acctg_recap = function() {
        this.$body = $("body");
    };

    var $required = 0;

    acctg_recap.prototype.required_fields = function() {
    ...
    acctg_recap.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    acctg_recap.prototype.preload_select3 = function()
    {
        if ( $('.select3') ) {
    ...
    acctg_recap.prototype.init = function()
    {   
        $.acctg_recap.preload_select3();
    ...
    //init acctg_recap
    $.acctg_recap = new acctg_recap, $.acctg_recap.Constructor = acctg_recap

}(window.jQuery),

//initializing acctg_recap
function($) {
    "use strict";
    $.acctg_recap.required_fields();
    $.acctg_recap.init();
