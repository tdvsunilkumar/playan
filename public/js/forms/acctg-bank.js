!function($) {
    ...
    var bankForm = function() {
        this.$body = $("body");
    };

    var $required = 0;

    bankForm.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    bankForm.prototype.init = function()
    {   
        /*
        | ---------------------------------
    ...
    //init bankForm
    $.bankForm = new bankForm, $.bankForm.Constructor = bankForm

}(window.jQuery),

//initializing bankForm
function($) {
    "use strict";
    $.bankForm.init();
}(window.jQuery);
