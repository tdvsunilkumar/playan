!function($) {
    ...
    var unit_of_measurementForm = function() {
        this.$body = $("body");
    };

    var $required = 0;

    unit_of_measurementForm.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    unit_of_measurementForm.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        ...
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var _error  = $.unit_of_measurementForm.validate(_form, 0);
                                ...
                                if (response.type == 'success') {
                                    setTimeout(function () {
                                        ...
                                        Swal.fire({ title: response.title, text: response.text, icon: response.type, buttonsStyling: !1, confirmButtonText: "Ok, got it!", customClass: { confirmButton: "btn btn-primary" } }).then(
                                            function (e) {
                                                $.unit_of_measurement.load_contents(1);
                                                _modal.modal('hide');
                                            }
                                        );
    ...
    //init unit_of_measurementForm
    $.unit_of_measurementForm = new unit_of_measurementForm, $.unit_of_measurementForm.Constructor = unit_of_measurementForm

}(window.jQuery),

//initializing unit_of_measurementForm
function($) {
    "use strict";
    $.unit_of_measurementForm.init();
}(window.jQuery);
