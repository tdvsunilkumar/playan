!function($) {
    ...
    var housingPenaltyForm = function() {
        this.$body = $("body");
    };

    var $required = 0;

    housingPenaltyForm.prototype.validate = function($form, $required)
    {   
        $required = 0;
    ...
    housingPenaltyForm.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        */
        this.$body.on('click', '.submit-btn', function (e){
            ...
            var _form   = $('form[name="housingPenaltyForm"]');
            var _id     = $.housingPenalty.fetchID();
            var _method = (_id > 0) ? 'PUT' : 'POST';
            var _action = (_id > 0) ? _form.attr('action') + '/update/' + _id : _form.attr('action') + '/store';
            var _error  = $.housingPenaltyForm.validate(_form, 0);
    ...
    //init housingPenaltyForm
    $.housingPenaltyForm = new housingPenaltyForm, $.housingPenaltyForm.Constructor = housingPenaltyForm

}(window.jQuery),

//initializing housingPenaltyForm
function($) {
    "use strict";
    $.housingPenaltyForm.init();
}(window.jQuery);
