...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"searching": false,
		"order": [],
		"columnDefs": [{ orderable: false, targets: [0,26] }],
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'engineering/consultantexternal/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
        	...
        	{ "data": "mobile_no" },
			{ "data": "ptr_no" },
        	{ "data": "ptr_date_issued" },
        	{ "data": "prc_no" },
			{ "data": "prc_validity" },
        	{ "data": "prc_date_issued" },
        	{ "data": "tin_no" },
			{ "data": "iapoa_no" },
        	{ "data": "iapoa_or_no" },
			{ "data": "is_active" },
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   reverseButtons: true
	   	...
	   	if(result.isConfirmed){
		  	$.ajax({
			   url :DIR+'engineering/consultantexternal/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
