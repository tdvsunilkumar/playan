...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'engbldgassessmentfees/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
			{ "data": "srno" },
        	{ "data": "ebpa_owner_first_name" },
        	{ "data": "ebaf_total_assessed_by" },
        	{ "data": "ebaf_total_or_no" },
        	{ "data": "ebaf_total_amount" },
        	{ "data": "ebaf_total_date_paid" },
        	{ "data": "is_active" },
        	{ "data": "action" }
        ],
...
function DeleteRecord(id){
	alert(id);
        ...
        swalWithBootstrapButtons.fire({
            ...
            {
               $.ajax({
			        url :DIR+'engbldgassessmentfees/delete', // json datasource
			        type: "POST", 
			        data: {
			          "id": id, 
			          "_token": $("#_csrf_token").val(),
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'engbldgassessmentfees/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
