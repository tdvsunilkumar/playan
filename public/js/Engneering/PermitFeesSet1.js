...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'engbuildingpermitfeesset1/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
            { "data": "srno" },
			{ "data": "ebpfs1_range_from" },
			{ "data": "ebpfs1_range_to" },
			{ "data": "ebpfs1_fees" },
        	{ "data": "eef_status" },
        	{ "data": "action" }
        ],
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'engbuildingpermitfeesset1/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id":id,
