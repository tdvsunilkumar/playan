...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'engbuildingfeesset4/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
            { "data": "srno" },
			{ "data": "ebpfs4_range_from" },
			{ "data": "ebpfs4_range_to" },
			{ "data": "ebpfs4_fees" },
        	{ "data": "ebpfs4_status" },
        	{ "data": "action" }
        ],
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'engbuildingfeesset4/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id":id,
