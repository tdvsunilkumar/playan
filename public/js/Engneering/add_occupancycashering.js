$(document).ready(function(){
           //$("#clientid").select3({});
           select3Ajax("top_transaction_id","topnumberajax","occupancycashering/getTopNumbersAjax");
    ...
    function getAmountinword(amount){
        ...
        $.ajax({
          type: "POST",
          url: DIR+'occupancycashering/getamountinword',
          data: filtervars,
          dataType: "html",
          success: function(html){ 
             hideLoader();
    ...
    function Getornumebr(checked){
         $.ajax({
                url :DIR+'occupancycashering/getOrnumber', // json datasource
                type: "POST", 
                data: {
     ...
     function gettransactionedit(id){
      ...
      $.ajax({
        type: "post",
        url: DIR+'occupancycashering/getTransactionid',
        data: filtervars,
        dataType: "html",
        success: function(html){ 
          $('.loadingGIF').hide();
          arr = $.parseJSON(html);
            //$("#top_transaction_id").html(html);
             ...
             $("#controlno").val(arr.eoa_application_no);  $("#appdate").val(arr.created_at); $("#apptype").val('Occupancy Fee');
             $("#cpdoamount").val(arr.amountdefault);  $("#totalamount").val(arr.eoa_total_fees); 
             $("#total_amount").val(arr.eoa_total_fees); $("#surcharge").val(arr.eoa_surcharge_fee);
             getAmountinword(arr.eoa_total_fees);
             var ejrid = arr.id;  var filtervars = {
                    ejrid:ejrid
                  }; 
                $.ajax({
                    type: "post",
                    url: DIR+'occupancycashering/getallFeeseoaedit',
                    data: filtervars,
                    dataType: "html",
                    success: function(html){ 
                      $('.loadingGIF').hide();
        ...
        success: function(html){ 
          ...
          arr = $.parseJSON(html);
            //$("#top_transaction_id").html(html);
             ...
             $("#cpdoamount").val(arr.amountdefault);  $("#totalamount").val(arr.eoa_total_fees); 
             $("#total_amount").val(arr.eoa_total_fees); $("#surcharge").val(arr.eoa_surcharge_fee);
             var showTotal = formatNumber(arr.eoa_total_fees.toFixed(2));
             ...
             var ejrid = arr.id;  var filtervars = {
                ...
                $.ajax({
                    type: "post",
                    url: DIR+'occupancycashering/getallFeeseeoa',
                    data: filtervars,
                    dataType: "html",
                    success: function(html){ 
                      $('.loadingGIF').hide();
