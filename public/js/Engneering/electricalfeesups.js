...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'engelectricalfeesups/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
            { "data": "srno" },
			{ "data": "eefu_kva_range_from" },
			{ "data": "eefu_kva_range_to" },
			{ "data": "eefu_fees" },
			{ "data": "eefu_in_excess_fees" },
        	{ "data": "eefu_status" },
        	{ "data": "action" }
        ],
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'engelectricalfeesups/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
