...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'engbuildingfeesset3/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
            { "data": "srno" },
			{ "data": "ebpfs3_range_from" },
			{ "data": "ebpfs3_range_to" },
			{ "data": "ebpfs3_fees" },
        	{ "data": "ebpfs3_status" },
        	{ "data": "action" }
        ],
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'engbuildingfeesset3/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id":id,
