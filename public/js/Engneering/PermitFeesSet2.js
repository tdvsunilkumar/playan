...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'engbuildingfeesset2/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
            { "data": "srno" },
			{ "data": "ebpfs2_range_from" },
			{ "data": "ebpfs2_range_to" },
			{ "data": "ebpfs2_fees" },
        	{ "data": "ebpfs2_status" },
        	{ "data": "action" }
        ],
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'engbuildingfeesset2/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id":id,
