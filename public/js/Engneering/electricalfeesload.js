...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'engelectricalfeesload/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
            { "data": "srno" },
			{ "data": "eefl_kva_range_from" },
			{ "data": "eefl_kva_range_to" },
			{ "data": "eefl_fees" },
			{ "data": "eef_in_excess_fees" },
        	{ "data": "eef_status" },
        	{ "data": "action" }
        ],
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'engelectricalfeesload/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
