...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'revisionyear/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
        	...
        	{ "data": "rvy_revision_code" },
        	{ "data": "description" },
        	{ "data": "basic" , "className": "align-center" },
        	{ "data": "sef" , "className": "align-center" },
        	{ "data": "sh" , "className": "align-center" },
        	{ "data": "rvy_city_assessor_code" },
        	{ "data": "rvy_city_assessor_assistant_code" },
        	{ "data": "stp_print" },
        	// { "data": "display_for_rpt" },
			{ "data": "is_active" },
...
function DeleteRecord(id){
	alert(id);
        ...
        swalWithBootstrapButtons.fire({
            ...
            {
               $.ajax({
			        url :DIR+'revisionyear/delete', // json datasource
			        type: "POST", 
			        data: {
			          "id": id, 
			          "_token": $("#_csrf_token").val(),
...
function PrintOptionUpdate(id,is_print){
    ...
    swalWithBootstrapButtons.fire({
        ...
        {
           $.ajax({
		        url :DIR+'revisionyear/defaultUpdateCode', // json datasource
		        type: "POST", 
		        data: {
		          "id": id,
		          "is_print": is_print,  
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'revisionyear/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
