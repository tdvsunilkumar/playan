!function($) {
    ...
    for_approval_abstract.prototype.required_fields = function() {
    ...
    for_approval_abstract.prototype.load_contents = function(_page = 0) 
    {   
        console.log(_baseUrl + 'for-approvals/abstract-of-canvass/lists'); 
        _table = new DataTable('#rfqTable', {
            ajax: { 
                url : _baseUrl + 'for-approvals/abstract-of-canvass/lists',
                type: "GET", 
                data: {
                    "_token": _token
                },
                complete: function() {
                    $.for_approval_abstract.shorten();
            ...
            initComplete: function(){
                ...
                $.for_approval_abstract.hideTooltip();
            }, 
            columns: [
                { data: 'id' },
    ...
    for_approval_abstract.prototype.load_committee_contents = function(_keywords = '') 
    {   
        console.log(_baseUrl + 'for-approvals/abstract-of-canvass/committee-lists/' + _rfqID); 
        _prTable = new DataTable('#committeeTable', {
            ajax: { 
                url : _baseUrl + 'for-approvals/abstract-of-canvass/committee-lists/' + _rfqID,
                type: "GET", 
                data: {
                    "query": _keywords,
                    "_token": _token
    ...
    for_approval_abstract.prototype.load_pr_contents = function(_keywords = '') 
    {   
        console.log(_baseUrl + 'for-approvals/abstract-of-canvass/pr-lists/' + _rfqID); 
        _prTable = new DataTable('#prTable', {
            ajax: { 
                url : _baseUrl + 'for-approvals/abstract-of-canvass/pr-lists/' + _rfqID,
                type: "GET", 
                data: {
                    "query": _keywords,
                    "_token": _token
    ...
    for_approval_abstract.prototype.load_supplier_contents = function(_keywords = '') 
    {   
        console.log(_baseUrl + 'for-approvals/abstract-of-canvass/supplier-lists/' + _rfqID); 
        _prTable = new DataTable('#supplierTable', {
            ajax: { 
                url : _baseUrl + 'for-approvals/abstract-of-canvass/supplier-lists/' + _rfqID,
                type: "GET", 
                data: {
                    "query": _keywords,
                    "_token": _token
    ...
    for_approval_abstract.prototype.load_item_contents = function(_keywords = '') 
    {   
        console.log(_baseUrl + 'for-approvals/abstract-of-canvass/item-lists/' + _rfqID); 
        _prTable = new DataTable('#itemTable', {
            ajax: { 
                url : _baseUrl + 'for-approvals/abstract-of-canvass/item-lists/' + _rfqID,
                type: "GET", 
                data: {
                    "query": _keywords,
                    "_token": _token
    ...
    for_approval_abstract.prototype.reload_available_control_no = function()
    {   
    ...
    for_approval_abstract.prototype.fetchID = function()
    {
        return _rfqID;
    }

    for_approval_abstract.prototype.updateID = function(_id)
    {
        return _rfqID = _id;
    }

    for_approval_abstract.prototype.fetch_status = function (_id)
    {   
        var _status = '';
        if (_id == 0) {
            return _status = 'draft';
        }
        console.log(_baseUrl + 'for-approvals/abstract-of-canvass/fetch-status/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'for-approvals/abstract-of-canvass/fetch-status/' + _id,
            success: function(response) {
    ...
    for_approval_abstract.prototype.validate_approver = function (_id)
    {   
        var _status = false;
        console.log(_baseUrl + 'for-approvals/abstract-of-canvass/validate-approver/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'for-approvals/abstract-of-canvass/validate-approver/' + _id,
            success: function(response) {
                console.log(response);
                _status = response;
            },
    ...
    for_approval_abstract.prototype.shorten = function() 
    {   
        if ($('.showLess')) {
            $('.showLess').shorten({
                "showChars" : 20,
    ...
    for_approval_abstract.prototype.preload_select3 = function()
    {
        if ( $('.select3') ) {
    ...
    for_approval_abstract.prototype.perfect_scrollbar = function()
    {
        if ($(".table-responsive")) {
    ...
    for_approval_abstract.prototype.validate_table = function($table)
    {   
        $('.pager').remove();
        $table.each(function() {
            var currentPage = 0;
    ...
    | ---------------------------------
    */
    for_approval_abstract.prototype.price_separator = function(input) {
        var output = input
        if (parseFloat(input)) {
    ...
    for_approval_abstract.prototype.fetch_remarks = function (_id)
    {   
        var _remarks = '';
        console.log(_baseUrl + 'for-approvals/abstract-of-canvass/fetch-remarks/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'for-approvals/abstract-of-canvass/fetch-remarks/' + _id,
            success: function(response) {
                console.log(response);
    ...
    for_approval_abstract.prototype.load_line_contents = function(_keywords = '') 
    {   
    ...
    for_approval_abstract.prototype.load_alob_line_contents = function(_keywords = '') 
    {   
        var table = new DataTable('#allotmentBreakdownTable', {
            ajax: { 
                url : _baseUrl + 'for-approvals/abstract-of-canvass/alob-lists/' + _rfqID,
                type: "GET", 
                data: {
                    "query": _keywords,
                    "_token": _token
    ...
    for_approval_abstract.prototype.reload_divisions_employees = function(_division, _employee, _designation, _department = 0)
    {   
        // if (_department > 0) {
            _employee.find('option').remove(); _division.find('option').remove(); _designation.val('');
            console.log(_baseUrl + 'for-approvals/abstract-of-canvass/reload-divisions-employees/' + _department);
            $.ajax({
                type: "GET",
                url: _baseUrl + 'for-approvals/abstract-of-canvass/reload-divisions-employees/' + _department,
                success: function(response) {
    ...
    for_approval_abstract.prototype.reload_designation = function(_designation, _employee = 0)
    {   
        // if (_employee > 0) {
            _designation.find('option').remove(); 
            console.log(_baseUrl + 'for-approvals/abstract-of-canvass/reload-designation/' + _employee);
            $.ajax({
                type: "GET",
                url: _baseUrl + 'for-approvals/abstract-of-canvass/reload-designation/' + _employee,
                success: function(response) {
                    console.log(response.data);
    ...
    for_approval_abstract.prototype.reload_items = function(_item, _uom, _purchaseType = 0)
    {   
        // if (_purchaseType > 0) {
            _item.find('option').remove(); _uom.val('');
            console.log(_baseUrl + 'for-approvals/abstract-of-canvass/reload-items/' + _purchaseType);
            $.ajax({
                type: "GET",
                url: _baseUrl + 'for-approvals/abstract-of-canvass/reload-items/' + _purchaseType,
                success: function(response) {
                    console.log(response.data);
    ...
    for_approval_abstract.prototype.fetch_total_allotment_amount = function()
    {   
        var _total = 0;
        var _url   = _baseUrl + 'for-approvals/abstract-of-canvass/fetch-allotment-via-pr/' + _rfqID + '?column=total_amount'; 
        console.log(_url);
        $.ajax({
            type: 'GET',
            url: _url,
    ...
    for_approval_abstract.prototype.hideTooltip = function()
    {
        $('.tooltip').remove();
    },

    for_approval_abstract.prototype.edit_supplier = function(_supplier, _url, _modal, _code, _button, _status)
    {   
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.data.length > 0) {
                    ...
                    _table.find('tfoot th.text-danger').text($.for_approval_abstract.price_separator(parseFloat(_totalCost).toFixed(2)));
                    if (_status !== 'pending') {
    ...
    for_approval_abstract.prototype.init = function()
    {   
        /*
        | ---------------------------------
        ...
        | ---------------------------------
        */
        $.for_approval_abstract.preload_select3();
        $.for_approval_abstract.load_contents();
        $.for_approval_abstract.perfect_scrollbar();
        ...
        */
        this.$body.on('hidden.bs.modal', '#rfq-modal', function (e) {
            ...
            $.for_approval_abstract.load_contents(_table.page());
            $.for_approval_abstract.hideTooltip();
            _rfqID = 0;
        });
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.data.total_budget) {
                        _modal.find('label[for="total_budget"].text-danger').text('₱' + $.for_approval_abstract.price_separator(parseFloat(response.data.total_budget).toFixed(2)));
                    }
                    ...
                    $.each(response.suppliers, function (k, v) {
                        ...
                        _supplierData += '<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse' + v.supplier_id + '" aria-expanded="false" aria-controls="flush-collapse' + v.supplier_id + '">';
                        
                        console.log(_found);
                        if (v.is_selected > 0) {
                            _supplierData += '<input value="' + v.supplier_id + '" class="form-check-input me-2" type="radio" name="is_selected" checked="checked" ' + ((_found != undefined) ? 'disabled="disabled"' : '') + '/>' + v.supplier + ' -&nbsp; <strong class="text-danger">' + '₱' + $.for_approval_abstract.price_separator(parseFloat(v.canvass).toFixed(2)) + '</strong>';
                        } else {
                            _supplierData += '<input value="' + v.supplier_id + '" class="form-check-input me-2" type="radio" name="is_selected" ' + ((_found != undefined) ? 'disabled="disabled"' : '') + '/>' + v.supplier + ' -&nbsp; <strong class="text-danger">' + '₱' + $.for_approval_abstract.price_separator(parseFloat(v.canvass).toFixed(2)) + '</strong>';
                        }
                        _supplierData += '</button>';
                        _supplierData += '</h2>';
                        _supplierData += '<div id="flush-collapse' + v.supplier_id + '" class="accordion-collapse collapse p-0" aria-labelledby="flush-heading3" data-bs-parent="#accordionFlushExample">';
                        ...
                        _supplierData += '<th class="text-end">Unit Cost</th>';
                        ...
                        var _total = 0; var _increment = 0;
                            $.each(v.items, function (k1, v2){
                                ...
                                _supplierData += '<td><code class="text-primary">' + v2.name + '</code></td>';
                                _supplierData += '<td>' + (v2.model ? v2.model : '')  + '</td>';
                                _supplierData += '<td class="text-center">' + v2.quantity + '</td>';
                                _supplierData += '<td class="text-center">' + v2.uom + '</td>';
                                _supplierData += '<td class="text-end">' + (v2.unit_cost ? $.for_approval_abstract.price_separator(parseFloat(v2.unit_cost).toFixed(2)) : $.for_approval_abstract.price_separator(parseFloat(0).toFixed(2))) + '</td>';
                                _supplierData += '<td class="text-end text-danger">' + (v2.total_cost ? $.for_approval_abstract.price_separator(parseFloat(v2.total_cost).toFixed(2)) : $.for_approval_abstract.price_separator(parseFloat(0).toFixed(2))) + '</td>';
                                _supplierData += '</tr>';
                                if (parseFloat(v2.total_cost) > 0) {
                        ...
                        _supplierData += '<td class="text-end text-danger" colspan="1"><strong>' + '₱' + $.for_approval_abstract.price_separator(parseFloat(_total).toFixed(2)) + '</strong></td>';
                        _supplierData += '</tr>';
                        _supplierData += '</tfoot>';
                        _supplierData += '</tr>';
                        _supplierData += '</table>';
                    ...
                    $.for_approval_abstract.load_committee_contents();
                    _modal.find('.m-form__help').text('');
                    _modal.find('.modal-header h5').html('View Abstract Of Canvass (<span class="variables">' + _code + '</span>)');
                    ...
                    if (_status != 'draft') {
                        ...
                        if (_status == 'completed') {
                            ...
                            if (_status == 'processed') {
                                ...
                                _modal.find('button.award-btn').removeClass('hidden');
                                _modal.find('button.send-btn').addClass('hidden');
                            }
                        }
                    } else {
        ...
        */
        this.$body.on('click', '#rfqTable .approve-btn', function (e) {
            ...
            var _url    = _baseUrl + 'for-approvals/abstract-of-canvass/approve/' + _id;

            var d1 = $.for_approval_abstract.fetch_status(_id);
            var d2 = $.for_approval_abstract.validate_approver(_id);
        ...
        */
        this.$body.on('click', '.submit-disapprove-btn', function (e){
            ...
            var _error  = $.for_approval_abstract.validate(_form, 0);
        ...
        */
        this.$body.on('click', '#rfqTable .view-disapprove-btn', function (e) {
            ...
            _self.prop('disabled', true);
            var d1 = $.for_approval_abstract.fetch_status(_id);
            var d2 = $.for_approval_abstract.fetch_remarks(_id);
            $.when( d1, d2 ).done(function ( v1, v2 ) 
            {  
                if (v1 == 'cancelled') {
                    _self.prop('disabled', false);
        ...
        */
        this.$body.on('click', '#supplierTable .view-btn', function (e) {
            ...
            var _url      = _baseUrl + 'for-approvals/abstract-of-canvass/edit-supplier/' + _rfqID + '?supplier=' + _supplier;
            var _modal    = $('#canvass-modal');
            
            _self.prop('disabled', true).html('<div class="spinner-border spinner-border-sm text-white" role="status" aria-hidden="true"><span class="visually-hidden">Loading...</span></div>');
            setTimeout(function () {
                $.for_approval_abstract.edit_supplier(_supplier, _url, _modal, _code, _self, _status);
            }, 500 + 300 * (Math.random() * 5));
        }); 
    }

    //init for_approval_abstract
    $.for_approval_abstract = new for_approval_abstract, $.for_approval_abstract.Constructor = for_approval_abstract

}(window.jQuery),

//initializing for_approval_abstract
function($) {
    "use strict";
    $.for_approval_abstract.required_fields();
    $.for_approval_abstract.init();
}(window.jQuery);