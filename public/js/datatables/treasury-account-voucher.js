!function($) {
    ...
    var _payableCodex = ''; var _paymentCodex = '';
    ...
    {   
        _table = new DataTable('#voucherTable', {
            ajax: { 
                url : _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/lists?status=' + _voucherStatus,
                type: "GET", 
                data: {
                    "_token": _token
                },
    ...
    {   
        _payable = new DataTable('#payablesTable', {
            ajax: { 
                url : _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payables-lists/' + _voucherID + '?status=' + _payableStatus,
                type: "GET", 
                data: {
                    "_token": _token
                },
            ...
            initComplete: function(){
                ...
                if(_payable.rows().data().length > 0 || _payment.rows().data().length > 0) {
                    ...
                    $('#voucher-card input[name="is_replenish"]').prop('disabled', true);
                } else {
                    $('#voucher-card select[name="fund_code_id"]').prop('disabled', false);
                    $('#voucher-card select[name="payee_id"]').prop('disabled', false);
                    $('#voucher-card input[name="is_replenish"]').prop('disabled', false);
                }
            },      
            columns: 
                (voucherSegment == 'payables') ?  
            ...
            columnDefs: 
                ...
                [
                    ...
                    {  orderable: false, targets: 6, className: 'text-center' },
                    {  orderable: false, targets: 7, className: 'text-center' },
                    {  orderable: true, targets: 8, className: 'text-end' },
                    {  orderable: true, targets: 9, className: 'text-end' },
    ...
    {   
        _deduction = new DataTable('#deductionTable', {
            ajax: { 
                url : _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/deductions-lists/' + _voucherID + '?status=' + _deductionStatus,
                type: "GET", 
                data: {
                    "_token": _token
                },
    ...
    {   
        _payment = new DataTable('#paymentsTable', {
            ajax: { 
                url : _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payments-lists/' + _voucherID + '?status=' + _paymentStatus,
                type: "GET", 
                data: {
                    "_token": _token
                },
    ...
    voucher.prototype.update_vouchers = function()
    {   
        var _url = _baseUrl + 'accounting/journal-entries/' + voucherSegment + '/update-vouchers/' + _voucherID;
        $.ajax({
            type: 'PUT',
            url: _url,
    ...
    {   
        ...
        var _replenish = $('input[name="is_replenish"]:checked').length;
        var _modal = _table.closest('.modal');
        var _rows  = '';
        var _url = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/view-available-payables/' + _id + '?fund_code=' + $('#fund_code_id').val() + '&payee=' + $('#payee_id').val() + '&replenish=' + _replenish;
        console.log(_url);
        $.ajax({
            type: 'GET',
            url: _url,
    ...
    {   
        ...
        console.log(_baseUrl + 'treasury/journal-entries/' + voucherSegment + '/get-voucher');
        $.ajax({
            type: "GET",
            url: _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/get-voucher',
            success: function(response) {
                console.log(response);
                ...
                if (_voucherID > 0) {
                    ...
                    _deductionsCard.find('th.total-amount').text($.voucher.price_separator($.voucher.money_format(response.data.total_deductions)));
                }
    ...
    {   
        ...
        console.log(_baseUrl + 'treasury/journal-entries/' + voucherSegment + '/deductions/fetch-status/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/deductions/fetch-status/' + _id,
            success: function(response) {
                console.log(response);
                _status = response.status;
            },
    ...
    {   
        var _status = false;
        console.log(_baseUrl + 'treasury/journal-entries/' + voucherSegment + '/deductions/validate-approver/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/deductions/validate-approver/' + _id,
            success: function(response) {
                console.log(response);
                _status = response;
            },
    ...
    {   
        var _remarks = '';
        console.log(_baseUrl + 'treasury/journal-entries/' + voucherSegment + '/deductions/fetch-remarks/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/deductions/fetch-remarks/' + _id,
            success: function(response) {
                console.log(response);
    ...
    {   
        ...
        console.log(_baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payables/fetch-status/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payables/fetch-status/' + _id,
            success: function(response) {
                console.log(response);
                _status = response.status;
            },
    ...
    {   
        var _status = false;
        console.log(_baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payables/validate-approver/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payables/validate-approver/' + _id,
            success: function(response) {
                console.log(response);
                _status = response;
            },
    ...
    {   
        ...
        console.log(_baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payments/fetch-status/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payments/fetch-status/' + _id,
            success: function(response) {
                console.log(response);
                _status = response.status;
            },
    ...
    {   
        var _status = false;
        console.log(_baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payments/validate-approver/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payments/validate-approver/' + _id,
            success: function(response) {
                console.log(response);
                _status = response;
            },
    ...
    {   
        var _remarks = '';
        console.log(_baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payables/fetch-remarks/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payables/fetch-remarks/' + _id,
            success: function(response) {
                console.log(response);
                _remarks = response.remarks;
            },
    ...
    {   
        var _remarks = '';
        console.log(_baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payments/fetch-remarks/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payments/fetch-remarks/' + _id,
            success: function(response) {
                console.log(response);
                _remarks = response.remarks;
            },
    ...
    {   
        var _type = 0;
        console.log(_baseUrl + 'treasury/journal-entries/' + voucherSegment + '/fetch-disbursement-type/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/fetch-disbursement-type/' + _id,
            success: function(response) {
                console.log(response);
                _type = response.type;
            },
    ...
    {
        var _reference = '';
        console.log(_baseUrl + 'treasury/journal-entries/' + voucherSegment + '/fetch-disbursement-reference/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/fetch-disbursement-reference/' + _id,
            success: function(response) {
                console.log(response);
    ...
    {
        var _voucherPrint = 0;
        console.log(_baseUrl + 'treasury/journal-entries/' + voucherSegment + '/fetch-voucher-print?id=' + _id + '&type=' + _type);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/fetch-voucher-print?id=' + _id + '&type=' + _type,
            success: function(response) {
                console.log(response);
    ...
    {
        var _voucherPrint = 0;
        console.log(_baseUrl + 'treasury/journal-entries/' + voucherSegment + '/fetch-document-status?id=' + _id + '&type=' + _type);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/fetch-document-status?id=' + _id + '&type=' + _type,
            success: function(response) {
                console.log(response);
                _voucherPrint = response.data;
            },
    ...
    {
        var _voucherPrint = 0;
        console.log(_baseUrl + 'treasury/journal-entries/' + voucherSegment + '/fetch-document-remarks?id=' + _id + '&type=' + _type);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/fetch-document-remarks?id=' + _id + '&type=' + _type,
            success: function(response) {
                console.log(response);
                _voucherPrint = response.data;
            },
    ...
    {   
        ...
        */
        this.$body.on('click', '#voucherTable .edit-btn', function (e) {
            ...
            var _url    = (_status == 'completed') ? _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/view/' + _id : _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/edit/' + _id;
        ...
        */
        this.$body.on('click', '#payablesTable .view-btn, #payablesTable .edit-btn', function (e) {
            ...
            var _url    = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payables/edit/' + _id;
        ...
        */
        this.$body.on('click', '#payablesTable .remove-btn', function (e) {
            ...
            var _status = _self.closest('tr').attr('data-row-status');
            var _url    = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payables/remove/' + _id;
            ...
            if (_fund.val() > 0) {
                ...
                {  
                    if (v1 == 'draft') {
                        ...
                        _self.prop('disabled', false).html('<i class="ti-plus align-middle me-2"></i> ADD');
                        window.onkeydown = null;
                        window.onfocus = null;    
                    }
                });
        ...
        */
        this.$body.on('click', '#paymentsTable .edit-btn', function (e) {
            ...
            var _status = _self.closest('tr').attr('data-row-status');
            var _modal  = $('#add-payment-modal');
            var _url    = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payments/edit/' + _id;
            console.log(_url);
            _paymentID = _id;
            _self.prop('disabled', true).attr('title', 'Loading...').html('<div class="spinner-border spinner-border-sm text-white" role="status" aria-hidden="true"><span class="visually-hidden">Loading...</span></div>');
            $.ajax({
        ...
        */
        this.$body.on('click', '#paymentsTable .remove-btn', function (e) {
            ...
            var _status = _self.closest('tr').attr('data-row-status');
            var _type   = _self.closest('tr').attr('data-row-type');
            var _url    = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payments/remove/' + _id;
        ...
        /*
        | ---------------------------------
        | # print voucher button is clicked
        | ---------------------------------
        */
        this.$body.on('click', '.print-voucher-btn', function (e) {
            ...
            var _url  = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/print/' + _voucher + '?type=' + _type; 
        ...
        this.$body.on('click', '.preview-voucher-btn', function (e) {
            ...
            var _type = _self.attr('data');
            var _voucher = $('#voucher-card input[name="voucher_no"]').val();
            var _url  = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/preview/' + _voucher + '?type=' + _type; 
            window.open(_url, '_blank');
        });
        ...
        */
        this.$body.on('click', '#del-payable-btn', function (e) {
            ...
            var _id   = $.voucher.fetchID();
            var _url    = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payables/remove-all/' + _id;
            var _payablesCard = $('#payable-card');
            var _label = (voucherSegment == 'payables') ? 'payables' : 'collections';
        ...
        */
        this.$body.on('click', '#send-payable-btn', function (e) {
            ...
            var _code = $('input[name="voucher_no"]').val();
            var _id   = $.voucher.fetchID();
            var _url    = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payables/send-all/' + _id;
            var _payablesCard = $('#payable-card');
            var _label = (voucherSegment == 'payables') ? 'payables' : 'collections';
        ...
        */
        this.$body.on('click', '#del-payment-btn', function (e) {
            ...
            var _code = $('input[name="voucher_no"]').val();
            var _id   = $.voucher.fetchID();
            var _url    = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payments/remove-all/' + _id;
            var _paymentsCard = $('#payment-card');
        ...
        */
        this.$body.on('click', '#send-payment-btn', function (e) {
            ...
            var _code = $('input[name="voucher_no"]').val();
            var _id   = $.voucher.fetchID();
            var _url    = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payments/send-all/' + _id;
            var _paymentsCard = $('#payment-card');
            var _label = (voucherSegment == 'payables') ? 'payments' : 'deposits';
        ...
        */
        this.$body.on('click', '#paymentsTable .print-btn', function (e) {
            ...
            var _url  = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/print-cheque/' + _id;
            window.open(_url, '_blank');
        }); 
        ...
        */
        this.$body.on('click', '#payablesTable .approve-btn', function (e) {
            ...
            var _url    = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payables/approve/' + _id;
        ...
        */
        this.$body.on('click', '#paymentsTable .approve-btn', function (e) {
            ...
            var _id     = $(this).closest('tr').attr('data-row-id');
            var _code   = $(this).closest('tr').attr('data-row-code');
            var _url    = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/payments/approve/' + _id;
            var _label = (voucherSegment == 'payables') ? 'payment' : 'deposit';
        ...
        */
        this.$body.on('click', '.print-disbursement-btn', function (e) {
            ...
            $.when( d1 ).done(function ( v1 ) 
            {
                var _url  = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/print/' + _voucher + '?type=' + _type + '&reference_no=' + v1;
                window.open(_url, '_blank');
            });
        });
        ...
        */
        this.$body.on('click', '#deductionTable .view-btn, #deductionTable .edit-btn', function (e) {
            ...
            var _status = _self.closest('tr').attr('data-row-status');
            var _modal  = $('#account-payable-modal');
            var _url    = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/deductions/view/' + _id;
            console.log(_url);
            _payableID = _id;
            _self.prop('disabled', true).attr('title', 'Loading...').html('<div class="spinner-border spinner-border-sm text-white" role="status" aria-hidden="true"><span class="visually-hidden">Loading...</span></div>');
            $.ajax({
        ...
        */
        this.$body.on('click', '#send-deduction-btn', function (e) {
            ...
            var _code = $('input[name="voucher_no"]').val();
            var _id   = $.voucher.fetchID();
            var _url    = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/deductions/send-all/' + _id;
        ...
        */
        this.$body.on('click', '#deductionTable .approve-btn', function (e) {
            ...
            var _id     = $(this).closest('tr').attr('data-row-id');
            var _code   = $(this).closest('tr').attr('data-row-code');
            var _url    = _baseUrl + 'treasury/journal-entries/' + voucherSegment + '/deductions/approve/' + _id;
