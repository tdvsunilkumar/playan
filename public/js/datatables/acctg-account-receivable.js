!function($) {
    ...
    {   
        _table = new DataTable('#accountReceivableTable', {
            ajax: { 
                url : _baseUrl + 'accounting/account-receivables/lists?status=' + _status,
                type: "GET", 
                data: {
                    "_token": _token
                },
    ...
    {   
        ...
        */
        this.$body.on('click', 'a[data-bs-original-title="Download Receivables"]', function (e) {
            ...
            var _url    = _baseUrl + 'accounting/account-receivables/export?keywords=' + _keywords + '&status=' + _status;
