!function($) {
    ...
    {   
        ...
        var _rows  = '';
        var _url = _baseUrl + 'accounting/journal-entries/' + voucherSegment + '/view-available-payables/' + _id + '?fund_code=' + $('#fund_code_id').val() + '&payee=' + $('#payee_id').val() + '&replenish=' + _replenish;
        console.log(_url);
        $.ajax({
            type: 'GET',
            url: _url,
