!function($) {
    ...
    var _repairID = 0, _lineID = 0; var _repairTable, _historyTable, _itemTable; 
    var _repairStatus = 'all'; var _repairPage = 0, _historyPage = 0, _itemPage = 0; var _codex = '';
    var _repairs = [];
    ...
    {   
        _repairTable = new DataTable('#repairTable', {
            ajax: { 
                url : _baseUrl + 'for-approvals/repairs-and-inspections/inspections/lists?status=' + _repairStatus,
                type: "GET", 
                data: {
                    "_token": _token
                },
    ...
    for_approval_repair.prototype.history_contents = function(_historyPage = 0) 
    {   
        _historyTable = new DataTable('#repairHistoryTable', {
            ajax: { 
                url : _baseUrl + 'for-approvals/repairs-and-inspections/inspections/history-lists/' + _repairID + '?fixed_asset=' + $('#property_id').val(),
                type: "GET", 
                data: {
                    "_token": _token
                },
    ...
    for_approval_repair.prototype.item_contents = function(_itemPage = 0) 
    {   
        _itemTable = new DataTable('#repairItemsTable', {
            ajax: { 
                url : _baseUrl + 'for-approvals/repairs-and-inspections/inspections/item-lists/' + _repairID,
                type: "GET", 
                data: {
                    "_token": _token
                },
    ...
    {   
        var _status = false;
        console.log(_baseUrl + 'for-approvals/repairs-and-inspections/inspections/validate-approver/' + _id + '/' + _sequence);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'for-approvals/repairs-and-inspections/inspections/validate-approver/' + _id + '/' + _sequence,
    ...
    {   
        ...
        console.log(_baseUrl + 'for-approvals/repairs-and-inspections/inspections/fetch-status/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'for-approvals/repairs-and-inspections/inspections/fetch-status/' + _id,
            success: function(response) {
                console.log(response);
    ...
    {   
        var _remarks = '';
        console.log(_baseUrl + 'for-approvals/repairs-and-inspections/inspections/fetch-remarks/' + _id);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'for-approvals/repairs-and-inspections/inspections/fetch-remarks/' + _id,
            success: function(response) {
                console.log(response);
    ...
    {  
        console.log(_baseUrl + 'for-approvals/repairs-and-inspections/inspections/preload-fixed-asset/' + _fixedAsset);
        $.ajax({
            type: "GET",
            url: _baseUrl + 'for-approvals/repairs-and-inspections/inspections/preload-fixed-asset/' + _fixedAsset,
            success: function(response) {
                console.log(response);
    ...
    {   
        ...
        */
        this.$body.on('click', '#repairTable .approve-btn', function (e) {
            ...
            var _url    = _baseUrl + 'for-approvals/repairs-and-inspections/inspections/approve/' + _id;
        ...
        */
        this.$body.on('click', '#repairTable .view-btn', function (e) {
            ...
            var _url    = _baseUrl + 'for-approvals/repairs-and-inspections/inspections/view/' + _id;
            console.log(_url);
            _repairID = _id;
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    {  
                        ...
                        $.for_approval_repair.item_contents();
                    });
        ...
        */
        this.$body.on('click', '#repairItemsTable .edit-btn, #repairItemsTable .view-btn', function (e) {
            ...
            var _url    = _baseUrl + 'for-approvals/repairs-and-inspections/inspections/edit-item/' + _id;
            console.log(_url);
            _lineID = _id;
            _self.prop('disabled', true).attr('title', 'Loading...').html('<div class="spinner-border spinner-border-sm text-white" role="status" aria-hidden="true"><span class="visually-hidden">Loading...</span></div>');
            $.ajax({
