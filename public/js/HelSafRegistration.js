...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'Health-and-safety/registration/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
				"reg_date_form":$("#reg_date_form").val(),
				"reg_date_to":$("#reg_date_to").val(),
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   reverseButtons: true
	   	...
	   	if(result.isConfirmed){
		  	$.ajax({
			   url :DIR+'Health-and-safety/registration/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
