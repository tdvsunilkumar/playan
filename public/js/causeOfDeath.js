...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'ecocauseofdeath/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
...
function DeleteRecord(id){
	// alert(id);
        ...
        swalWithBootstrapButtons.fire({
            ...
            {
               $.ajax({
			        url :DIR+'ecocauseofdeath/delete', // json datasource
			        type: "POST", 
			        data: {
			          "id": id, 
			          "_token": $("#_csrf_token").val(),
...
function isDefaultUpdate(id,is_print){
    ...
    swalWithBootstrapButtons.fire({
        ...
        {
           $.ajax({
		        url :DIR+'ecocauseofdeath/defaultUpdateCode', // json datasource
		        type: "POST", 
		        data: {
		          "id": id,
		          "is_print": is_print,  
