...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'fees-master/business-garbage-fee/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
        	...
        	{ "data": "bgf_fee_option" },
        	{ "data": "bgf_fee_amount" },
        	{ "data": "bgf_tax_schedule" },
        	{ "data": "bgf_revenue_code" },
        	{ "data": "bgf_remarks" },
        	{ "data": "is_active" },
            { "data": "action" }
        ],
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'fees-master/business-garbage-fee/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
