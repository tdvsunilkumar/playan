...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'hr-pagibig/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
            { "data": "srno" },
			{ "data": "hrpit_description" },
			{ "data": "hrpit_amount_from" },
			{ "data": "hrpit_amount_to" },
			{ "data": "hrpit_personal" },
			{ "data": "hrpit_gov" },
			{ "data": "is_active" },
        	{ "data": "action" }
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'hr-pagibig/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
