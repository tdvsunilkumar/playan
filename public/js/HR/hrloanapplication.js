...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'loan-application/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
            { "data": "srno" },
			{ "data": "hrla_employeesid" },
			{ "data": "hrla_application_no" },
			{ "data": "hrla_id" },
			{ "data": "hrla_loan_description" },
			{ "data": "hrla_loan_status" },
			{ "data": "hrla_loan" },
        	{ "data": "action" }
        ],
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'loan-application/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
