...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'hr-tax/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
            { "data": "srno" },
			{ "data": "hrtt_description" },
			{ "data": "hrtt_amount_from" },
			{ "data": "hrtt_amount_to" },
			{ "data": "hrtt_fixed_amount" },
			{ "data": "hrtt_percentage" },
        	{ "data": "action" }
        ],
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'hr-tax/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
