...
function ActiveInactiveUpdate(id,is_newRenew){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   reverseButtons: true
	   	...
	   	if(result.isConfirmed){
		  	$.ajax({
			   url :DIR+'business-online-application/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
...
function newRenewUpdate(id,is_newRenew){
	...
	swalWithBootstrapButtons.fire({
		title: 'Are you sure?',
		text: "You want to change application type to "+msg,
		icon: 'warning',
		showCancelButton: true,
		confirmButtonText: 'Yes',
		cancelButtonText: 'No',
		reverseButtons: true
			...
			if(result.isConfirmed){
			   $.ajax({
				url :DIR+'business-online-application/NewRenew', // json datasource
				type: "POST", 
				data: {
				  "id": id,
