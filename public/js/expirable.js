...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'health-and-safety/medicine-supplies/expirable-inventory/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
	...
	swalWithBootstrapButtons.fire({
		...
		reverseButtons: true
			...
			if(result.isConfirmed){
			   $.ajax({
				url :DIR+'health-and-safety/medicine-supplies/expirable-inventory/ActiveInactive', // json datasource
				type: "POST", 
				data: {
				  "id": id,
