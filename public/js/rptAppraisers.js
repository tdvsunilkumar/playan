...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'rptappraisers/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
       ...
       "columns": [
       	    { "data": "no" },
       	    { "data": "is_sgd" },
        	{ "data": "ra_appraiser_name" },
			{ "data": "department" },
        	{ "data": "ra_appraiser_position" },
			{ "data": "registered_by" },
        	{ "data": "is_active" },
            { "data": "action" }
        ],
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'rptappraisers/appraisersActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
