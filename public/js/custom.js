...
$(document).ready(function () {
    ...
    if($("#openPrintDialog").length>0){
        setTimeout(function() {
            var pdfFrame = document.getElementById("openPrintDialog");
...
function select2() {
    if ($("form .select3").length > 0) {
        $($("form .select3")).each(function (index, element) {
            if (!$(this).hasClass("select3-hidden-accessible") && !$(this).hasClass("select3-container")) {
