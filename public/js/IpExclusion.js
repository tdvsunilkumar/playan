...
function datatablefunction()
{
	...
	var table = $('#Jq_datatablelist').DataTable({ 
		...
		"searching": false,
		"order": [],
		"columnDefs": [{ orderable: false, targets: [0,4,9] }],
		"pageLength": 10,
		"ajax":{ 
			url :DIR+'ip-security-exclusion/getList', // json datasource
			type: "GET", 
			"data": {
				"q":$("#q").val(),
...
function ActiveInactiveUpdate(id,is_activeinactive){
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   {
		  $.ajax({
			   url :DIR+'ip-security-exclusion/ActiveInactive', // json datasource
			   type: "POST", 
			   data: {
				 "id": id,
