...
@section('action-btn')
    <div class="float-end">
        <a href="#" id="filter_box" class="btn btn-sm btn-primary action-item" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="ti-filter"></i>
        </a>
    </div>
@endsection
...
@section('content')
                    ...
                    <div class="table-responsive">
                        <table class="table" id="Jq_datatablelist">
                            ...
                            <tr>
                                ...
                                <th>{{__('Status of Application')}}</th>
                                <th>{{__('Payment Mode')}}</th>
                                <th>{{__('TOP[Payment Status]')}}</th>
                                <th>{{__('Action')}}</th>
                            </tr>
                            </thead>
                           </table>
    ...
    <script src="{{ asset('js/Bplo/TreasurerAssessment.js') }}"></script>
@endsection
