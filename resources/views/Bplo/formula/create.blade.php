...
{{ Form::open(array('url' => 'CtoDataFormula','class'=>'formDtls','id'=>'CtoChargeDescription')) }}
{{ Form::hidden('id',$data->id, array('id' => 'id')) }}
    <div class="modal-body">
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    {{ Form::label('df_desc', __('Description'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                    <span class="validate-err">{{ $errors->first('df_desc') }}</span>
                    <div class="form-icon-user">
                         {{ Form::text('df_desc', $data->df_desc, array('class' => 'form-control','maxlength'=>'150','required'=>'required')) }}
                    </div>
