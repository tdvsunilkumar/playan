                        ...
                        <div id="flush-collapseone2" class="accordion-collapse collapse show" aria-labelledby="flush-headingone2" data-bs-parent="#accordionFlushExample2">
                            <div class="basicinfodiv">
                                ...
                                <div class="row instruction-dtls currentyearDetails">
                                    <div class="col-md-12">
                                        <p><b>Note -</b> This SECTION display all the outstanding details of the taxpayers business tax.</p>
                                    </div>
                                </div>
                                <div class="fee-details" id="jqCurrentYearDetails"></div>
                                <!----------- Start Previous Payment Details -------->
                                <div class="row instruction-dtls currentyearDetails">
                                    <div class="col-md-12">
                                        <p><b>Note -</b> This SECTION display all the delinquency details of the taxpayers business tax.</p>
                                    </div>
                                </div>
                                <div class="fee-details" id="assesmentDetails"></div>
                                <!----------- End Previous Payment Details -------->
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="assessmentFeeModal">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
           ...
           <div class="modal-footer"> 
               <a class="btn btn-primary" target="_blank" href="{{url('/treasurer/assessment/generatePaymentPdf?id='.$data->busn_id.'&year='.date('Y').'&app_code=3')}}"> <i class="ti-printer text-white fs-12"></i> Print</a>
            </div>
           <div class="container">
...
<script src="{{ asset('js/Bplo/add_DelinquencyOutstanding.js?v='.rand(000,9999999999)) }}"></script>
