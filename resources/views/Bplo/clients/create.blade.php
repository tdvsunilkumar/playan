{{ Form::open(array('url' => 'bploclients','id'=>'storePropertyOwnerForm')) }}
                ...
                <div  class="accordion accordion-flush">
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseone" class="accordion-collapse collapse show" aria-labelledby="flush-headingone1" data-bs-parent="#accordionFlushExample">
                            <div class="basicinfodiv" style="margin-bottom:150px;">
                                <div class="row">
...
<script src="{{ asset('js/Bplo/add_bploclients.js') }}"></script>
...
function uploadAttachmentonly(){
	...
	showLoader();
	$.ajax({
	   url : DIR+'bploclients-uploadDocument',
	   type : 'POST',
	   data : formData,
	   ...
	   swalWithBootstrapButtons.fire({
		   ...
		   reverseButtons: true
			...
			if(result.isConfirmed){
				showLoader();
				$.ajax({
				   url :DIR+'bploclients-deleteAttachment', // json datasource
				   type: "POST", 
				   data: {
