...
@section('page-title')
    ...
    {{__('Real Property: Accounts Receivables')}}
@endsection
@push('script-page')
@endpush
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Real Property: Accounts Receivables')}}</li>
@endsection
@section('action-btn')
<style type="text/css">
       ...
       <a href="#" class="btn btn-sm btn-primary dropdown-toggle" type="button" id="columnDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="columnDropdown">
            <div class="card card-body">
                ...
                <label><input type="checkbox" id="chk_Address" class="toggle-column" data-column="18" checked> BASIC TAX</label>   
                <label><input type="checkbox" id="chk_Address" class="toggle-column" data-column="19" checked> SEF</label>
                <label><input type="checkbox" id="chk_Address" class="toggle-column" data-column="20" checked> SHT</label>
                <label><input type="checkbox" id="chk_Address" class="toggle-column" data-column="21" checked> TOTAL</label>
                <label><input type="checkbox" id="chk_Address" class="toggle-column" data-column="22" checked> TOTAL</label>
                <label><input type="checkbox" id="chk_Address" class="toggle-column" data-column="23" checked> ACTION</label>
...
<style type="text/css">
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12 pdr-20" >
                                <div class="form-group">
                                    {{Form::label('revisionyear',__("Property"),['class'=>'form-label'])}}
                                    <div class="btn-box">
                                       
                                    {{ Form::select('kind_filter',$kinds,'', array('class' => 'form-control','id'=>'rptPropertySearchByKind','placeholder' => 'All')) }}
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12 pdr-20" id="barangaydiv">
                                <div class="form-group">
                                    ...
                                    <div class="btn-box">
                                     ...
                                     {{ Form::select('barangay',[],'', array('class' => 'form-control','id'=>'barangay','required'=>'required')) }}
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12 pdr-20" id="barangaydiv">
                                <div class="form-group">
                                    ...
                                    <div class="btn-box">
                                     ...
                                     {{ Form::select('taxpayer',[],'', array('class' => 'form-control','id'=>'taxpayer','required'=>'required')) }}
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12 pdr-20" id="barangaydiv">
                                <div class="form-group">
                                    ...
                                    {{ Form::select('tax',[],'', array('class' => 'form-control','id'=>'tax','required'=>'required')) }}
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table" id="Jq_datatablelist">
                            ...
                            <tr>
                                ...
                                <th colspan="4" style="border:1px solid #fff;text-align: center;">{{__('Current Year')}}</th>
    ...
    <script src="{{ asset('js/accountreceivablesProperty.js') }}?rand={{rand(0,999)}}"></script>
