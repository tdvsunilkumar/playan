{{Form::open(array('name'=>'forms','url'=>'rptbuilding/approve','method'=>'post','id'=>'saveApprovelFormData'))}}
...
<div class="modal-header">
                ...
                <a class="close closeApprovalFormModel" data-dismiss="modal" aria-hidden="true" type="add" mid="">X</a>
                        ...
                        <div class="table-responsive">
                            <table class="table" id="new_added_land_apraisal">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 5%;">
                                            ...
                                            <a data-toggle="modal" href="javascript:void(0)" data-propertyid="{{ (isset($approvelFormData->rp_code) && $approvelFormData->rp_code != '')?$approvelFormData->rp_code:'' }}" id="{{(isset($approvelFormData->rp_code) && $approvelFormData->rp_code != '')?'addPreviousOwnerForBuilding':''}}" class="btn btn-primary" ><i class="ti-plus"></i></a>
                                            @endif
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    @php
                                   // dd($val->cancelProp);
                                        $pau_actual_use_code = (!$val->cancelProp->floorValues->isEmpty())?$val->cancelProp->floorValues[0]->actualUses->pau_actual_use_code.'-'.$val->cancelProp->floorValues[0]->actualUses->pau_actual_use_desc:'';
                                         @endphp
                                        <tr class="font-style" >
                                                                    ...
                                                                    <td class="app_qurtr">{{ number_format($val->cancelProp->floorValues->sum('rpb_assessed_value'), 2, '.', ',') }}</td>
                    ...
                    <div id="flush-collapseone" class="accordion-collapse collapse show" aria-labelledby="flush-headingone1" data-bs-parent="#accordionFlushExample">
                        <div class="basicinfodiv">
                            <div class="row">
                             ...
                             <div class="row">
                                ...
                                {{ Form::checkbox('rp_app_recommend_is_signed', '1', (isset($approvelFormData->rp_app_recommend_is_signed))?$approvelFormData->rp_app_recommend_is_signed:0, array('id'=>'rp_app_recommend_is_signed','class'=>'form-check-input rp_app_recommend_is_signed')) }}
                                 ...
                                 <div class="col-lg-1 col-md-1 col-sm-1">
                                       {{Form::label('rp_app_effective_quarter',__('Quarter'),['class'=>'form-label'])}} <span class="text-danger">*</span>
                                </div>  
                                 <div class="col-lg-1 col-md-1 col-sm-1">
                                        <div class="form-icon-user">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 textright" style="text-align: left;">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 textright">
                                 ...
                                 <div class="col-lg-10 col-md-10 col-sm-10">
                                        <div class="form-icon-user">
                                            ...
                                            {{ Form::select('rp_app_cancel_by_td_id',$allTds,(isset($approvelFormData->rp_app_cancel_by_td_id))?$approvelFormData->rp_app_cancel_by_td_id:'', array('class' => 'form-control rp_app_cancel_by_td_id','id'=>'rp_app_cancel_by_td_id','disabled' => true,'multiple'=>'multiple')) }}
