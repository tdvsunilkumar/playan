{{Form::open(array('name'=>'forms','url'=>'rptbuilding/rc/submit','method'=>'post','id'=>'reclassificationIntermediateSubmission'))}}
       ...
       <div class="row">
            ...
            <div class="accordion accordion-flush">
                <div class="accordion-item">
                    <h6 class="accordion-header" id="flush-headingtwo">
                        <button class="accordion-button collapsed btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsetwo" aria-expanded="false" aria-controls="flush-headingtwo">
                        <h6 class="sub-title accordiantitle">{{__('Building Floor Value')}}</h6>
                        </button>
                    </h6>
                                ...
                                <tbody>
                                    ...
                                    @foreach($selectedProperty->floorValues as $val)
                                        <tr class="font-style">
                                            ...
                                            <td class="app_qurtr">{{ Helper::decimal_format($val->rpbfv_floor_unit_value) }}</td> 
                                            <td class="app_qurtr">{{ Helper::decimal_format($val->rpbfv_floor_base_market_value) }}</td>
                                            <td class="app_qurtr">{{ Helper::decimal_format($val->rpbfv_floor_additional_value) }}</td> 
                                            <td class="rpa_base_market_value">{{ Helper::decimal_format($val->rpbfv_floor_adjustment_value) }}</td>
                                            <td class="app_qurtr">{{ Helper::decimal_format($val->rpbfv_total_floor_market_value) }}</td>
                                        </tr>
                                    @endforeach
                                    @endif
