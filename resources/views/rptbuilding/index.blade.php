...
@section('page-title')
    {{__('Property Building')}}
@endsection
@push('script-page')
@endpush
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item">{{__('Property Building')}}</li>
@endsection
@section('action-btn')
    <div class="float-end">

         <a href="#" class="btn btn-sm btn-primary uploadNewProperties" data-size="lg" data-url="{{ url('/rptbuilding/bulkUpload') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Manage Bulk Upload')}}" {{ (session()->get('buildingSelectedBrgy') == '')?'hidden':''}}>
        ...
        <a href="#"  data-url="{{ url('/rptbuilding/store') }}" title="{{__('New Property')}}" class="btn btn-sm btn-primary addNewProperty" {{ (session()->get('buildingSelectedBrgy') == '')?'hidden':''}}>
            <i class="ti-plus"></i>
        </a>
...
@section('content')
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12 pdr-20">
                                <div class="btn-box">
                                    ...
                                    {{ Form::select('barangy_filter',$arrBarangay,session()->get('buildingSelectedBrgy'), array('class' => 'form-control','id'=>'rptPropertySearchByBarangy')) }}
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12 pdr-20">
                                <div class="btn-box">
    ...
    <div class="modal" id="addPreviousOwnerForBuildingModal"  style="z-index:99999999 !important;">
   <div class="modal-dialog " >
      <div class="modal-content" >
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel"></h5>
    ...
    <script src="{{ asset('js/rptBuildingNew.js') }}"></script>
@endsection
