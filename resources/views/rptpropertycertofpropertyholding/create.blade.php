            ...
            table tr:hover {
             ...
             <div class="col-lg-12 col-md-12 col-sm-12"  id="accordionFlushExample3">  
                ...
                <tr id="ownerdetails"  class="clientdata" style="border: 1px solid #ccc;">
                   ...
                   <td><input type="radio" name="rpc_owner_code" value="{{$val->clientsId}}" class="clientdata" checked></td>
                   <td >{{$val->full_name}}</td>
           ...
           <div class="col-lg-12 col-md-12 col-sm-12"  id="accordionFlushExample1">  
              ...
              <!--   @if(($data->id)>0)
                ...
                <tr id="ownerdetails"  class="clientdata" style="border: 1px solid #ccc;">
                    ...
                    <td><input type="checkbox" name="rp_code[]" value="{{$val->propertyId}}"  checked>
                    ...
                    <td>{{$val->rp_lot_cct_unit_desc}}</td>
                    <td>{{$val->brgy_name}}</td>
                    <td>{{$val->rp_market_value}}</td>
                    <td>@if($val->pk_id == 1)
                        {{$val->rpb_assessed_value}}
                        @else
                        {{$val->rp_assessed_value}}
                        @endif
                    </td>
        ...
        <div class="row" style="margin-top: 10px;padding-top: 10px;background: #e6d4d4;">
            ...
            <div class="col-md-4">
              <div class="form-group">
                    ...
                    <div class="form-icon-user">
                        {{ Form::date('rpc_or_date',$data->rpc_or_date, array('class' => 'form-control  z
            ...
            <div class="col-md-4">
              <div class="form-group">
                    ...
                    <div class="form-icon-user">
                        ...
                        ','id'=>'rpc_or_amount','readonly','step'=>'0.01')) }}
                    </div>
                    <span class="validate-err" id="err_rvy_revision_year"></span>
                </div>
            </div>
