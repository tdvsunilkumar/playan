...
@section('page-title')
    ...
    {{__('Certificate of Property Holdings')}}
@endsection
@push('script-page')
@endpush
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Certificate of Property Holdings')}}</li>
@endsection
@section('action-btn')
    <div class="float-end">
...
<script src="{{ asset('js/certificateOfHolding.js') }}?rand={{ rand(000,999) }}"></script>
@endsection
