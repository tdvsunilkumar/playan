...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Inspection Report') }}</li>
@endsection
</div>
@section('action-btn')
    <div class="float-end">
        ...
        <a href="#" style="display:none;" data-size="lg" data-bendid="1" data-busnid="1" data-url="{{ url('/environmental-inspection-report/store') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{ __('Create') }}" data-title="{{ __('Add Inspection Report') }}" class="btn btn-sm btn-primary">
            <i class="ti-plus"></i>
        </a>
    </div>
@endsection
...
<div class="row" id="this_is_filter">
    ...
    <script src="{{ asset('js/envirinspereport.js') }}"></script>
@endsection
