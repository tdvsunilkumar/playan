{{ Form::open(array('url' => 'cpdoapplication/certification','class'=>'formDtls','id'=>'storeJobService','enctype'=>'multipart/form-data')) }}
                                    ...
                                    <div class="col-md-2">
                                     ...
                                     <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('address',$certificatedata->locationproject, array('class' => 'form-control disabled-field','id'=>'address','required'=>'required')) }}
                                            </div>
                                    ...
                                    <div class="col-md-2">
                                     ...
                                     <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('telephoenumber',$certificatedata->telephone, array('class' => 'form-control disabled-field','id'=>'telephoenumber','required'=>'required')) }}
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('cc_name_project',$certificatedata->cc_name_project, array('class' => 'form-control disabled-field','id'=>'cc_name_project','required'=>'required')) }}
                                            </div>
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('cc_location',$certificatedata->cclocation, array('class' => 'form-control disabled-field','id'=>'cc_location','required'=>'required')) }}
                                            </div>
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('cc_site_classification',$certificatedata->cc_site_classification, array('class' => 'form-control field-disabled','id'=>'cc_site_classification','required'=>'required')) }}
                                            </div>
                                        ...
                                        <div class="basicinfodiv">
                                            ...
                                            <div class="row"> 
                                                <div class="col-md-6" id="prparedbydiv">
                                                    <div class="form-group">
                                                        {{ Form::label('prparedby', __('Prepared By'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                                 ...
                                                 <div class="col-md-2" style="margin-top: 36px;">
                                                     ...
                                                     @if(($certificatedata->id)>0)   
                                                        ...
                                                        {{ Form::label('cc_recom_status', __('Approved'),['class'=>'form-label']) }}
                                                        @else
                                                  ...
                                                  <div class="col-md-2" style="margin-top: 36px;">
                                                     ...
                                                     <div class="form-check form-check-inline form-group col-md-3">
                                                      ...
                                                      @if($certificatedata->cc_recom_status == 1)  
                                                        ...
                                                        {{ Form::label('cc_notes_status', __('Approved'),['class'=>'form-label']) }}
                                                        @else
                                                 ...
                                                 <div class="col-md-2" style="margin-top: 36px;">
                                                     <div class="form-check form-check-inline form-group col-md-3">
                                                       ...
                                                       @if($certificatedata->cc_recom_status == 1)    
                                                        ...
                                                        {{ Form::label('cc_approval_status', __('Approved'),['class'=>'form-label']) }}
                                                        @else
    ...
    <div class="modal-footer">
        <input type="button" value="{{__('Cancel')}}" class="btn  btn-light" data-bs-dismiss="modal">
         @if(($certificatedata->id)>0 && $certificatedata->cc_approval_status=='1')
          <a href="{{ url('/cpdoapplication/printcertificate?id=').''.$certificatedata->id.'&cafid='.$certificatedata->caf_id }}" title="Print Zoning Clearance Certificate" style="background: #20b7cc;padding: 10px;color: #fff;" data-title="Print Zoning Clearance Certificate" target="_blank" class="mx-3 btn btn-sm digital-sign-btn" id="{{$certificatedata->id}}" >
...
<script src="{{ asset('js/Cpdo/add_application.js') }}"></script> 
