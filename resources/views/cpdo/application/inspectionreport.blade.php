{{ Form::open(array('url' => 'cpdoapplication/inspectionreport','class'=>'formDtls','id'=>'storeJobService','enctype'=>'multipart/form-data')) }}
...
<div class="modal-body">
                ...
                <div  class="accordion accordion-flush">
                    <div class="accordion-item">
                        ...
                        <div  class="accordion-collapse collapse show" aria-labelledby="flush-headingfive" data-bs-parent="#accordionFlushExample5">
                            <div class="basicinfodiv" style="margin-bottom: 0px;margin-top: -6px;">
                                ...
                                <div CLASS="row"> 
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('nameofproject',$inspectiondata->nameofproject, array('class' => 'form-control disabled-field','id'=>'nameofproject','required'=>'required')) }}
                                            </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('locationproject',$inspectiondata->locationproject, array('class' => 'form-control disabled-field','id'=>'locationproject')) }}
                                            </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('cir_zoning_class',$inspectiondata->cir_zoning_class, array('class' => 'form-control field-disabled','id'=>'cir_zoning_class','required'=>'required')) }}
                                            </div>
                        ...
                        <div class="accordion"   style="padding-top: 10px;">  
                            <div  class="accordion accordion-flush">
                                <div class="accordion-item">
                                    ...
                                    <div  class="accordion-collapse collapse show" aria-labelledby="flush-headingfive" data-bs-parent="#accordionFlushExample5">
                                        <div class="basicinfodiv" style="margin-bottom:px;">
                                            <!--  <a data-toggle="modal" href="javascript:void(0)" id="loadAddserviceForm" class="btn btn-primary" type="add">Add Service</a> -->
                                            <!--------------- Land Apraisal Listing Start Here------------------>
                                            <div class="row"> 
                                                <div class="col-md-12">
    ...
    padding-right: 68px;">
                    ...
                    <div class="col-md-3" style="">
                     ...
                     <div class="col-md-3" style="">
                        <div class="form-group " id="orderofpdiv">
                            ...
                            <div class="form-icon-user {{$disabled}}">
                                {{ Form::select('cir_penalty',$penaltyarray,$inspectiondata->cir_penalty, array('class' => 'form-control ','id'=>'cir_penalty','required'=>'required')) }}
                            </div>
                            <span class="validate-err" id="err_cit_id"></span>
                        </div>
                    </div>
                ...
                @if($inspectiondata->id > 0)
                <div class="col-lg-12 col-md-12 col-sm-12"  id="accordionFlushExample3" style="padding-top:10px">  
                        <div  class="accordion accordion-flush">
                            <div class="accordion-item">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-11 col-md-11 col-sm-11">
                                                ...
                                                <div class="col-lg-1 col-md-1 col-sm-1" style="padding-top:25px">
                                                    <button type="button" style="float: center;" class="btn btn-primary" id="uploadAttachmentbtn">Upload File</button>
                                                </div>
                                            </div>
                            ...
                            <div class="accordion-item">
                                <h6 class="accordion-header" id="flush-heading5">
                                    <button class="accordion-button collapsed btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse5" aria-expanded="false" aria-controls="flush-collapse5">
                                        <h6 class="sub-title accordiantitle">
                                            <i class="ti-menu-alt text-white fs-12"></i>
                                            <span class="accordiantitle-icon">{{__("Tagging")}}
                                            </span>
                                        </h6>
                                    </button>
                                </h6>
                                ...
                                <div id="flush-collapse5" class="accordion-collapse collapse" aria-labelledby="flush-heading5" data-bs-parent="#accordionFlushExample4">
                                        <div class="row">
                ...
                <div class="row"> -->
                        <div class="col-md-12">
                          <div class="row field-requirement-details-status">
                            ...
                            <div class="col-lg-1 col-md-1 col-sm-1">
                                 <span class="btn_addmore_geolocation btn btn-primary" id="btn_addmore_geolocation" style="color:white;padding: 5px;"><i class="ti-plus"></i></span>
                            </div>
                        </div>
                         <span class="geolocationDetails activity-details" id="geolocationDetails">
                             {{ Form::hidden('inspectonid',$inspectiondata->id, array('id' => 'inspectonid')) }}
                             @php $i=1; @endphp
                            @foreach($arrLocations as $key=>$val)
                            <div class="removedocumentsdata row pt10" style="padding: 5px;">
                                <div class="col-lg-1 col-md-1 col-sm-1">
                                  <div class="form-group"><div class="form-icon-user">
                                    <p class="serialnoclass" style="text-align:left;">{{$i}}</p>
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-5">
                                    <div class="form-group">
                                       {{ Form::text('linkdesc[]',$val->cig_location_description, array('id' => 'linkdesc'.$i,'class'=>"form-control")) }}
                                       <span class="validate-err linkdesc" id="err_linkdesc{{$i}}"></span>
                                   </div>
                                </div>
                                <div class="col-lg-5 col-md-5 col-sm-5">
                                    <div class="form-group">
                                ...
                                @if($i>=1)
                                    <div class="col-lg-1 col-md-1 col-sm-1">
                                         <div class="form-group">
                                        <a class="btn btn-primary" href="{{$val->cig_location_description}}" target="_blank" style="padding: 5px;"><i class="ti-world"></i></a>
                                         <button type="button" class="btn btn-danger btn_cancel_locations"  value="{{$val->id}}" style="padding: 5px;"><i class="ti-trash"></i></button>
                                       </div>
                                 </div>
                                @endif
                                @php $i++; @endphp
                        ...
                        @endforeach
                        <span class="validate-err linkdesc" id="commonerror"></span>
                         </span>
                         <div class="row" style="padding-top: 0px !important;">
                        <div class="col-md-12">
                           <a href="#"  id="savelocations" data-bs-toggle="tooltip" title="{{__('Search')}}" class="btn btn-sm btn-primary savelocations" style="margin-top: 8px;">
                                       Apply Changes</a>
                        </div>
                     </div>
                       </div>  
    ...
    <div class="modal-footer">
		...
		@endphp
         @if(($inspectiondata->id)>0)
		  @if(isset($inspectiondata->cir_isapprove) ==1)
               <a href="{{ url('/cpdoapplicationprintinspection?id=').''.$inspectiondata->id}}" title="Print Zoning Clearance inspection" style="background: #20b7cc;padding: 10px;color: #fff;" data-title="Print Zoning Clearance inspection" target="_blank" class="mx-3 btn btn-sm digital-sign-btn" id="{{$inspectiondata->id}}" >
...
<div class="modal fade" id="orderofpaymentModal" style="width: 100%;
       ">
                     ...
                     <div class="row" style="padding-bottom: 5px;">
                            ...
                            <div class="col-md-3" style="pointer-events:none;">
                               <div class="form-group">
                                    ...
                                    <div class="form-icon-user">
                                        {{ Form::select('applicantname',$arrOwners,$inspectiondata->cafid, array('class' => 'form-control','id'=>'applicantname','readonly'=>'true')) }}
                                    </div>
...
<div id="hiddenlocationHtml" class="hide">
    <div class="removelocationdata row pt10" style="padding: 5px;">
         <div class="col-lg-1 col-md-1 col-sm-1">
            <div class="form-group">
                    <div class="form-icon-user">
                        <input type="hidden" name="geoid[]">
                        <p class="serialnoclass" style="text-align:left;"></p>
                    </div>
            </div>
          </div>
         <div class="col-lg-5 col-md-5 col-sm-5">
                <div class="form-group">
                <div class="form-icon-user"><input required="required" class="form-control link-input" name="linkdesc[]" type="text" value="">
                    </div>
               </div>
            </div>
            <div class="col-lg-5 col-md-5 col-sm-5">
         ...
         <div class="col-lg-1 col-md-1 col-sm-1">
                     <div class="form-group">
                       <div class="form-icon-user">
                        <a class="btn btn-primary link-button" id="" href="" target="_blank" style="padding: 5px;"><i class="ti-world"></i></a>
                        <button type="button" class="btn btn-danger btn_cancel_locations" style="padding: 5px;"><i class="ti-trash"></i></button>
                       </div>
                   </div>
             </div>
    </div>
...
$(document).ready(function() {
    ...
    $('#hiddenlocationHtml').on('input', '.link-input', function() {
        var inputValue = $(this).val();
        console.log("Input Value: " + inputValue);
        
        var $linkButton = $(this).closest('.removelocationdata').find('.link-button');
        $linkButton.attr('href', inputValue);
        console.log("Updated Href: " + $linkButton.attr('href'));
    });

    // Add more input fields
    $('#addMoreButton').click(function() {
        var html = $('#hiddenlocationHtml .removelocationdata:first').clone();
        html.find('.link-input').val('');
        $('#hiddenlocationHtml').append(html);
    });

    // Remove location data
    $('#hiddenlocationHtml').on('click', '.btn_cancel_locations', function() {
