{{ Form::open(array('url' => 'cpdoclients','id'=>'storePropertyOwnerForm')) }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::select('p_barangay_id_no',$arrgetBrgyCode,$data->p_barangay_id_no,array('class'=>'form-control select3','id'=>'p_barangay_id_no','required'=>'required')) }}
                                            </div>
                                            <span class="validate-err" id="err_ba_p_address"></span>
                                        </div>
                                    </div>
                           <!--  <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-icon-user">
                                        {{Form::number('p_telephone_no',$data->p_telephone_no,array('class'=>'form-control','id'=>'p_telephone_no'))}}
                                    </div>
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-icon-user">
                                        {{Form::number('p_mobile_no',$data->p_mobile_no,array('class'=>'form-control','id'=>'p_mobile_no'))}}
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                             ...
                             <div class="col-md-4" id="natonality">
                               <div class="form-group">
...
<script src="{{ asset('js/add_cpdoclients.js') }}"></script>
...
function uploadAttachmentonly(){
	...
	showLoader();
	$.ajax({
	   url : DIR+'cpdoclients-uploadDocument',
	   type : 'POST',
	   data : formData,
   ...
   swalWithBootstrapButtons.fire({
	   ...
	   reverseButtons: true
		...
		if(result.isConfirmed){
			showLoader();
			$.ajax({
			   url :DIR+'cpdoclients-deleteAttachment', // json datasource
			   type: "POST", 
			   data: {
