<div class="modal form fade" id="ewt-modal" tabindex="-1" role="dialog" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="ewtModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            {{ Form::open(array('url' => 'accounting/setup-data/expanded-withholding-taxes', 'class'=>'formDtls needs-validation', 'name' => 'ewtForm')) }}
            @csrf
                <div class="modal-header bg-accent">
                    <h5 class="modal-title full-width c-white" id="ewtModal">
