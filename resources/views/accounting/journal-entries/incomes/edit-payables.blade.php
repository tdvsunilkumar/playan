<div class="modal form fade" id="account-payable-modal" tabindex="-1" role="dialog" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="accountPayableModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            {{ Form::open(array('url' => 'accounting/journal-entries/incomes/payables', 'class'=>'formDtls needs-validation', 'name' => 'accountPayableForm')) }}
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group m-form__group required">
                                ...
                                {{
                                    Form::select('trans_type', $trans_types, $value = '', ['id' => 'trans_type', 'class' => 'require form-control select3', 'data-placeholder' => 'select a transaction type'])
                                }}
                                <span class="m-form__help text-danger"></span>
                            </div>
                        </div>
                    ...
                    <!-- <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group m-form__group">
                                ...
                                {{
                                    Form::select('ewt_id', $ewts, $value = '', ['id' => 'ewt_id', 'class' => 'form-control select3 disable', 'data-placeholder' => 'select an ewt'])
                                }}
                                <span class="m-form__help text-danger"></span>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group m-form__group disabled">
                                ...
                                {{ 
                                    ...
                                    $attributes = array(
                                        'id' => 'quantity',
                                        'class' => 'require form-control form-control-solid numeric-doubles disable',
                                        'disabled' => 'disabled'
                                    )) 
                                }}
                                <span class="m-form__help text-danger"></span>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group m-form__group disabled">
                                ...
                                {{
                                    Form::select('uom_id', $uoms, $value = '', ['id' => 'uom_id', 'class' => 'require form-control select3 disable', 'data-placeholder' => 'select a uom', 'disabled' => 'disabled'])
                                }}
                                <span class="m-form__help text-danger"></span>
                            </div>
                        </div>
