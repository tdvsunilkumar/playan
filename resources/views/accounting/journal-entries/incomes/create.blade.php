...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="payable-card" class="card table-card">
                <div class="card-header">
                    <h5 class="d-flex">
                        <div class="me-auto">Collection's Details</div>
                                    ...
                                    <table id="payablesTable" class="display dataTable table w-100 table-striped" aria-describedby="payablesInfo">
                                        ...
                                        <tfoot>
                                            ...
                                            <!-- <tr>
                                                ...
                                                <th colspan="2" class="text-start pt-0 pb-0 fs-6 border-0">TOTAL COLLECTIONS</th>
                                            </tr> -->
                                            <!-- <tr>
    ...
    @include('accounting.journal-entries.incomes.add-payables')
    @include('accounting.journal-entries.incomes.add-payments')
    @include('accounting.journal-entries.incomes.add-bank-payments')
    @include('accounting.journal-entries.incomes.add-date')
    @include('accounting.journal-entries.incomes.edit-payables')
    @include('accounting.journal-entries.incomes.disapprove-payable')
    @include('accounting.journal-entries.incomes.disapprove-payment')
    @include('accounting.journal-entries.incomes.disapprove-deduction')
    @include('accounting.journal-entries.incomes.disapprove-document')
    @if ($treasury_permission['download'] > 0 || $accounting_permission['download'] > 0)  
    @include('accounting.journal-entries.incomes.fab-menu')
    @endif
@endsection
