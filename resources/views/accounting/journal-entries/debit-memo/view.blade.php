                                ...
                                <div class="table-responsive">
                                    <table id="deductionTable" class="display dataTable table w-100 table-striped" aria-describedby="deductionInfo">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                <th colspan="5" class="text-end pt-0 pb-0 fs-6 total-pagibig border-0" id="total-pagibig">0.00</th>
                                                <th colspan="1" class="text-start pt-0 pb-0 fs-6 border-0">PAG-IBIG</th>
                                            </tr>
                                            <tr>
                                                <th colspan="5" class="text-end pt-0 pb-0 fs-6 total-philhealth border-0" id="total-philhealth">0.00</th>
                                                <th colspan="1" class="text-start pt-0 pb-0 fs-6 border-0">PHILHEALTH</th>
                                            </tr>
                                            <tr>
                                                <th colspan="5" class="text-end pt-0 pb-0 fs-6 total-bir border-0" id="total-bir">0.00</th>
                                                <th colspan="1" class="text-start pt-0 pb-0 fs-6 border-0">BIR</th>
                                            </tr>
                                            <tr>
                                                <th colspan="5" class="text-end pt-0 pb-0 fs-6 total-gsis border-0" id="total-gsis">0.00</th>
