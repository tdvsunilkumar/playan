...
@section('action-btn')
    <div class="float-end">
        ...
        <a href="{{ url('accounting/journal-entries/payables/add') }}" data-size="lg" data-bs-toggle="tooltip" data-bs-placement="left" title="{{__('Create Voucher')}}" class="btn btn-sm btn-primary add-btn">
            <i class="ti-plus"></i>
        </a>
        @endif
    </div>
