<div class="modal form fade" id="add-bank-payment-modal" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="addPaymentLabel" tabindex="-1">
    <div class="modal-dialog modal-lg">
    <div class="modal-content">
            {{ Form::open(array('url' => 'accounting/journal-entries/payables/payments', 'class'=>'formDtls needs-validation', 'name' => 'payments2Form')) }}
            @csrf
                    ...
                    <div class="fv-row row">
                        <div class="col-sm-6">
                            <div class="form-group m-form__group">
                                ...
                                {{
                                    Form::select('payment_type_id', $payment_types, $value = '', ['id' => 'payment_type_id2', 'class' => 'form-control select3 fs-3', 'data-placeholder' => 'select a payment type', 'disabled' => 'disabled'])
                                }}
                                <span class="m-form__help text-danger"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group m-form__group required">
                                ...
                                <select name="sl_account_id" id="sl_account_id2" class="form-control select3 fs-3" data-placeholder= "select a gl account">
                                    <option value=""></option>
                                    @foreach ($sl_accountx as $sl_account)
