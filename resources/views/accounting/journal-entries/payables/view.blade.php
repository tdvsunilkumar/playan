...
@section('content')
    ...
    @include('accounting.journal-entries.payables.add-payments')
    @include('accounting.journal-entries.payables.add-bank-payments')
    ...
    @include('accounting.journal-entries.payables.fab-menu')
    @endif
@endsection
