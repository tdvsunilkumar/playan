<div class="modal form fade" id="major-account-group-modal" tabindex="-1" role="dialog" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="majorAccountGroupModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            {{ Form::open(array('url' => 'accounting/chart-of-accounts/major-account-groups', 'class'=>'formDtls', 'name' => 'majorAccountGroupForm')) }}
            @csrf
                <div class="modal-header bg-accent">
                    <h5 class="modal-title full-width c-white" id="majorAccountGroupModal">
                        Manage Major Group
