        ...
        <table width="100%" style="border:0px solid black;">
            ...
            <tr>
                ...
                <td width="21%" style="border:0px solid black; border-bottom:solid 1px black;">
                    ...
                    <p style="padding-bottom: 5px;">
                        <img src="assets/storage/uploads/logo/{{ $bplo_business->client->gender == 1 && $bplo_business->btype_id == 1  ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; vertical-align: middle;">Male <img src="assets/storage/uploads/logo/{{ $bplo_business->client->gender == 0 && $bplo_business->btype_id == 1  ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-left: 10px; padding-right:2px; vertical-align: middle;">Female
                    </p>
                </td>
                <td width="22%" style="border:0px solid black; border-bottom:solid 1px black;">
                    ...
                    <p>
                        <img src="assets/storage/uploads/logo/{{ $bplo_business->client->gender == 1 && $bplo_business->btype_id == 2  ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; vertical-align: middle;">Male <img src="assets/storage/uploads/logo/{{ $bplo_business->client->gender == 0 && $bplo_business->btype_id == 2  ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-left: 10px; padding-right:2px; vertical-align: middle;">Female
                    </p>
                </td>
