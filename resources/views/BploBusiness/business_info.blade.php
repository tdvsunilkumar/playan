...
<div class="tab-pane fade show active" id="request-details" role="tabpanel" aria-labelledby="request-details-tab">
    {{ Form::open(array('url' => 'business-permit/application', 'class'=>'formDtls', 'name' => 'requisitionForm')) }}
    @csrf
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group m-form__group required">
                ...
                {{
                    Form::select('btype_id', $bsn_type, $value = '', ['id' => 'btype_id', 'class' => 'form-control select3', 'data-placeholder' => 'Please select'])
                }}
                <span class="m-form__help text-danger"></span>
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="form-group m-form__group">
                {{ Form::label('busn_registration_date', 'Registration Date', ['class' => 'fs-6 fw-bold']) }}
                {{ 
                    Form::date($name = 'busn_registration_date', $value = '', 
                    $attributes = array(
                        'id' => 'busn_registration_date',
                        'class' => 'form-control form-control-solid'
                    )) 
                }}
                <span class="m-form__help text-danger"></span>
                    ...
                    <div class="form-group m-form__group required">
                        ...
                        <div class="form-icon-user d-flex align-items-center">
                            <div class="flex-grow-1">
                                    {{
                                    Form::select('busn_office_main_barangay_id', $barangay, $value = '', ['id' => 'busn_office_main_barangay_id', 'class' => 'form-control select3', 'data-placeholder' => 'Please select'])
                                }}                       
                            </div>
                            <!-- <div class="ms-2">
    ...
    <div class="item-layer" style="padding-bottom: 50px;">
        <h4 class="text-header">Taxpayer Information</h4>
        <div class="row">
            <div class="col-sm-12" id="div_client_id">
                <div class="form-group m-form__group required">
                    ...
                    <div class="form-icon-user d-flex align-items-center">
                        <div class="flex-grow-1">
                            {{
                                Form::select('client_id', $client, $value = '', ['id' => 'client_id', 'class' => 'form-control select3', 'data-placeholder' => 'Please select'])
                            }}                      
                        </div>
                        <!-- <div class="ms-2">
