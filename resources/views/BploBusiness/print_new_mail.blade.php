    ...
    <body>
            ...
            <table width="100%" style="border:1px;">
                ...
                <tr>
                    <td style="width:50%; padding:0px;">
                        <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->app_code == 1 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 5px; vertical-align: middle;">
                        <label for="new_form">NEW</label>
                    </td>
                    <td style="width:50%; padding:0px;">
                        <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->pm_id == 1 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 5px; vertical-align: middle;">
                        <label for="annually">Annually</label>
                    </td>
                </tr>
                <tr>
                    <td style="width:50%; padding:0px;">
                        <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->app_code == 2 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 5px; vertical-align: middle;">
                        <label for="new_form">RENEWAL</label>
                    </td>
                    <td style="width:50%; padding:0px;">
                        <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->pm_id == 2 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 5px; vertical-align: middle;">
                        <label for="annually">Bi-Annually</label>
                    </td>
                </tr>
                <tr>
                    <td style="width:50%; padding:0px; border-bottom: 0;">
                        <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->app_code == 3 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 5px; vertical-align: middle;">
                        <label for="new_form">ADDITIONAL</label>
                    </td>
                    <td style="width:50%; padding:0px; border-bottom: 0;">
                        <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->pm_id == 3 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 5px; vertical-align: middle;">
            ...
            <tr>
                ...
                <td width="21%" style="border:0px solid black; border-bottom:solid 1px black;">
                    <p style="padding-bottom: 5px;">
                        <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->btype_id == 1 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 5px; vertical-align: middle;">Single Proprietorship
                    </p>
                    <p style="padding-bottom: 5px;">
                        <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->client->gender == 1 && $bplo_business->btype_id == 1  ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; vertical-align: middle;">Male <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->client->gender == 0 && $bplo_business->btype_id == 1  ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-left: 10px; padding-right:2px; vertical-align: middle;">Female
                    </p>
                </td>
                <td width="22%" style="border:0px solid black; border-bottom:solid 1px black;">
                    <p style="">
                        <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->btype_id == 2 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 5px; vertical-align: middle;">One Person Corporation
                    </p>
                    <p>
                        <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->client->gender == 1 && $bplo_business->btype_id == 2  ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; vertical-align: middle;">Male <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->client->gender == 0 && $bplo_business->btype_id == 2  ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-left: 10px; padding-right:2px; vertical-align: middle;">Female
                    </p>
                </td>
                <td width="13%" style="border:0px solid black; border-bottom:solid 1px black;vertical-align:top;">
                    <p style="">
                        <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->btype_id == 3 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; vertical-align: middle;">Partnership
                    </p>
                </td>
                <td width="13%" style="border:0px solid black; border-bottom:solid 1px black;vertical-align:top;">
                    <p style="">
                        <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->btype_id == 4 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; vertical-align: middle;">Corporation
                    </p>
                </td>
                <td width="13%" style="border:0px solid black; border-bottom:solid 1px black; border-right:solid 1px black;vertical-align:top;">
                    <p style="">
                        <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->btype_id == 5 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; vertical-align: middle;">Cooperative
                    </p>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="font-size:12px;">
          <tr>
              ...
              <td width="33.33%" style="border:none; padding-bottom:0px;">
                  Barangay: <strong><u>{{$bplo_business->mainBarangay->brgy_name}}</u></strong>
              </td>
        ...
        <table width="100%" style="font-size:12px;">
          <tr>
              <td width="33.33%" style="border:none; border-left:solid 1px #000; border-bottom:solid 1px #000;">
                  City/Municipality: <strong><u>{{$bplo_business->mainBarangay->municipality->mun_desc}}</u></strong>
              </td>
              <td width="33.33%" style="border:none; border-bottom:solid 1px #000;">
                  Province: <strong><u>{{$bplo_business->mainBarangay->province->prov_desc}}</u></strong>
              </td>
              <td width="33.33%" style="border:none; border-bottom:solid 1px #000; border-right:solid 1px black;">
                  Zip Code: <strong><u>{{$bplo_business->mainBarangay->municipality->mun_zip_code}}</u></strong>
              </td>
          </tr>
        </table>
        ...
        <table width="100%" style="border:0px solid black;">
            <tr>
                <td width="33%" style="border: none; border-left:1px solid black; ">
                    Telephone No:<br>
                    <strong>{{$bplo_business->client->p_telephone_no}}</strong>
                </td>
                <td width="33%" style="border: none; border-left:1px solid black; ">
                    Mobile No:<br>
                    <strong>{{$bplo_business->client->p_mobile_no}}</strong>
                </td>
                <td width="33%" style="border: none; border-left:1px solid black; border-right:1px solid black; ">
                    Email Address:<br>
                    <strong>{{$bplo_business->client->p_email_address}}</strong>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="border:0px solid black;">
            <tr>
                ...
                <td width="15%" style="border: none; border-left:1px solid black; border-top: 1px solid black;">
                    Surname:<br>
                    <strong>{{$bplo_business->client->rpo_custom_last_name}}</strong>
                </td>
                <td width="15%" style="border: none; border-left:1px solid black; border-top: 1px solid black;">
                    Given Name:<br>
                    <strong>{{$bplo_business->client->rpo_first_name}}</strong>
                </td>
                <td width="15%" style="border: none; border-left:1px solid black; border-top: 1px solid black;">
                    Middle Name:<br>
                    <strong>{{$bplo_business->client->rpo_middle_name}}</strong>
                </td>
                <td width="15%" style="border: none; border-left:1px solid black; border-top: 1px solid black; border-right: 1px solid black;">
                    Suffix:<br>
                    <strong>{{$bplo_business->client->suffix}}</strong>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="border:0px solid black;">
            <tr>
                ...
                <td width="10%" style="border:none; border-top:1px solid black; border-bottom:solid 1px black;">
                    <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/checkbox.png" style="height:15px; width:15px; padding-right:2px; vertical-align: middle;">Filipino
                </td>
                <td width="10%" style="border:none; border-top:1px solid black; border-bottom:solid 1px black; border-right:solid 1px black;">
                    <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/checkbox.png" style="height:15px; width:15px; padding-right:2px; vertical-align: middle;">Foreign
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="border:0px solid black;">
            <tr>
                <td width="50%" style="border:1px solid black; border-bottom: 0px solid black;">
                    <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->busn_office_is_same_as_main == 1 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 0px; vertical-align: middle;">Same as Main Office Address
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="font-size:12px;">
          <tr>
              ...
              <td width="33.33%" style="border:none; padding-bottom:0px;">
                  Barangay: <strong><u>{{$bplo_business->busnBarangay->brgy_name}}</u></strong>
              </td>
              <td width="33.33%" style="border:none; border-right:solid 1px black; padding-bottom:0px;">
        ...
        <table width="100%" style="font-size:12px;">
            <tr>
                <td width="33.33%" style="border:none; border-left:solid 1px #000; border-bottom:solid 1px #000;">
                    City/Municipality: <strong><u>{{$bplo_business->busnBarangay->municipality->mun_desc}}</u></strong>
                </td>
                <td width="33.33%" style="border:none; border-bottom:solid 1px #000;">
                    Province: <strong><u>{{$bplo_business->busnBarangay->province->prov_desc}}</u></strong>
                </td>
                <td width="33.33%" style="border:none; border-bottom:solid 1px #000; border-right:solid 1px black;">
                    Zip Code: <strong><u>{{$bplo_business->busnBarangay->municipality->mun_zip_code}}</u></strong>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="border:0px solid black;">
            <tr>
                <td width="30%" style="border:0px solid black; border-left: 1px solid black; border-bottom: 1px solid black;">Owned ?
                    <span>
                        <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->busn_bldg_is_owned == 1 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 0px; vertical-align: middle;"> Yes &nbsp;&nbsp; <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->busn_bldg_is_owned == 0 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 0px; vertical-align: middle;"> No
                    </span>
                </td>
        ...
        <table width="100%" style="border:0px solid black;">
            <tr>
                <td width="100%" style="border:0px solid black; border-bottom: 1px solid black; border-right: 1px solid black; border-left: 1px solid black">
                    ...
                    <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->busn_tax_incentive_enjoy == 1 ? 'checked.png' : 'checkbox.png' }} " style="height:15px; width:15px; padding-right:2px; padding-bottom: 0px; vertical-align: middle;"> Yes &nbsp;&nbsp;
                    (Please attach a copy of your Certificate) &nbsp; <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->busn_tax_incentive_enjoy == 0 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 0px; vertical-align: middle;"> No
                </td>
            </tr>
        </table>
        ...
        <table width="100%" id="summary" style="border:0px solid black;">
            <tr>
                <td width="20%" style="border:0px solid black; border-left: 1px solid black; border-right: 1px solid black;">
                    ...
                    <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->busloc_id == 1 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 0px; vertical-align: middle;">Main Office

                    <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->busloc_id == 2 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 0px; vertical-align: middle;">Branch Office

                    <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->busloc_id == 3 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 0px; vertical-align: middle;">Admin Office Only

                    <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->busloc_id == 4 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 0px; vertical-align: middle;">Warehouse

                    <img src="http://89.117.63.249/dev/assets/storage/uploads/logo/{{ $bplo_business->busloc_id == 5 ? 'checked.png' : 'checkbox.png' }}" style="height:15px; width:15px; padding-right:2px; padding-bottom: 0px; vertical-align: middle;">Other Pls. Specify
                </td>
            </tr>
        </table>
            ...
            <table width="100%">
                <tr>
                    <td style="border-top: none; text-align:center; border-bottom: none; padding-top:30px;">
                        <span style="text-align:center;">{{ (!empty($bplo_business->client->rpo_first_name) ? $bplo_business->client->rpo_first_name . ' ' : '') . (!empty($bplo_business->client->rpo_middle_name) ? $bplo_business->client->rpo_middle_name . ' ' : '') . (!empty($bplo_business->client->rpo_custom_last_name) ? $bplo_business->client->rpo_custom_last_name . ' ' : '') }}</span><br>
