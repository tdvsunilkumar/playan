{{ Form::open(array('url' => 'business-permit/application','id'=>'bulkUploadClients')) }}
            ...
            <div class="row">
                <div class="col-lg-10 col-md-10 col-sm-10" id="DivBusiness">
                    <div class="form-group">
                        {{Form::label('bulkUploadFile1',__('Upload Business Permit[CSV File]-1st'),['class'=>'form-label'])}}<span class="text-danger">*</span>
                        <div class="form-icon-user">
                            {{Form::file('bulkUploadFile1',array('class'=>'form-control','id'=>'bulkUploadFile1','accept'=>'.csv'))}}
                        </div>
                        <a href="{{url('business-permit/application/downloadBusinessPermitTemplate')}}" target="_blank">Download Business Permit Template[CSV File]</a>
                    </div>
                </div>

                <div class="col-lg-10 col-md-10 col-sm-10 hide" id="DivPsic">
                    <div class="form-group">
                        {{Form::label('bulkUploadFile2',__('Upload Business Permit: PSIC Subclass[CSV File]-2nd'),['class'=>'form-label'])}}<span class="text-danger">*</span>
                        <div class="form-icon-user">
                            {{Form::file('bulkUploadFile2',array('class'=>'form-control', 'id'=>'bulkUploadFile2','accept'=>'.csv'))}}
                        </div>
                        <a href="{{url('business-permit/application/downloadPSICSubclassTemplate')}}" target="_blank">Download Business Permit: PSIC Subclass Template[CSV File]</a>
                    </div>
                </div>
 ...
 {{Form::close()}}
<script src="{{ asset('js/Bplo/bploBusinessBulkupload.js') }}"></script> 
