...
@section('page-title')
    ...
    {{__('Certificate Of No Improvement')}}
@endsection
@push('script-page')
@endpush
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Certificate Of No Improvement')}}</li>
@endsection
@section('action-btn')
    <div class="float-end">
        ...
        <a href="#" data-size="lg" data-url="{{ url('/rptcertificateofnoImprovement/store') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Manage Certificate Of No Improvement')}}" class="btn btn-sm btn-primary">
            <i class="ti-plus"></i>
        </a>
    </div>
@endsection
...
<script src="{{ asset('js/certificateOfImprovment.js') }}?rand={{ rand(000,999) }}"></script>
@endsection
