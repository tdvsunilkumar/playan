...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Accounts Payable Recap') }}</li>
@endsection
                                    ...
                                    @if (!empty($rows)) 
                                        ...
                                        @foreach ($rows as $row)
                                            <tr>
                                                ...
                                                <td rowspan="1" colspan="1" class="text-end"></td>
                                            </tr>
                                            @php 
                                                if($row->debit > 0) {
                                        ...
                                        @endforeach
                                        <tr>
                                            <td rowspan="1" colspan="1" class="text-left">{{ $account_payable->description }}</td>
                                            <td rowspan="1" colspan="1" class="text-center">{{ $account_payable->code }}</td>
                                            <td rowspan="1" colspan="1" class="text-end"></td>
                                            <td rowspan="1" colspan="1" class="text-end">{{ $controller->money_format($totalCredit) }}</td>
                                        </tr>
                                        <tr>
