...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Debit Memo Journal') }}</li>
@endsection
                            ...
                            <table class="table" cellspacing="0" cellpadding="0">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="3" colspan="1"  class="text-center">Alobs No.</th>
                                        <th rowspan="3" colspan="1"  class="text-center">Office Code</th>
                                        ...
                                        <th rowspan="1" colspan="2" class="text-center">Credit</th>
                                    </tr>
                                    <tr>
                                        <th rowspan="1" colspan="1" class="text-center">Code</th>
                                        <th rowspan="1" colspan="1" class="text-center">Amount</th>
                                        <th rowspan="1" colspan="1" class="text-center">Code</th>
                                        <th rowspan="1" colspan="1" class="text-center">Amount</th>
                                    </tr>
                                </thead>
                                        ...
                                        @foreach ($rows as $row)
                                            <tr>
                                                ...
                                                <td rowspan="1" colspan="1"  class="text-center">
                                                    @foreach($row->debit_memo->unique('alobs') as $alobs)
                                                        {{$alobs->alobs}}
                                                    @endforeach
                                                </td>
                                                <td rowspan="1" colspan="1"  class="text-center">
                                                    @foreach($row->debit_memo->unique('responsibility_center') as $alobs)
                                                        {{$alobs->responsibility_center}}
                                                    @endforeach
                                                </td>
                                                ...
                                                <!-- debit -->
                                                <td rowspan="1" colspan="1"  class="text-center">
                                                    @foreach($row->debit as $alobs)
                                                        {{$alobs->code}} </br>
                                                    @endforeach
                                                </td>
                                                <td rowspan="1" colspan="1"  class="text-center">
                                                    @foreach($row->debit as $alobs)
                                                        {{currency_format($alobs->amt)}} </br>
                                                        @php $total_debit += $alobs->amt; @endphp
                                                    @endforeach
                                                </td>
                                                <!-- credit -->
                                                <td rowspan="1" colspan="1"  class="text-center">
                                                    @foreach($row->credit as $alobs)
                                                        {{$alobs->code}} </br>
                                                    @endforeach
                                                </td>
                                                <td rowspan="1" colspan="1"  class="text-center">
                                                    @foreach($row->credit as $alobs)
                                                        {{currency_format($alobs->amt)}} </br>
                                                        @php $total_credit += $alobs->amt; @endphp
                                                    @endforeach
                                                </td>
                                            </tr>
                                        @endforeach
