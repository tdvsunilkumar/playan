        ...
        <div class="col-xl-12">
            <div id="report-card" class="card noflow" style="min-height: 400px">
                <div class="card-header">
                    <h5 class="w-100">FILTER JOURNALS REPORT</h5>
                </div>
                <div class="card-body">
                    {{ Form::open(array('url' => 'reports/accounting/journals', 'class'=>'formDtls needs-validation', 'name' => 'reportsAcctgJournalForm', 'method' => 'GET')) }}
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
