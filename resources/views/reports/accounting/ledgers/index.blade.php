        ...
        <div class="col-xl-12">
            <div id="report-ledger-card" class="card noflow" style="min-height: 400px">
                <div class="card-header">
                    <h5 class="w-100">FILTER LEDGERS REPORT</h5>
                </div>
                <div class="card-body">
                    {{ Form::open(array('url' => 'reports/accounting/ledgers', 'class'=>'formDtls needs-validation', 'name' => 'reportsAcctgLedgerForm', 'method' => 'GET')) }}
                    @csrf
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group m-form__group required">
                                {{ Form::label('ledger_type', 'Ledger Type', ['class' => '']) }}
                                {{
                                    Form::select('ledger_type', $types, $value = '', ['id' => 'ledger_type', 'class' => 'form-control select3', 'data-placeholder' => 'select a ledger type'])
                                }}
