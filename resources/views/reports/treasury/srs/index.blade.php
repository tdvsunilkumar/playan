        ...
        <div class="col-xl-12">
            <div id="report-ledger-card" class="card noflow">
                <div class="card-header">
                    <h5 class="w-100">FILTER REPORT</h5>
                </div>
                <div class="card-body">
                    {{ Form::open(array('url' => 'reports/treasury/statement-of-reciepts-sources', 'class'=>'formDtls needs-validation', 'name' => 'reportsCollectionForm', 'method' => 'GET')) }}
                    @csrf
