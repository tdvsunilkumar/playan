...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('PSA LIST')}}</li>
...
@section('content')
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-1 col-md-1 col-sm-1">
                                <div class="col-auto float-end ms-2" style="padding-top: 30px;">
                                    ...
                                    <a href="{{ url('export-reportsnationalgovpsa-lists') }}" class="btn btn-sm btn-primary" id="btn_download_spreadsheet" title="Download Spreadsheet">
                                        <span class="btn-inner-icon"><i class="ti-files"> </i></span>
                             </a>
                                </div>
                           </div>
                          <!--  <div class="d-flex align-items-center justify-content-end mt-3">
                            <a href="{{ url('export-reportsnationalgovbir-lists') }}" class="btn btn-sm btn-primary" id="btn_download_spreadsheet">
                        ...
                        <table class="table" id="Jq_datatablelist">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{__('Business Lines')}}</th>
                                    <th>{{__('Gross Revenue / Capital Investment')}}</th>
                                    <th>{{__('Business Tax')}}</th>
                                    <th>{{__('App status')}}</th>
    ...
    <script src="{{ asset('js/report/businesspsalist.js') }}"></script>
@endsection
