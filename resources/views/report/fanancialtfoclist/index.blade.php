...
@section('page-title')
    {{__('Fanancial Tax And Other Charges')}}
@endsection
@push('script-page')
@endpush
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item">{{__('Fanancial Tax And Other Charges')}}</li>
...
@section('content')
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-1 col-md-1 col-sm-1">
                                <div class="col-auto float-end ms-2" style="padding-top: 40px;">
                                    ...
                                    <a href="{{ url('export-reportfanancetaxfeecharges') }}" class="btn btn-sm btn-primary" id="btn_download_spreadsheet" title="Download Spreadsheet">
                                        <span class="btn-inner-icon"><i class="ti-files"> </i></span>
                             </a>
                                </div>
                           </div>
                           <!-- <div class="d-flex align-items-center justify-content-end mt-3">
                            <a href="{{ url('export-reportfanancetaxfeecharges') }}" class="btn btn-sm btn-primary" id="btn_download_spreadsheet">
                        ...
                        <table class="table" id="Jq_datatablelist">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{__('Total Penalty')}}</th>
                                    <th>{{__('Credit Applied')}}</th>
                                    <th>{{__('Totals')}}</th>
                                </tr>
                            </thead>
                        </table>
    ...
    <script src="{{ asset('js/report/financetfocreport.js') }}"></script>
@endsection
