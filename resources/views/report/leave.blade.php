                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <a href="{{route('attendanceemployee.index')}}" class="btn btn-sm btn-danger " data-bs-toggle="tooltip"  title="{{ __('Reset') }}" data-original-title="{{__('Reset')}}">
                                            <span class="btn-inner--icon"><i class="ti-trash-off text-white-off "></i></span>
                                        </a>
        ...
        <div class="row mt-3">
            <div class="col">
                ...
                <div class="card p-4 mb-4">
                    ...
                    <h7 class="text-sm mb-0">{{$filterYear['type'].' '.__('Leave Summary')}}</h7>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-md-4 col-lg-4">
                <div class="card p-4 mb-4">
                    <div class="float-left">
                        <h7 class="text-sm  mb-0">{{__('Approved Leaves')}} :</h7>
                        <h6 class=" mb-0">{{$filter['totalApproved']}}</h6>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-4 col-lg-4">
                <div class="card p-4 mb-4">
                    <h7 class="text-sm mb-0">{{__('Rejected Leaves')}} :</h7>
                    <h6 class=" mb-0">{{$filter['totalReject']}}</h6>
                </div>
            </div>
            <div class="col-xl-4 col-md-4 col-lg-4">
                <div class="card p-4 mb-4">
                    <h7 class="text-sm mb-0">{{__('Pending Leaves')}} :</h7>
                    <h6 class="mb-0">{{$filter['totalPending']}}</h6>
                </div>
            </div>
        </div>
    </div>
