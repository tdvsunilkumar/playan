...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('BIR LIST')}}</li>
...
@section('content')
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-1 col-md-1 col-sm-1">
                                <div class="col-auto float-end ms-2" style="padding-top: 30px;">
                                    ...
                                    <a href="{{ url('export-reportsnationalgovbir-lists') }}" class="btn btn-sm btn-primary" id="btn_download_spreadsheet" title="Download Spreadsheet">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="Jq_datatablelist">
                            <thead>
                                <tr>
                                    <th>{{_('NO.')}}</th>
                                    <th>{{__('Business IDentification No.')}}</th>
                                    <th>{{__('Permit no.')}}</th>
    ...
    <script src="{{ asset('js/report/businessbirlist.js') }}"></script>
@endsection
