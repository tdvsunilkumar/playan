...
@section('page-title')
    {{__('List of Business (Per Barangay)')}}
@endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{ __('Dashboard') }}</a></li>
    <li class="breadcrumb-item">{{ __('List of Business (Per Barangay)') }}</li>
@endsection
@section('action-btn')
    <div class="float-end">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 pdr-20">
                                ...
                                {{ Form::date('fromdate', $from_date, array('class' => 'form-control','id'=>'from_date')) }}
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 pdr-20">
                                <div class="btn-box">
                                {{ Form::label('to_date', 'To Date', ['class' => 'fs-6 fw-bold']) }}
                                {{ Form::date('p_todate', $to_date, array('class' => 'form-control','id'=>'to_date')) }}
                                </div>
                            </div>
							<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 pdr-20">
                                <div class="btn-box">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="Jq_datatablelist">
                            ...
                            <tr>
								...
								<th>{{__('Status (New/Renewal)')}}</th>
								<th>{{__('Date Issued')}}</th>
								<th>{{__('Mode Of Payment')}}</th>
								<th>{{__('Total Assessment')}}</th>
...
@endsection
@push('scripts')
<script src="{{ asset('js/report/listofbusinessper.js') }}?rand={{ rand(000,999) }}"></script>
@endpush
