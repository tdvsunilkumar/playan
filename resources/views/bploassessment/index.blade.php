...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('CTO Applications')}}</li>
@endsection
@section('action-btn')
    <div class="float-end">
        ...
        <a href="#" data-size="xll" data-url="{{ url('/bploassessment/store') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('New Business License Assessment')}}" class="btn btn-sm btn-primary">
            <i class="ti-plus"></i>
        </a>
...
@section('content')
    ...
    <script src="{{ asset('js/ctoapplication.js') }}"></script>
@endsection
