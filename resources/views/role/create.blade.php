    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row ">
                                                    ...
                                                    @if(in_array('posting '.$module,(array) $permissions))
                                                        @if($key = array_search('posting '.$module,$permissions))
                                                            <div class="col-md-2 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck bplodetails_checkall isscheck_'.str_replace(' ', '', str_replace('&', '', $module)),'id' =>'permission'.$key])}}
                                                                {{Form::label('permission'.$key,'posting',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
                                                    ...
                                                    @if(in_array('upload '.$module,(array) $permissions))
                                                        @if($key = array_search('upload '.$module,$permissions))
                                                            <div class="col-md-2 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck bplodetails_checkall isscheck_'.str_replace(' ', '', str_replace('&', '', $module)),'id' =>'permission'.$key])}}
                                                                {{Form::label('permission'.$key,'upload',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
                ...
                <div class="tab-pane fade" id="planning" role="tabpanel" aria-labelledby="pills-profile-tab">
                    @php
                        ...
                        <div class="form-group">
                            @if(!empty($permissions))
                                ...
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    ...
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input custom_align_middle" name="planning_heckall"  id="planning_checkall" >
                                        </th>
                                        <th>{{__('Module')}} </th>
                                        <th>{{__('Permissions')}} </th>
                                    </tr>
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input ischeck planning_checkall"  data-id="{{str_replace(' ', '', $module)}}" ></td>
                                            ...
                                            <td>
                                                <div class="row ">
                                                    @if(in_array('view '.$module,(array) $permissions))
                                                        @if($key = array_search('view '.$module,$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck planning_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])}}
                                                                {{Form::label('permission'.$key,'View',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
                ...
                <div class="tab-pane fade" id="healthsanitary" role="tabpanel" aria-labelledby="pills-profile-tab">
                    @php
                        ...
                        <div class="form-group">
                            @if(!empty($permissions))
                                ...
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    ...
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input custom_align_middle" name="healthsanitary_heckall"  id="healthsanitary_checkall" >
                                        </th>
                                        <th>{{__('Module')}} </th>
                                        <th>{{__('Permissions')}} </th>
                                    </tr>
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input ischeck healthsanitary_checkall"  data-id="{{str_replace(' ', '', $module)}}" ></td>
                                            ...
                                            <td>
                                                <div class="row ">
                                                    @if(in_array('view '.$module,(array) $permissions))
                                                        @if($key = array_search('view '.$module,$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck healthsanitary_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])}}
                                                                {{Form::label('permission'.$key,'View',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
                                            ...
                                            <td>
                                                <div class="row ">
                                                    ...
                                                    @if(in_array('view '.$module,(array) $permissions))
                                                        @if($key = array_search('view '.$module,$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck assessment_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])}}
                                                                {{Form::label('permission'.$key,'View',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
                        ...
                        <div class="form-group">
                            @if(!empty($permissions))
                                ...
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    ...
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input align-middle custom_align_middle" name="point_checkall"  id="point_checkall" >
                                        </th>
                                        <th>{{__('Module')}} </th>
                                        <th>{{__('Permissions')}} </th>
                                    </tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="row ">
                                                    @if(in_array('manage '.$module,(array) $permissions))
                                                        @if($key = array_search('manage '.$module,$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck point_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])}}
                                                                {{Form::label('permission'.$key,'Manage',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
                ...
                <div class="tab-pane fade" id="administrative" role="tabpanel" aria-labelledby="pills-contact-tab">
                    @php
                        $modules=['bplo system parameters','bplo tax rate effectivity','bplo fixed taxes & fees','bplo graduated new tax','psic sections','psic division','psic group','psic class','psic subclass','tax class','tax category','tax type','requirements','bplo requirements','bussiness classifications','bussiness activity','app types','bussiness types','barangay','occupancy type','region','province','municipality','country', 'tax declaration','demo'];
                    @endphp
                    <div class="col-md-12">
                        <div class="form-group">
                            @if(!empty($permissions))
