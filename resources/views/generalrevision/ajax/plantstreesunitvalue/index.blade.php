<div class="modal-header">
                                <h4 class="modal-title">Plants Trees Unit Value</h4>
                                <a class="close closePlantTreeUnitValueScheduleModal" mid="" type="edit" data-dismiss="modal" aria-hidden="true">X</a>
                            </div>
    ...
    <div class="row pt10" >
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body table-border-style">
                        <div class="table-responsive" id="plantstreesUnitValueListing">
        ...
        <!--------------- Land Apraisal Listing End Here------------------><br />
                            ...
                            <div class="modal-footer">
                                <a href="#" data-dismiss="modal" class="btn closePlantTreeUnitValueScheduleModal" mid=""  type="edit">Close</a>
                            </div>
