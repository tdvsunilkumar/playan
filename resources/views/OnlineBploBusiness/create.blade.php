...
<div class="modal form fade" id="departmental-requisition-modal" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="departmentalRequisitionLabel" tabindex="-1">
    ...
    {{ Form::open(array('url' => 'business-online-application', 'class'=>'formDtls', 'name' => 'appDetailsForm')) }}
    @csrf
        <div class="modal-content">
                ...
                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group m-form__group required">
                                        ...
                                        {{
                                            Form::select('app_code', $app_type, $value = '', ['id' => 'app_code', 'class' => 'form-control'])
                                        }}
                    ...
                    <div class="col-md-9 border-left space-left" style="padding-right: 30px;">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            @include('OnlineBploBusiness.business_info') 
                            <!-- REQUEST DETAILS END -->
                            <!-- ALOB DETAILS START -->
                            @include('OnlineBploBusiness.business_operation') 
                            <!-- ALOB DETAILS END -->
                            <!-- ALOB DETAILS START -->
                            @include('OnlineBploBusiness.business_activity') 
                            <!-- ALOB DETAILS END -->
                            <!-- Summary START -->
                            @include('OnlineBploBusiness.summary') 
                            <!-- Summary END -->
            ...
            <div class="modal-footer" style="padding-right: 30px;">
                ...
                <button type="button" class="btn decline-btn btn-danger">Decline</button>
                <button type="button" class="btn approve-btn bg-success btn-primary">Accept</button>
            </div>
        </div>
    {{ Form::close() }} 
    </div>
