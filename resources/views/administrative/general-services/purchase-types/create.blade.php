<div class="modal form fade" id="purchase-type-modal" tabindex="-1" role="dialog" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="purchaseTypeModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            {{ Form::open(array('url' => 'administrative/general-services/purchase-types', 'class'=>'formDtls needs-validation', 'name' => 'purchaseTypeForm')) }}
            @csrf
