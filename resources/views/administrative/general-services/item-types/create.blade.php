<div class="modal form fade" id="item-type-modal" tabindex="-1" role="dialog" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="itemTypeModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            {{ Form::open(array('url' => 'administrative/general-services/item-types', 'class'=>'formDtls needs-validation', 'name' => 'itemTypeForm')) }}
            @csrf
                <div class="modal-header bg-accent">
                    <h5 class="modal-title full-width c-white" id="itemTypeModal">
                        Manage Item Type
