...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Request Permit')}}</li>
@endsection
@section('action-btn')
    <div class="float-end">
        ...
        <a href="#" data-size="lg" data-url="{{ url('/OccupationalPermit/store') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Manage Request Permit')}}" class="btn btn-sm btn-primary">
            <i class="ti-plus"></i>
        </a>
    </div>
@endsection
...
<script src="{{ asset('js/requestpermit.js') }}"></script>
@endsection
