...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Sanitary Permit')}}</li>
...
@section('action-btn')
    <div class="float-end">
        ...
        <!-- <a href="#" data-size="lg" data-url="{{ url('/healthy-and-safety/app-sanitary/store') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Ho App Sanitary')}}" class="btn btn-sm btn-primary">
            <i class="ti-plus"></i>
        </a> -->
    </div>
@endsection
...
@section('content')
                        ...
                        <table class="table" id="Jq_datatablelist">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{__('Type Of Establishment')}}</th>
    ...
    <script src="{{ asset('js/hoappsanitary.js') }}"></script>
@endsection
