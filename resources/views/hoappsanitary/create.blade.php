{{ Form::open(array('url' => 'healthy-and-safety/app-sanitary','enctype'=>'multipart/form-data')) }}
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="form-icon-user">
                         <!-- {{ Form::text('has_app_year', $data->has_app_year, array('class' => 'yearpicker form-control numeric-only','id'=>'has_app_year','required'=>'required', ($data->id ? '' : ''))) }} -->
...
{{Form::close()}}
<script src="{{ asset('js/ajax_validation_issuance.js') }}"></script>
