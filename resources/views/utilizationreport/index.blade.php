...
@section('page-title')
    {{__('Manage Utilization Report')}}
@endsection
@push('script-page')
@endpush
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item">{{__('Manage Utilization Report')}}</li>
@endsection
@section('action-btn')
    <div class="float-end">
        ...
        <a href="javascript::void(0)" 
            data-url="{{ url('/reports-utilization/store') }}"
            data-ajax-popup="true" 
            data-bs-toggle="tooltip" 
            title="{{__('Manage Utilization Report')}}"
            data-size="xxl"
