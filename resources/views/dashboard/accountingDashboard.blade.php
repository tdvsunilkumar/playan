                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Month')}}</p>
                                            <h6 class="mb-3">{{__('Disbursement')}}</h6>
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Voucher')}}</p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Current')}}</p>
                                            <h6 class="mb-3">{{__('Month')}}</h6>
                                            <h3 class="mb-0">{{\Auth::user()->countCustomers()}}
