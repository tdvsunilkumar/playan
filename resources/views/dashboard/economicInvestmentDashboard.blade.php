                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Total Cemetery')}}</p>
                                            <h6 class="mb-3">{{__('Applicant')}}</h6>
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Total Housing')}}</p>
                                            <h6 class="mb-3">{{__('Applicant')}}</h6>
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Rental ')}}</p>
                                            <h6 class="mb-3">{{__('Applicant')}}</h6>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Payment Cemetery')}}</p>
                                            <h6 class="mb-3">{{__('Parial')}}</h6>
                                            <h3 class="mb-0">{{\Auth::user()->countCustomers()}}
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Payment Housing')}}</p>
                                            <h6 class="mb-3">{{__('Parial')}}</h6>
                                            <h3 class="mb-0">{{\Auth::user()->countBills()}} </h3>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Total Rental')}}</p>
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Cemetery')}}</p>
                                            <h6 class="mb-3">{{__('Completed')}}</h6>
                                            <h3 class="mb-0">{{\Auth::user()->countInvoices()}} </h3>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Housing')}}</p>
                                            <h6 class="mb-3">{{__('Completed')}}</h6>
                                            <h3 class="mb-0">{{\Auth::user()->countCustomers()}}
                        ...
                        <div class="col-xxl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mt-1 mb-0">{{__('Total Income')}}</h5>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mt-1 mb-0">{{__('Housing Income')}}</h5>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mt-1 mb-0">{{__('Rental Income')}}</h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mt-1 mb-0">{{__('Cemetery Income')}}</h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table">
                ...
                <div class="col-xxl-5">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mt-1 mb-0">{{__('Expense by Category')}}</h5>
                                </div>
                                <div class="card-body">
                                    <div id="cash-flow"></div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-pills mb-5" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" href="#invoice_monthly_statistics" role="tab" aria-controls="pills-profile" aria-selected="false">{{__('Cemetery')}}</a>
                                        </li>
                                    </ul>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-pills mb-5" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" href="#invoice_monthly_statistics" role="tab" aria-controls="pills-profile" aria-selected="false">{{__('Rental')}}</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="invoice_weekly_statistics" role="tabpanel" aria-labelledby="pills-home-tab">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-pills mb-5" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" href="#invoice_monthly_statistics" role="tab" aria-controls="pills-profile" aria-selected="false">{{__('Housing')}}</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="invoice_weekly_statistics" role="tabpanel" aria-labelledby="pills-home-tab">
