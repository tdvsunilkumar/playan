                ...
                <div class="card-body table-border-style">
                    <div class="row d-flex justify-content-end mt-2">
                        ...
                        <div class="col-auto my-auto">
                            ...
                            <a href="{{route('vender.payment')}}" class="reset-btn" data-toggle="tooltip" data-original-title="{{__('Reset')}}">
                                <span class="btn-inner--icon"><i class="ti-trash-restore-alt"></i></span>
                            </a>
