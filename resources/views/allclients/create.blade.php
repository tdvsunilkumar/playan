{{ Form::open(array('url' => 'allclients','id'=>'storePropertyOwnerForm')) }}
                        ...
                        <div id="flush-collapseone" class="accordion-collapse collapse show" aria-labelledby="flush-headingone1" data-bs-parent="#accordionFlushExample">
                            <div class="basicinfodiv">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8 hide">
                                        <div class="form-group">
                           ...
                           <!--  <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-icon-user">
                                        {{Form::text('p_telephone_no',$data->p_telephone_no,array('class'=>'form-control','id'=>'p_telephone_no'))}}
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-icon-user">
                                         {{ Form::select('civil_status',array('0' =>'Single','1' =>'Separated','2'=>'Consbitation(Live in)','3'=>'Married','4'=>'Windowler','5'=>'Divorce'), $data->civil_status, array('class' => 'form-control spp_type','id'=>'civil_status','required'=>'required')) }}
                                    </div>
...
<script src="{{ asset('js/add_engclients.js') }}"></script>
