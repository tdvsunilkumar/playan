{{ Form::open(array('url' => 'buildingfeescategory','class'=>'formDtls','id'=>'excavationgroundtype')) }}
	...
	<div class="row">
		 <div class="col-md-12">
			<div class="form-group">
				{{ Form::label('ebpfc_description', __('Description'),['class'=>'form-label']) }}<span class="text-danger">*</span>
				<span class="validate-err">{{ $errors->first('ebpfc_description') }}</span>
				<div class="form-icon-user">
					{{ Form::text('ebpfc_description',$data->ebpfc_description, array('class' => 'form-control','id'=>'ebpfc_description','required'=>'required')) }}
				</div>
