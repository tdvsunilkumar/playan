{{ Form::open(array('url' => 'engcashering','id'=>'casherform')) }}
    {{ Form::hidden('id',$data->id, array('id' => 'id')) }}
    {{ Form::hidden('maintfoc_id','', array('id' => 'maintfoc_id')) }}
    {{ Form::hidden('engjobrequestno','', array('id' => 'engjobrequestno')) }}
                        ...
                        <div class="basicinfodiv">
                            <div class="row">
                               ...
                               <div class="col-sm-12">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        {{Form::text('total_amount',$data->total_amount,array('class'=>'form-control disabled-field','required'=>'required','id'=>'total_amount','step'=>'0.01'))}}
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label  class="form-label labelbold"><strong>Amount Paid</strong><span class="text-danger">*</span></label>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        {{Form::text('total_paid_amount',$data->total_paid_amount,array('class'=>'form-control numeric-double','required'=>'required','id'=>'total_paid_amount'))}}
                                    </div>
                                    <span class="validate-err" id="err_total_paid_amount"></span>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                         <label  class="form-label labelbold"><strong>Change</strong></label>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        {{Form::text('total_amount_change',$data->total_amount_change,array('class'=>'form-control numeric-double','id'=>'total_amount_change','step'=>'0.01'))}}
                                    </div>
                                </div>
                            ...
                            <div class="box-border">
                                    <div class="row">
                                        <div class="col-md-12"> 
                                            <div class="d-flex radio-check">
                                             <div class="form-check form-check-inline form-group" style="margin: 0px;">
                     ...
                     <div class="row" style="width: 100%; margin: 0px;padding-bottom: 10px; margin-top: -30px;">
                            <div class="row field-requirement-details-status">
                                <div class="col-lg-1 col-md-1 col-sm-1">
                                    {{Form::label('subclass_id',__('Tax Year'),['class'=>'form-label','style'=>'color:#fff;'])}}
                                </div>
                                <div class="col-lg-7 col-md-7 col-sm-7">
                                    {{Form::label('taxable_item_name',__('Particulars'),['class'=>'form-label','style'=>'color:#fff;'])}}
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    {{Form::label('taxable_item_qty',__('Taxable Amount'),['class'=>'form-label numeric','style'=>'color:#fff;'])}}
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    {{Form::label('taxable_item_qty',__('Amount'),['class'=>'form-label numeric','style'=>'color:#fff;'])}}
                                </div>
                            ...
                            <span class="taxfeesDetails activity-details tablestripped" id="FeesDetails">
                                ...
                                <div class="removetaxfeesdata row pt10 {{ ($i == $iteratio)? 'hide':'' }}">
                                    <div class="col-lg-1 col-md-1 col-sm-1">
                                ...
                                <div class="row hide">
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-5">
                                        <div class="form-group">
                                            <div class="form-icon-user">
                                                 {{ Form::select('taxfees[]',$feesaray,'',array('class' => 'form-control taxfees','required'=>'required','id'=>'taxfeescpdo','readonly'=>'true')) }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-2 col-sm-2">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2">
                                        <div class="form-group">
                                            {{Form::text('amount[]','',array('class'=>'form-control disabled-field amount','id'=>'amountdefault'))}}
                                        </div>
                                    </div>
                                    <div class="col-lg-1 col-md-1 col-sm-1">
                                    </div>
                               ...
                               @endif
                               <div class="row hide">
                                  <div class="col-sm-8"></div><div class="col-sm-2">  <label  class="form-label labelbold"><strong>Surcharge</strong></label></div><div class="col-sm-2" style="font-size:20px;"> {{Form::text('total_paid_surcharge','0.00',array('class'=>'form-control disabled-field red','id'=>'surcharge'))}}</div>
                              </div>
                               <div class="row hide"> 
                                   <div class="col-sm-8"></div><div class="col-sm-2">  <label  class="form-label labelbold"><strong>Total</strong></label></div><div class="col-sm-2" style="font-size:20px;"> {{Form::text('totalamount',$data->total_amount,array('class'=>'form-control disabled-field red','id'=>'totalamount'))}}</div>
                               </div>
                    </div>
                            ...
                            <span class="checkDetails activity-details tablestripped" id="checkDetails">
                                ...
                                <div class="row removecheckdata" style="padding: 5px 0px;">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2">
                                     ...
                                     <div class="col-lg-2 col-md-2 col-sm-2">
                                        {{Form::text('checkamount3[]',$val->opayment_amount,array('class'=>'form-control checkamount','id'=>'checkamount'))}}
                                    </div>
                                      <div class="col-lg-2 col-md-2 col-sm-2">
                                ...
                                @foreach($arrPaymentbankDetails as $key=>$val)
                                 <div class="row removebankdata" style="padding: 5px 0px;">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2">
                                     ...
                                     <div class="col-lg-2 col-md-2 col-sm-2">
                                        {{Form::text('checkamount2[]',$val->opayment_amount,array('class'=>'form-control checkamount','id'=>'checkamount'))}}
                                    </div>
                                      <div class="col-lg-2 col-md-2 col-sm-2">
                                        {{Form::date('checkdate2[]',$val->opayment_date,array('class'=>'form-control checkdate','id'=>'checkdate'))}}
                                    </div>
                                     <div class="col-lg-1 col-md-1 col-sm-1"><div class="form-group"><button type="button" class="btn btn-danger btn_cancel_bank"><!-- <i class="ti-trash"></i> --></button></div></div>
                                      @php $i++; @endphp
                                </div>
                                @endforeach
                        </span>
...
<div id="hidencheckHtml" class="hide">
     <div class="row removecheckdata" style="padding: 5px 0px;">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2">
         ...
         <div class="col-lg-2 col-md-2 col-sm-2">
            {{Form::text('checkamount3[]','',array('class'=>'form-control numeric-double  checkamount','id'=>'checkamount','required'=>'required'))}}
        </div>
          <div class="col-lg-2 col-md-2 col-sm-2">
            {{Form::date('checkdate3[]','',array('class'=>'form-control checkdate','id'=>'checkdate','required'=>'required'))}}
        </div>
         <div class="col-lg-1 col-md-1 col-sm-1"><div class="form-group"><button type="button" class="btn btn-danger btn_cancel_check"><i class="ti-trash"></i></button></div></div>
    </div>
</div>
<div id="hidenbankHtml" class="hide">
     <div class="row removebankdata" style="padding: 5px 0px;">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2">
         ...
         <div class="col-lg-2 col-md-2 col-sm-2">
            {{Form::text('checkamount2[]','',array('class'=>'form-control numeric-double checkamount','id'=>'checkamount','required'=>'required'))}}
        </div>
          <div class="col-lg-2 col-md-2 col-sm-2">
 ...
 @if(($data->id)>0)
	{{ Form::open(array('url' => 'engcashering/cancelorpayment','class'=>'formDtlscancel','id'=>'formdtlcancelid')) }}
...
<script src="{{asset('js/Engneering/add_engcashering.js')}}?rand={{ rand(000,999) }}"></script>
