...
@section('action-btn')
    <div class="float-end">
            ...
            <a href="#" data-size="lg" data-url="{{ url('/engineering/consultantexternal/store') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Manage Engineering Consultant External')}}" class="btn btn-sm btn-primary">
            <i class="ti-plus"></i>
        </a>
...
<div class="row hide" id="this_is_filter">
    ...
    <script src="{{ asset('js/Engneering/consultantexternal.js') }}"></script>
@endsection
