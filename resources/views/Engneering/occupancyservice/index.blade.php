...
@section('page-title')
    {{__('Occupancy Service')}}
@endsection
@push('script-page')
@endpush
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item">{{__('Occupancy Service')}}</li>
@endsection
@section('action-btn')
    <div class="float-end">
         <a href="#" id="filter_box" class="btn btn-sm btn-primary action-item" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="ti-filter"></i>
             ...
             <a href="#" data-size="xxll" data-url="{{ url('/occupancy-services/store') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Manage Occupancy Service')}}" class="btn btn-sm btn-primary modal-dialog-scrollable">
            <i class="ti-plus"></i>
        </a>
    </div>
@endsection
...
@section('content')
   <div class="row hide" id="this_is_filter">
    ...
    <div class="row">
     ...
     <script src="{{ asset('js/Engneering/occupancyservice.js') }}"></script>
@endsection
