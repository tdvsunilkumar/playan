...
<div class="modal-header">
                      ...
                      <div id="page1">  
                                ...
                                <h6 class="accordion-header" id="flush-headingfive">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-8">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('ema_location', __('City / Municipality of'),['class'=>'form-label']) }}
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('locappbrgy_code',$mechanicalappdata->locbarangay, array('class' => 'form-control disabled-field locappbrgy_code','id'=>'locappbrgy_code')) }}
                                            </div>
                                            <span class="validate-err" id="err_brgy_code"></span>
                                        </div>
                                    </div>
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('locema_location', __('City / Municipality of'),['class'=>'form-label']) }}
                                            <span class="validate-err">{{ $errors->first('locema_location') }}</span>
                                            <div class="form-icon-user">
                                                {{ Form::text('locema_location',$mechanicalappdata->locmunicipality, array('class' => 'form-control disabled-field','id'=>'locema_location')) }}
                                            </div>
                                            <span class="validate-err" id="err_ema_location"></span>
                                        </div>
                                    </div>
                        ...
                        <div  class="accordion accordion-flush">
                            <div class="accordion-item">
                                <h6 class="accordion-header" id="flush-headingfive">
                                    <button class="accordion-button collapsed btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefive" aria-expanded="false" aria-controls="flush-headingfive">
                                        <h6 class="sub-title accordiantitle">{{__("Installation and Operation Of")}}&nbsp;<span class="text-danger">*</span></h6>
                                    </button>
                                </h6>
                                 <div class="row">
                                    <div class="col-sm-12">
                                      <div class="row">
                                       @foreach($instllationtypearray as  $key => $val)
                                        @php  $idsofeiot_id = explode(',',$mechanicalappdata->eiot_id);
                                                     @endphp
                                        <div class="col-md-4">
                                               <div class="form-check form-check-inline form-group col-md-12">
                                                {{ Form::checkbox('eiot_id[]', $key,(in_array($key,$idsofeiot_id))?true:false, array('id'=>'eiot_id'.$key,'class'=>'form-check-input code')) }}
                                                {{ Form::label('eiot_id'.$key, __($val),['class'=>'form-label']) }}
                                            </div>
                                        </div>  
                                      @endforeach
                                     </div>
                                     <span class="validate-err" id="err_eiot_id"></span>
                                    </div>
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                {{ Form::label('others', __('OTHERS(specify)'),['class'=>'form-label bold']) }}
                                ...
                                <div class="accordion-item">
                                    <h6 class="accordion-header" id="flush-headingfive">
                                        <button class="accordion-button collapsed btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefive" aria-expanded="false" aria-controls="flush-headingfive" style="padding-right:0px;">
                                            ...
                                            <div class="row" style="width: 100%;padding-right: 0px;padding-left: 0px;">
                                        <div class="col-md-11">
                                            <h6 class="sub-title accordiantitle " style="padding-top: 12px;">{{__("Supervisor/In Charge of Mechanical Works")}}</h6>
                                        </div>
                                        <div class="col-md-1" >
                                            <a href="{{ url('/eng/consultantexternal') }}" target="_blank">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::select('ema_building_official',$buildofficial,$mechanicalappdata->ema_building_official, array('class' => 'form-control','id'=>'ema_building_official')) }}
                                            </div>
                 ...
                 <script type="text/javascript">
                     $(document).ready(function(){
                        ...
                        $("#ema_sign_category").select3({ dropdownAutoWidth: false });
                        $("#ema_incharge_category").select3({ dropdownAutoWidth: false });
                     });
                 </script>
                 <script>
