{{Form::open(array('name'=>'forms','url'=>'jobrequest/storeexcavationpermit','method'=>'post','id'=>'storeexcavationpermit'))}}
                            ...
                            <div class="accordion-item">
                                <h6 class="accordion-header" id="flush-headingfive">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('eega_location', __('City/Municipality of'),['class'=>'form-label']) }}
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <span class="validate-err">{{ $errors->first('appbrgy_code') }}</span>
                                            <div class="form-icon-user">
                                                {{ Form::text('locappbrgy_code',$excavationappdata->locbarangay, array('class' => 'form-control disabled-field locappbrgy_code','id'=>'locappbrgy_code')) }}
                                            </div>
                                            <span class="validate-err" id="err_brgy_code"></span>
                                        </div>
                                    </div>
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('loceega_location',$excavationappdata->locmunicipality, array('class' => 'form-control disabled-field','id'=>'loceega_location')) }}
                                            </div>
                                            <span class="validate-err" id="err_eega_location"></span>
                                        </div>
                                    </div>
                         ...
                         <div  class="accordion accordion-flush">
                            <div class="accordion-item">
                                <h6 class="accordion-header" id="flush-headingfive">
                                 ...
                                 <div class="row">
                                       <div class="col-sm-12">
                                     {{ Form::label('label', __('Excavation Ground Type'),['class'=>'form-label bold']) }}<span class="text-danger">*</span>
                                      <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            @php  $idsofeeetid = explode(',',$excavationappdata->eegt_id);
                                               ...
                                               <div class="form-check form-check-inline form-group col-md-12">
                                                {{ Form::checkbox('eegt_id[]', $key,(in_array($key,$idsofeeetid))?true:false, array('id'=>'eegt_id'.$key,'class'=>'form-check-input code')) }}
                                                {{ Form::label('eegt_id'.$key, __($val),['class'=>'form-label']) }}
                                            </div>
                                        </div>  
                                      @endforeach
                                     </div>
                                     <span class="validate-err" id="err_eegt_id"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="accordion-item">
                                    <h6 class="accordion-header" id="flush-headingfive">
                                        <button class="accordion-button collapsed btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefive" aria-expanded="false" aria-controls="flush-headingfive" style="padding-right:0px;">
                                            ...
                                            <div class="row" style="width: 100%;padding-right: 0px;padding-left: 0px;">
                                        <div class="col-md-11">
                                            <h6 class="sub-title accordiantitle " style="padding-top: 12px;">{{__("Full-Time Inspector and Supervisor of Construction Works")}}</h6>
                                        </div>
                                        <div class="col-md-1" >
                                            <a href="{{ url('/eng/consultantexternal') }}" target="_blank">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::select('eega_building_official',$buildofficial,$excavationappdata->eega_building_official, array('class' => 'form-control','id'=>'eega_building_official','required'=>'required')) }}
                                            </div>
                 ...
                 {{Form::close()}}
                  <script type="text/javascript">
                     $(document).ready(function(){
                        ...
                        $("#eega_sign_category").select3({ dropdownAutoWidth: false });
                        $("#eega_incharge_category").select3({ dropdownAutoWidth: false });
                     });
                 </script>
                 <script>
