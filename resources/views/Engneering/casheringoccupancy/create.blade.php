{{ Form::open(array('url' => 'occupancycashering','id'=>'casherform')) }}
    ...
    font-style: normal;
    font-weight: 400;
    src: local('Digital Numbers'), url('../dev/css/DigitalNumbers-Regular.woff?v=4.7.0"') format('woff');
    }   
                            ...
                            <div class="row">
                                 <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user" id="topnumberajax">
                               ...
                               <div class="col-sm-12">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        {{Form::text('total_amount',$data->total_amount,array('class'=>'form-control numeric-double','required'=>'required','id'=>'total_amount','step'=>'0.01'))}}
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        {{Form::text('total_paid_amount',$data->total_paid_amount,array('class'=>'form-control numeric-double','required'=>'required','id'=>'total_paid_amount','step'=>'0.01'))}}
                                    </div>
                    ...
                    <div class="row" style="width: 100%; margin: 0px;padding-bottom: 20px;">
                            <div class="row field-requirement-details-status">
                                <div class="col-lg-1 col-md-1 col-sm-1">
                                    {{Form::label('subclass_id',__('Years'),['class'=>'form-label','style'=>'color:#fff;padding-top: 10px;'])}}
                                </div>
                                <div class="col-lg-5 col-md-5 col-sm-5">
                                    {{Form::label('taxable_item_name',__('Particulars'),['class'=>'form-label','style'=>'color:#fff;padding-top: 10px;'])}}
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    {{Form::label('taxable_item_qty',__('Taxable Amount'),['class'=>'form-label numeric','style'=>'color:#fff;padding-top: 10px;'])}}
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    {{Form::label('taxable_item_qty',__('Amount'),['class'=>'form-label numeric','style'=>'color:#fff;padding-top: 10px;'])}}
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1">
                           ...
                           <span class="taxfeesDetails activity-details tablestripped" id="FeesDetails">
                                ...
                                <div class="removetaxfeesdata row pt10 hide">
                                    <div class="col-lg-1 col-md-1 col-sm-1">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2">
                                        <div class="form-group">
                                         {{Form::text('taxableamount[]',$val->ctc_taxable_amount,array('class'=>'form-control taxableamount disabled-field numeric-double','id'=>'taxableamount'))}}
                                       </div>
                                    </div>
                                    <div class="col-lg-2 col-md-2 col-sm-2">
                                        <div class="form-group">
                                ...
                                <div class="row hide">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2">
                                        <div class="form-group">
                                            {{Form::text('amount[]','',array('class'=>'form-control disabled-field amount','id'=>'cpdoamount'))}}
                                        </div>
                                    </div>
                                    <div class="col-lg-1 col-md-1 col-sm-1">
                                    </div>
                               ...
                               @endif
                        <div class="row hide"> <div class="col-sm-8"></div><div class="col-sm-2">  <label for="amountpaid" class="form-label labelbold"><strong>Surcharge</strong></label></div><div class="col-sm-2" style="font-size:20px;"> {{Form::text('total_paid_surcharge','0.00',array('class'=>'form-control red','id'=>'surcharge'))}}</div></div>
...
<div id="hidencheckHtml" class="hide">
     <div class="row removecheckdata" style="padding: 5px 0px;">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2">
         ...
         <div class="col-lg-2 col-md-2 col-sm-2">
            {{Form::text('checktype3[]','',array('class'=>'form-control checktype','id'=>'checktype'))}}
        </div>
         <div class="col-lg-2 col-md-2 col-sm-2">
            {{Form::text('checkamount3[]','',array('class'=>'form-control checkamount','id'=>'checkamount','required'=>'required'))}}
        </div>
          <div class="col-lg-2 col-md-2 col-sm-2">
...
<div id="hidenbankHtml" class="hide">
     <div class="row removebankdata" style="padding: 5px 0px;">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2">
         ...
         <div class="col-lg-2 col-md-2 col-sm-2">
            {{Form::text('checkamount2[]','',array('class'=>'form-control checkamount','id'=>'checkamount','required'=>'required'))}}
        </div>
          <div class="col-lg-2 col-md-2 col-sm-2">
...
<script src="{{asset('js/Engneering/add_occupancycashering.js')}}?rand={{ rand(000,999) }}"></script>
