{{Form::open(array('name'=>'forms','url'=>'rptmachinery/sd/submit','method'=>'post','id'=>'subdivisionIntermediateSubmission'))}}
       ...
       <div class="row">
            ...
            <div class="accordion accordion-flush">
                <div class="accordion-item">
                    <h6 class="accordion-header" id="flush-headingtwo">
                        <button class="accordion-button collapsed btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsetwo" aria-expanded="false" aria-controls="flush-headingtwo">
                        <h6 class="sub-title accordiantitle">{{__('Property Machine Appraisals & Assessment Details')}}</h6>
                        </button>
                    </h6>
                ...
                <div class="col-xl-12">
                 <div class="card">
                    <div class="card-body table-border-style">
                        <div class="table-responsive" id="prevPropertyFloorValues">
