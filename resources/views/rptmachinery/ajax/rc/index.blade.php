{{Form::open(array('name'=>'forms','url'=>'rptmachinery/rc/submit','method'=>'post','id'=>'reclassificationIntermediateSubmission'))}}
                                ...
                                <tbody>
                                    ...
                                    @foreach($selectedProperty->machineAppraisals as $key=>$val)
                                        <tr class="font-style">
                                            ...
                                            <td class="app_qurtr">{{ ($val->rpma_date_acquired != '')?date("m/d/Y",strtotime($val->rpma_date_acquired)):''}}</td> 
                                            <td class="app_qurtr">{{ $val->rpma_condition }}</td>
                                            <td class="app_qurtr">{{ $val->rpma_estimated_life }}</td> 
                                            <td class="">{{ $val->rpma_remaining_life }}</td>
                                            <td class="app_qurtr">{{ ($val->rpma_date_installed != '')?date("m/d/Y",strtotime($val->rpma_date_installed)):'' }}</td>
                                            <td class="app_qurtr">{{ ($val->rpma_date_operated != '')?date("m/d/Y",strtotime($val->rpma_date_operated)):'' }}</td>
                                        </tr>
                                    @endforeach
                                ...
                                <tbody>
                                    ...
                                    @foreach($selectedProperty->machineAppraisals as $key=>$val)
                                        <tr class="font-style">
                                            ...
                                            <td class="app_qurtr">{{Helper::decimal_format(($val->rpma_freight_cost+$val->rpma_insurance_cost+$val->rpma_insurance_cost+$val->rpma_installation_cost+$val->rpma_other_cost))}}</td>
                                             <td class="app_qurtr">{{Helper::decimal_format($val->rpma_base_market_value)}}</td>
                                            <td class="app_qurtr">{{Helper::decimal_format($val->rpma_depreciation)}}</td> 
