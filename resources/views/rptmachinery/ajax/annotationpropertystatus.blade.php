{{Form::open(array('name'=>'forms','url'=>'rptmachinery/anootationspeicalpropertystatus','method'=>'post','id'=>'saveAnnotationPropertyStatus'))}}
...
<div class="modal-header">
                <h4 class="modal-title">Annotation & Property Status (Machinery)</h4>
        ...
        <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                	<div class="row">
                                		...
                                		<div class="col-lg-10 col-md-10 col-sm-10" style="margin-top: -8px;padding-bottom: 10px;">
                                			<div class="form-group">
             ...
             <div class="col-lg-12 col-md-12 col-sm-12"> 
              ...
              <div class="col-lg-12 col-md-12 col-sm-12"> 
             	<div class="row">
             		...
             		<div class="col-lg-4 col-md-4 col-sm-4">
             			{{Form::text('rpss_mortgage_exec_by',(isset($propertyStatus->rpss_mortgage_exec_by))?$propertyStatus->rpss_mortgage_exec_by:'',array('class'=>'form-control rpss_mortgage_exec_by','rows'=>1,'placeholder'=>'Select Name'))}}
