{{Form::open(array('name'=>'forms','url'=>'rptproperty/anootationspeicalpropertystatus','method'=>'post','id'=>'saveAnnotationPropertyStatus'))}}
...
<div class="modal-header">
                <h4 class="modal-title">Annotation & Property Status (Land)</h4>
            ...
            <div  class="accordion accordion-flush">
                <div class="accordion-item">
                    ...
                    <div id="flush-collapsefive" class="accordion-collapse collapse show" aria-labelledby="flush-headingfive" data-bs-parent="#accordionFlushExample5">
                        <div class="basicinfodiv firstDivOfCheckBoxes">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                	<div class="row">
                                		...
                                		<div class="col-lg-10 col-md-10 col-sm-10">
                                			<div class="form-group" style="margin-top: -8px;padding-bottom: 10px;">
             ...
             <div class="col-lg-12 col-md-12 col-sm-12"> 
             	<div class="row">
             		...
             		<div class="col-lg-9 col-md-9 col-sm-9">
             			{{Form::text('rpss_mortgage_cancelled',(isset($propertyStatus->rpss_mortgage_cancelled))?$propertyStatus->rpss_mortgage_cancelled:'',array('class'=>'form-control rpss_mortgage_cancelled','rows'=>1))}}
