...
<div class="modal-header">
		<h4 class="modal-title">Land Appraisal Update</h4>
...
<div class="row">
   ...
   <div class="col-lg-3 col-md-3 col-sm-3">
	...
	<div class="col-lg-3 col-md-3 col-sm-3">
		<div class="form-group">
			<div class="form-icon-user">
				{{Form::text('lav_unit_measure',(isset($landAppraisal->lav_unit_measure))?config('constants.lav_unit_measure.'.$landAppraisal->lav_unit_measure):'',array('class'=>'form-control lav_unit_measure','readonly'=>true))}}
...
<div class="row">
   ...
   <div class="col-lg-3 col-md-3 col-sm-3">
		<div class="form-group">
			<div class="form-icon-user">
				{{Form::label('al_assessment_level',__("Assessment Level"),['class'=>'form-label'])}}
			</div>
		</div>
	</div>
	<div class="col-lg-3 col-md-3 col-sm-3">
...
<div class="row">
	<div class="col-lg-3 col-md-3 col-sm-3">
		<div class="form-group">
			<div class="form-icon-user">
				{{Form::label('rpa_assessed_value',__("Assessed Value"),['class'=>'form-label hide','id'=>'rpa_assessed_value_label'])}}
			</div>
		</div>
	</div>
	<div class="col-lg-9 col-md-9 col-sm-9">
