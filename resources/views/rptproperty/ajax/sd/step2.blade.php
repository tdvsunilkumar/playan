{{Form::open(array('name'=>'forms','url'=>'rptproperty/sd/submit','method'=>'post','id'=>'subdivisionIntermediateSubmission'))}}
 ...
 {{ Form::hidden('action','taxDeclarationDivisionFinsish', array('id' => 'selectedlandappraisal','class'=>'selectedlandappraisal')) }}
            ...
            </div><div class="col-sm-6" style="text-align: end;padding-right: 20px;">
            <a href="{{ url('/rptpropertyowner?isopenAddform=1') }}" title="Manage Taxpayer" data-title="Manage Taxpayers" class="btn btn-sm btn-primary" target="_blank" style="font-size: 16px;padding: 9px 8px;">Add Taxpayer
            </a>
             <!-- <button type="button" class="btn btn-success pull-right" data-url="{{ url('/rptpropertyowner/store') }}" id="addnewownerSubdividedTaxDeclaration">Add Taxpayer</button>  -->
