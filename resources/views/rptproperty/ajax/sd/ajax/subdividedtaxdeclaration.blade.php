 <table class="table" id="new_added_land_apraisal">
                                ...
                                <tbody>
                                    ...
                                    @foreach($selectedProperty as $prop)

                                        <tr class="font-style">
                                            <td width="10%">
                                                <input type="checkbox" data-subdividedtaxdeclarationid="{{ $prop->id }}" class="subdividedtaxdeclarationid" value="{{ $prop->id }}" {{($prop->id == $lastId)?'checked':''}}/>
                                            ...
                                            <td width="10%"><button type="button" class="btn btn-danger deleteSubdividedTaxDeclaration" id="{{ $prop->id }}"><i class="ti-trash"></i></button>
                                            </td> 
                                        </tr>
                                   @endforeach
