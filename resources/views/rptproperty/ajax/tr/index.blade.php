{{Form::open(array('name'=>'forms','url'=>'rptproperty/tr/submit','method'=>'post','id'=>'transferOfOwnershipIntermediateSubmission'))}}
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapsetwo" class="accordion-collapse collapse show" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample2">
                        <div class="row"  id="otheinfodiv">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    {{ Form::label('rp_td_no', __('Series No.'),['class'=>'form-label']) }}
                                    <div class="form-icon-user">
                                        {{ Form::text('rp_td_no', (isset($selectedProperty->rp_td_no))?$selectedProperty->rp_td_no:'', array('class' => 'form-control '.$readonly)) }}
                                    </div>
