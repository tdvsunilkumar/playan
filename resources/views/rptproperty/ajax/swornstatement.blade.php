{{Form::open(array('name'=>'forms','url'=>'rptproperty/swornstatment','method'=>'post','id'=>'saveSwornStatement'))}}
...
{{ Form::hidden('cashier_id',(isset($propertyStatus->cashier_id))?$propertyStatus->cashier_id:'', array('id' => 'cashier_id')) }}
{{ Form::hidden('cashierd_id',(isset($propertyStatus->cashierd_id))?$propertyStatus->cashierd_id:'', array('id' => 'cashierd_id')) }}
 <style>
    .modal-xll {
...
<div class="modal-header">
                <h4 class="modal-title">Sworn Statement Of Owner (Land)</h4>
