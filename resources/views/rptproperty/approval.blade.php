{{Form::open(array('name'=>'forms','url'=>'rptproperty/approve','method'=>'post','id'=>'saveApprovelFormData'))}}
...
<div class="modal-header">
                ...
                <a class="close closeApprovalFormModel" data-dismiss="modal" aria-hidden="true" type="add" mid="" style="cursor: default;">X</a>
...
<div class="modal-body">
    <div class="row pt10" >
        ...
        <div class="col-lg-12 col-md-12 col-sm-12"  id="accordionFlushExample5" style="margin-top: -20px;">  
            @if($ucCode =='11' && !empty($Oldtaxdeclarationno))
            <p>Dublicate Copy of tax Declaration: {{$Oldtaxdeclarationno}}</p>
            @endif
            @if(!empty($duptaxdeclaration))
                <p>Original Copy of tax Declaration: {{$duptaxdeclaration}}</p>
            @endif
                                                ...
                                                <table class="table" id="new_added_land_apraisal">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 5%;">
                                                                ...
                                                                <a data-toggle="modal" href="javascript:void(0)" data-propertyid="{{ (isset($approvelFormData->rp_code) && $approvelFormData->rp_code != '')?$approvelFormData->rp_code:'' }}" id="addPreviousOwnerForLand" class="btn btn-primary" ><i class="ti-plus"></i>
                                                                </a>
                                                                @endif
                                                            </th>
                                                        </tr>
                                                    ...
                                                    <tbody>
                                                        @foreach($history as $key=>$val)
                                                            ...
                                                            @if($val->cancelProp != null && $val->activeProp != null)
                                                                @php
                                                                   
                                                                    $totalHectare =0;
                                                                    $totalSM=0;
                                                                    if($val->cancelProp != null){
                                                                        foreach($val->cancelProp->landAppraisals as $l_key=>$l_val){
                                                                            if(isset($l_val)){
                                                                                if($l_val->lav_unit_measure==1){
                                                                                    $totalSM +=$l_val->rpa_total_land_area;
                                                                                }
                                                                                if($l_val->lav_unit_measure==2){
                                                                                    $totalHectare +=$l_val->rpa_total_land_area;
                                                                                }
                                                                            }
                                                                    ...
                                                                    $totalArea = '';
                                                                    if($totalHectare>0){
                                                                        $totalArea .= Helper::decimal_format($totalHectare).' '.config('constants.lav_unit_measure')[2];
                                                                    }
                                                                    if($totalSM>0){
                                                                        $totalArea .= ' | '.Helper::decimal_format($totalSM).' '.config('constants.lav_unit_measure')[1];
                                                                    }
                                                                    $totalArea = trim($totalArea,' | ');
                                                                    $pau_actual_use_code = (isset($val->cancelProp->landAppraisals[0]->actualUses->pau_actual_use_code))?$val->cancelProp->landAppraisals[0]->actualUses->pau_actual_use_code.'-'.$val->cancelProp->landAppraisals[0]->actualUses->pau_actual_use_desc:'';
                                                                ...
                                                                <tr class="font-style" >
                                                                    ...
                                                                    <td class="app_qurtr"><span class="showLessArea">{{ $totalArea }}</span></td>

                                                                    <td class="app_qurtr">{{ number_format($val->cancelProp->landAppraisals->sum('rpa_adjusted_market_value'), 2, '.', ',') }}</td>
                                                                    <td class="app_qurtr">{{ ($val->cancelProp->pk_is_active != 9)?number_format($val->cancelProp->landAppraisals->sum('rpa_assessed_value'), 2, '.', ','):Helper::decimal_format($val->cancelProp->rp_assessed_value) }}</td>
                                                                    ...
                                                                    <td class="app_qurtr">{{ $val->cancelProp->rp_app_effective_year}} - {{ config('constants.payModePartitionShortCut')[3][($val->cancelProp->rp_app_effective_quarter != 0)?$val->cancelProp->rp_app_effective_quarter:1]  }}</td>
                        ...
                        <div class="basicinfodiv">
                            <div class="row">
                                <div class="col-lg-2 col-md-2 col-sm-2 textright">
                                 ...
                                 <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-icon-user err_rp_app_appraised_by_group">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-icon-user err_rp_app_taxability_group">
                             ...
                             <div class="row">
                                <div class="col-lg-2 col-md-2 col-sm-2 textright">
                                 ...
                                 <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-icon-user err_rp_app_recommend_by_group">
                                ...
                                {{ Form::checkbox('rp_app_recommend_is_signed', '1', (isset($approvelFormData->rp_app_recommend_is_signed))?$approvelFormData->rp_app_recommend_is_signed:0, array('id'=>'rp_app_recommend_is_signed','class'=>'form-check-input rp_app_recommend_is_signed')) }}
                                 ...
                                 <div class="col-lg-1 col-md-1 col-sm-1">
                                        <div class="form-icon-user">
                                            ...
                                            ?>
                                            {{ Form::text('rp_app_effective_year', isset($approvelFormData->rp_app_effective_year) ? $approvelFormData->rp_app_effective_year : $nextYear, array('class' => 'form-control', 'rows' => 1)) }}
                                 ...
                                 <div class="col-lg-1 col-md-1 col-sm-1">
                                        <div class="form-icon-user err_rp_app_effective_quarter_group">
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-2 col-sm-2 textright">
                                 ...
                                 <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-icon-user err_rp_app_approved_by_group">
                                ...
                                {{ Form::checkbox('rp_app_approved_is_signed', '1', (isset($approvelFormData->rp_app_approved_is_signed))?$approvelFormData->rp_app_approved_is_signed:0, array('id'=>'rp_app_approved_is_signed','class'=>'form-check-input rp_app_approved_is_signed')) }}
                                 ...
                                 <div class="col-lg-2 col-md-2 col-sm-2">
                                       {{Form::label('updatedcode',__('Updated Code'),['class'=>'form-label'])}}
                                </div>  
                                               
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-icon-user" id="uc_codediv">
                                            {{Form::select('uc_code',$arrUpdateCodes,$ucCode,array('class'=>'form-control select3 uc_code err_uc_code','readonly'=>'readonly'))}}
                                        </div>
                                 ...
                                 <div class="col-lg-10 col-md-10 col-sm-10">
                                        <div class="form-icon-user">
                                            @php $annotation = (isset($annotation))?'&#13;&#10;'.$annotation:''; @endphp
                                             ...
                                             {{Form::textarea('annotation',(isset($annotation))?$annotation:'',array('class'=>'form-control annotation','rows'=>2,'readonly'=>true,'style' => "border-top: 0px;border-radius: 0px 0px 5px 5px;resize: none;background-color: #fff;"))}}
                                        </div>
                        ...
                        <div class="basicinfodiv">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                   ...
                                   <input type="hidden" name="rp_app_cancel_by" value="{{ \Auth::user()->id }}">
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-2 col-sm-2 textright">
                                 ...
                                 <div class="col-lg-3 col-md-3 col-sm-3 rp_app_cancel_type_group">
                                    
                                     {{ Form::select('rp_app_cancel_type',$arrUpdateCodes,(isset($approvelFormData->rp_app_cancel_type))?$approvelFormData->rp_app_cancel_type:'', array('class' => 'form-control select3 rp_app_cancel_type','id'=>'rp_app_cancel_type','placeholder'=>'Select Cancellation Type','disabled' => true)) }}
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-2 col-sm-2 textright">
                                 ...
                                 <div class="col-lg-10 col-md-10 col-sm-10">
                                        <div class="form-icon-user rp_app_cancel_by_td_id_group">
                                            ...
                                            {{ Form::select('rp_app_cancel_by_td_id[]',$allTds,(isset($approvelFormData->rp_app_cancel_by_td_id))?explode(",",$approvelFormData->rp_app_cancel_by_td_id):[], array('class' => 'form-control rp_app_cancel_by_td_id','id'=>'rp_app_cancel_by_td_id','multiple'=>'multiple','disabled' => true)) }}
                                         </div>
                             ...
                             <div class="row">
                                <div class="col-lg-2 col-md-2 col-sm-2 textright">
                                 ...
                                 <div class="col-lg-10 col-md-10 col-sm-10"> 
                                        <div class="form-icon-user">
                                             {{Form::textarea('rp_app_cancel_remarks',(isset($approvelFormData->rp_app_cancel_remarks))?$approvelFormData->rp_app_cancel_remarks:'',array('class'=>'form-control','rows'=>2,'id'=>'rp_app_cancel_remarks','disabled' => true))}}
                                        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#quarter").select3({dropdownAutoWidth : false,dropdownParent : $("#quarterId")});
        $("#revision_year").select3({dropdownAutoWidth : false,dropdownParent : $("#yearId")});
        $("#owner").select3({dropdownAutoWidth : false,dropdownParent : $("#ownerId")});
        $("#taxablity").select3({dropdownAutoWidth : false,dropdownParent : $("#taxablityId")});
        $("#approved").select3({dropdownAutoWidth : false,dropdownParent : $("#approvedId")});
        $("#newdeclaration").select3({dropdownAutoWidth : false,dropdownParent : $("#newdeclarationId")});
        // $("#rvy_revision_year_id").select3({dropdownAutoWidth : false,dropdownParent : $("#year")});
        var yearpickerInput = $('input[name="efectivity"]').val();
