{{ Form::open(array('url' => 'business-permit/application','id'=>'bulkUploadClients')) }}
            ...
            <div class="row">
                <div class="col-lg-10 col-md-10 col-sm-10" id="DivBusiness">
                    <div class="form-group">
                        {{Form::label('bulkUploadFile1',__('Upload Land Tax Declaration[CSV File]-1st'),['class'=>'form-label'])}}<span class="text-danger">*</span>
                        <div class="form-icon-user">
                            {{Form::file('bulkUploadFile1',array('class'=>'form-control','id'=>'bulkUploadFile1','accept'=>'.csv'))}}
                        </div>
                        <a href="{{url('rptproperty/downloadlandTDTemplate')}}" target="_blank">Download Land Tax Declaration Template[XLSX File]</a>
                    </div>
                </div>

                <div class="col-lg-10 col-md-10 col-sm-10 hide" id="DivPsic">
                    <div class="form-group">
                        {{Form::label('bulkUploadFile2',__('Upload Land Appraisals'),['class'=>'form-label'])}}<span class="text-danger">*</span>
                        <div class="form-icon-user">
                            {{Form::file('bulkUploadFile2',array('class'=>'form-control', 'id'=>'bulkUploadFile2','accept'=>'.csv'))}}
                        </div>
                        <a href="{{url('rptproperty/downloadLandAppraisalTemplate')}}" target="_blank">Download Real Property: Land Appraisal Template[XLSX File]</a>
                    </div>
                </div>
 ...
 {{Form::close()}}
<script src="{{ asset('js/rptLandBulkUpload.js') }}"></script> 
