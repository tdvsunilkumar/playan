{{ Form::open(array('url' => 'psicgroup','class'=>'formDtls','id'=>'submitLandUnitValueForm')) }}
        ...
        .modal.show .modal-dialog {
            ...
            <div class="modal-body">
                        ...
                        <!-- <div class="col-md-12">
                         ...
                         <div class="col-md-12">
                            <div class="form-group" id="group_Division">
                                {{ Form::label('division_id', __('Section => Division'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                    ...
                    <div class="row">
                       <div class="col-md-8">
                            <div class="form-group">
                                {{ Form::label('group_code', __('Group Code'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                <span class="validate-err">{{ $errors->first('group_code') }}</span>
                                <div class="form-icon-user">
                                     {{ Form::text('group_code', $data->group_code, array('class' => 'form-control','required'=>'required')) }}
                                </div>
                                <span class="validate-err" id="err_group_code"></span>
                            </div>
                        </div>
                    ...
                    <div class="d-flex radio-check">
                        ...
                        <div class="form-group col-md-12">
                            {{ Form::label('group_description', __('Group Desc'),['class'=>'form-label']) }}
                            <span class="text-danger">*</span>
                            <span class="validate-err">{{ $errors->first('group_description') }}</span>
                            {!! Form::textarea('group_description', $data->group_description, ['class'=>'form-control','rows'=>'2','required'=>'required']) !!}
                             <span class="validate-err" id="err_group_description"></span>
                        </div>
                    </div>
...
<script src="{{ asset('js/add_psicgroup.js') }}"></script>
<script type="text/javascript">
    ...
    $('#savechanges').click(function (e) {
        ...
        $.ajax({
            url :DIR+'psicgroup/formValidation', // json datasource
            type: "POST", 
