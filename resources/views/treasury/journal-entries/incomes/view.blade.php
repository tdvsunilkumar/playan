...
@section('action-btn')
    <div class="float-end">
        <a href="{{ url('treasury/journal-entries') }}" data-size="lg" data-bs-toggle="tooltip" data-bs-placement="left" title="{{__('Back to Manage Voucher')}}" class="btn btn-sm btn-primary add-btn">
