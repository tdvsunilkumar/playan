<div class="modal form fade" id="disapprove-payment-modal" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="accountPaymentLabel" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            {{ Form::open(array('url' => 'treasury/journal-entries/payments', 'class' => '', 'name' => 'disapprovePaymentForm')) }}
            @csrf
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn submit-disapprove-payment-btn btn-blue align-middle d-flex justify-content-center">Submit</button>
            </div>
            {{ Form::close() }}
        </div>
    </div>
