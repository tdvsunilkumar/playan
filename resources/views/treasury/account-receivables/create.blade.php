<div class="modal form fade" id="account-payable-modal" tabindex="-1" role="dialog" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="accountPayableModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            {{ Form::open(array('url' => 'accounting/account-payables', 'class'=>'formDtls needs-validation', 'name' => 'accountPayableForm')) }}
            @csrf
                        ...
                        <div class="col-sm-12">
                            <div class="form-group m-form__group required disabled">
                                ...
                                {{ 
                                    ...
                                    $attributes = array(
                                        'id' => 'total_amount',
                                        'class' => 'require form-control form-control-solid strong text-danger numeric-double disable',
                                        'disabled' => 'disabled'
                                    )) 
                                }}
                                <span class="m-form__help text-danger"></span>
