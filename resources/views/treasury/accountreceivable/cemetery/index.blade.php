...
@section('page-title')
    {{__('Treasury -> Account Receivable: Cemetery')}}
@endsection
@push('script-page')
@endpush
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item">{{__('Account Receivable: Cemetery')}}</li>
                    ...
                    <div class="card-body">
                        <div class="row">
                           ...
                           <div class="d-flex align-items-center justify-content-end mt-3">
                            <a class="btn btn-sm btn-primary" id="btn_download_spreadsheet" href="{{ url('cemetery-ar/exportarcemetery') }}">
...
<script src="{{ asset('js/treasury/cemeteryar.js') }}?rand={{ rand(000,999) }}"></script>
@endsection
