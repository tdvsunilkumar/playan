...
@section('page-title')
    {{__('Treasury -> Account Receivable: Housing')}}
@endsection
@push('script-page')
@endpush
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item">{{__('Account Receivable: Housing')}}</li>
        ...
        <div class="modal-dialog modal-lg modalDiv" style="max-width: 1200px;">
            <div class="modal-content" id="serviceform">
                <div class="modal-header">
					<h4 class="modal-title">Housing Application Payment Summary<span id="orno"></span> <span id="itemNo"></span>]</h4>
...
<script src="{{ asset('js/treasury/housingar.js') }}?rand={{ rand(000,999) }}"></script>
@endsection
