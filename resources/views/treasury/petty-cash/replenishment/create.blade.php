<div class="modal form fade" id="replenish-modal" tabindex="-1" role="dialog" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="replenishModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            {{ Form::open(array('url' => 'treasury/petty-cash/replenishment', 'class'=>'formDtls needs-validation', 'name' => 'replenishForm')) }}
            @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn send-btn bg-info align-middle d-flex justify-content-center text-white">
                        Send Request
                    </button>
                </div>
            {{ Form::close() }}
