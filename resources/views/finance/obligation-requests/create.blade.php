    ...
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header pt-4 pb-4">
                <h5 class="modal-title" id="departmentalRequisitionLabel">Manage {{ ucwords(str_replace('-',' ',request()->segment(count(request()->segments())))) }}</h5>
            </div>
                ...
                <div class="alob-v1 hidden">
                    <div class="row">
                        ...
                        <div class="col-md-7 space-left">
                            ...
                            <h4 class="text-header mt-1 mb-3">COMPUTED PAYROLL</h4>
                            <div id="datatable-emp" class="dataTables_wrapper">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table id="empListTable" class="display dataTable table w-100 table-striped mt-4" aria-describedby="allotmentBreakdown_info">
                                                <thead>
                                                    <tr>
                                                        <th>{{ __('ID') }}</th>
                        ...
                        <div class="col-md-5 border-right space-right">
                            <ul class="nav nav-pills mb-3 d-flex justify-content-center" id="pills-tab" role="tablist">
                                <li class="nav-item" role="departmental-request">
                                    <button class="nav-link active" id="request-details-tab" data-bs-toggle="pill" data-bs-target="#request-details" type="button" role="tab" aria-controls="request-details" aria-selected="true">1) REQUEST </button>
                                </li>
                                <li class="nav-item" role="for-alob">
                                    <button class="nav-link disabled" id="alob-details-tab" data-bs-toggle="pill" data-bs-target="#alob-details" type="button" role="tab" aria-controls="alob-details" aria-selected="false">2) ALOB</button>
                                </li>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                @include('finance.obligation-requests.request-details') 
                                <!-- REQUEST DETAILS END -->

                                <!-- ALOB DETAILS START -->
                                @include('finance.obligation-requests.alob-details') 
                                <!-- ALOB DETAILS END -->
