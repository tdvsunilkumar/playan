<div class="modal form-inner fade" id="budget-breakdown2-modal" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="bugetLabel" tabindex="-1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4 pt-3 pb-1">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group m-form__group required">
                            ...
                            {{
                                Form::select('gl_account_id', $gl_accounts, $value = '', ['id' => 'gl_account_id2', 'class' => 'form-control', 'data-placeholder' => 'select a gl account'])
                            }}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group m-form__group required">
                            ...
                            {{
                                Form::select('budget_category_id', $categories, $value = '', ['id' => 'budget_category_id2', 'class' => 'form-control', 'data-placeholder' => 'select a category'])
                            }}
                            <span class="m-form__help text-danger"></span>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group m-form__group hidden">
                            {{ Form::label('alignment', 'Re-alignment', ['class' => 'required fs-6 fw-bold']) }}
                            {{ 
