    ...
    <div class="modal-dialog modal-xxl">
        <div class="modal-content">
                                        ...
                                        <table id="breakdownTable" class="display dataTable table w-100 table-striped" aria-describedby="prInfo">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>{{ __('Category') }}</th>
                                                    <th class="text-center">{{ __('Quarterly') }}<br/>{{ __('Budget') }}</th>
                                                    <th class="text-center">{{ __('Annual') }}<br/>{{ __('Budget') }}</th>
                                                    <th class="text-center">{{ __('Budget') }}<br/>{{ __('Re-alignment') }}</th>
                                                    <th class="text-center">{{ __('Final') }}<br/>{{ __('Budget') }}</th>
                                                    <th class="text-center">{{ __('Used') }}<br/>{{ __('Budget') }}</th>
                                                    <th class="text-center">{{ __('BALANCE') }}</th>
                                                    <th class="text-center">{{ __('Is PPMP') }}</th>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th colspan="1" class="text-end fs-5 total-quarterly">{{ __('0.00') }}</th>
                                                    <th colspan="1" class="text-end fs-5 total-annual">{{ __('0.00') }}</th>
                                                    <th colspan="1" class="text-end fs-5 total-alignment">{{ __('0.00') }}</th>
                                                    <th colspan="1" class="text-end fs-5 total-final text-primary">{{ __('0.00') }}</th>
                                                    <th colspan="1" class="text-end fs-5 total-used">{{ __('0.00') }}</th>
                                                    <th colspan="1" class="text-end text-danger fs-5 total-balance">{{ __('0.00') }}</th>
                                                    <th colspan="3"></th>
                                                </tr>
                                            </tfoot>
                                        </table>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn send-btn bg-info align-middle d-flex justify-content-center text-white">Lock Budget</button>
            </div>
            {{ Form::close() }}
        </div>
    </div>
