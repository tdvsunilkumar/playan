{{ Form::open(array('url' => 'cashier/Miscellaneous/store','class'=>'formDtls','id'=>'mainForm')) }}
                            ...
                            <div class="basicinfodiv">
                                <div class="box-border">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="d-flex radio-check">
                                                <div class="form-check form-check-inline form-group col-md-1">
                                                    {{ Form::radio('payee_type', '2',  ($data->payee_type =='2')?true:false, array('id'=>'citizens','class'=>'form-check-input payee_type', 'required'=>'required',$isDisabledChkboxOr)) }}
                                                    {{ Form::label('citizens', __('Citizens'),['class'=>'form-label']) }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="d-flex radio-check">
                                                <div class="form-check form-check-inline form-group col-md-1">
                                                    {{ Form::radio('payee_type', '1', ($data->payee_type =='1')?true:false, array('id'=>'taxpayers','class'=>'form-check-input payee_type', 'required'=>'required',$isDisabledChkboxOr)) }}
                                                    {{ Form::label('taxpayers', __('Taxpayers'),['class'=>'form-label']) }}
                                                </div>
                                            </div>
                                        </div>
                                     ...
                                     <div class="row">
                                        <div class="col-md-1">
                                            {{Form::label('client_topno',__('TOP'),['class'=>'form-label'])}}
                                        </div>
                                        <div class="col-md-11 select-box" id="topnumberajax">
                                            {{ Form::select('client_topno',$arrTransactionNum,$data->top_transaction_id, array('class' => 'form-control '.$select3,'id'=>'client_topno')) }}
                                        </div>
                                        <span class="validate-err" id="err_client_topno" style="text-align: right;"></span>
                                    </div>

                                    <div class="row" id="communitytaxtaxpayers">
                                        <div class="col-md-1">
                                            {{Form::label('client_citizen_id',__('Name'),['class'=>'form-label'])}}
                                        </div>
                                        <div class="col-md-10 select-box" id="clientdivselect">
                                            {{ Form::select('client_citizen_id',$arrUser,$data->client_citizen_id, array('class' => 'form-control '.$readonlyclass,'id'=>'client_citizen_id')) }}
                                        </div>
                                        <div class="col-md-9 select-box hide" id="clientdivshow">
                                             {{Form::text('clientcitizenidshow','',array('class'=>'form-control','id'=>'clientcitizenidshow'))}}
                                            <span class="validate-err" id="err_client_citizen_id" style="text-align: right;"></span>
                                        </div>
                                         <div class="col-md-1" style="margin-top: 1px;margin-left: -7px;">    
                                           <a target="_blank" href="{{ url('/allclients') }}" data-size="lg"  title="{{__('Manage Citizens')}}" id="addtaxpayerorcitizen" class="btn btn-sm btn-primary" style="    padding: 5px 9px;"><i class="ti-plus"></i></a></div>
                                        <span class="validate-err" id="err_client_citizen_id" style="text-align: right;"></span>
                                    </div>
                                </div>
...
@if(($data->id)>0)
    {{ Form::open(array('url' => 'cashier/Miscellaneous/cancelOr','class'=>'formDtls','id'=>'formdtlcancelid')) }}
...
<script src="{{asset('js/SocialWelfare/add_MiscellaneousCashiering.js')}}?rand={{ rand(000,999) }}"></script>
