...
@section('page-title')
    {{__('Engineering: Online Application')}}
@endsection
@push('script-page')
@endpush
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item">{{__('Engineering: Online Application')}}</li>
@endsection
@section('action-btn')
    <div class="float-end">
...
@section('content')
   <div class="row" id="this_is_filter">
    ...
    <div class="row">
     ...
     <script src="{{ asset('js/Engneering/engjobrequestonline.js') }}"></script>
@endsection
