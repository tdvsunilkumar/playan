                        ...
                        <div  class="accordion accordion-flush">
                            <div class="accordion-item">
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('ebpa_location', __('City / Municipal of'),['class'=>'form-label']) }}
                         ...
                         <div  class="accordion accordion-flush">
                            <div class="accordion-item">
                                <h6 class="accordion-header" id="flush-headingfive">
                                 ...
                                 <div class="row">
                                    <div class="col-sm-12">
                                         {{ Form::label('typeofdisplay', __('A Type of Display'),['class'=>'form-label']) }}
                                      <div class="row">
                                       @foreach($arrsigndisplaytype as  $key => $val)
                                        <div class="col-md-4">
                                               <div class="form-check form-check-inline form-group col-md-12">
                                                {{ Form::checkbox('esdt_id', $key,($signappdata->esdt_id == $key)?true:false, array('id'=>'esdt_id','class'=>'form-check-input code')) }}
                                                {{ Form::label('esdt_id', __($val),['class'=>'form-label']) }}
                                            </div>
                                        </div>  
                                      @endforeach
                                     </div>
                                 ...
                                 <div class="row">
                                   <div class="col-sm-12">
                                         {{ Form::label('typeofdisplay', __('A Type of Installation'),['class'=>'form-label']) }}
                                      <div class="row">
                                       @foreach($arrsignInstllationtype as  $key => $val)
                                        <div class="col-md-4">
                                               <div class="form-check form-check-inline form-group col-md-12">
                                                {{ Form::checkbox('esit_id', $key,($signappdata->esit_id == $key)?true:false, array('id'=>'esit_id','class'=>'form-check-input code')) }}
                                                {{ Form::label('esit_id', __($val),['class'=>'form-label']) }}
                                            </div>
                                        </div>  
                                      @endforeach
                                     </div>
                                 ...
                                 <div class="row">
                                   <div class="col-sm-12">
                                         {{ Form::label('dispalysize', __('Display Size/Face'),['class'=>'form-label']) }}
                                      <div class="row">
                                        <div class="col-md-4">
                                               <div class="form-group">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::select('esa_building_official',$hremployees,$signappdata->esa_building_official, array('class' => 'form-control','id'=>'esa_building_official','required'=>'required')) }}
                                            </div>
