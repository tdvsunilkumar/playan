                        ...
                        <div  class="accordion accordion-flush">
                            <div class="accordion-item">
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('ebpa_location', __('City / Municipal of'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                         ...
                         <div class="col-sm-6">
                               <div  class="accordion accordion-flush">
                                <div class="accordion-item">
                                    <h6 class="accordion-header" id="flush-headingfive">
                                        <button class="accordion-button collapsed btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefive" aria-expanded="false" aria-controls="flush-headingfive">
                                            <h6 class="sub-title accordiantitle">{{__("FULL TIME INSPECTOR AND SUPERVISOR OF CONSTRUCTION WORK")}}</h6>
                                        </button>
                                    </h6>
                                     <div class="row">
                                        <div class="col-md-4">
                              ...
                              <div  class="accordion accordion-flush">
                                <div class="accordion-item">
                                   ...
                                   <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                {{ Form::label('address', __('Address'),['class'=>'form-label bold']) }}<span class="text-danger">*</span>
                                                <span class="validate-err">{{ $errors->first('validity') }}</span>
                                                <div class="form-icon-user">
                                   ...
                                   <div class="row">
                                    <div class="col-md-4">
                                            <div class="form-group">
                                                {{ Form::label('ctcno', __('CTC NO'),['class'=>'form-label bold']) }}<span class="text-danger">*</span>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                {{ Form::label('dateissued', __('Date Issued'),['class'=>'form-label bold']) }}<span class="text-danger">*</span>
                                       ...
                                       <div class="col-md-4">
                                            <div class="form-group">
                                                {{ Form::label('placeissued', __('Place Issued'),['class'=>'form-label bold']) }}<span class="text-danger">*</span>
                                                <span class="validate-err">{{ $errors->first('placeissued') }}</span>
                                                <div class="form-icon-user">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="validate-err">{{ $errors->first('ctcno') }}</span>
                                                <div class="form-icon-user">
                                                    {{ Form::text('applicantaddressnew',$fencingappdata->applicantaddressnew, array('class' => 'form-control','id'=>'applicantaddress'))}}
                                                <span class="validate-err" id="err_ctcno"></span>
                                              </div>
                                           </div>
                                       </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-icon-user">
                                                    {{ Form::text('measurelength',$fencingappdata->measurelength, array('class' => 'form-control numeric-only','id'=>'measurelength','required'=>'required')) }}
                                       ...
                                       <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-icon-user">
                                                    {{ Form::text('measureheight',$fencingappdata->measureheight, array('class' => 'form-control numeric-only','id'=>'measureheight')) }}
                                       ...
                                       @foreach($arrtypeofFencing as  $key => $val)
                                        <div class="col-md-4">
                                               <div class="form-check form-check-inline form-group col-md-12">
                                                {{ Form::checkbox('typeoffencing', $key,( $fencingappdata->typeoffencing == $key)?true:false, array('id'=>'typeoffencing','class'=>'form-check-input code')) }}
                                                {{ Form::label('typeoffencing', __($val),['class'=>'form-label']) }}
                                            </div>
                                        </div>  
                                      @endforeach
                                     </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::select('efa_building_official',$hremployees,$fencingappdata->efa_building_official, array('class' => 'form-control','id'=>'efa_building_official','required'=>'required')) }}
                                            </div>
