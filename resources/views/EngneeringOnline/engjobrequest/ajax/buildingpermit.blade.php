                                    ...
                                    <div class="col-md-4">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('ebpa_permit_no',$appdata->ebpa_permit_no, array('class' => 'form-control ebpa_permit_no disabled-field','id'=>'ebpa_permit_no')) }}
                                            </div>
                                ...
                                <h6 class="accordion-header" id="flush-headingfive">
                                 ...
                                 <div class="row">
                                    <div class="col-md-4">
                                     ...
                                     <div class="col-md-2">
                                      ...
                                      <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('ebpa_owner_suffix_name','', array('class' => 'form-control suffix','id'=>'suffix')) }}
                                            </div>
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('ebpa_economic_act', __('Main Economic Activity/kind Bussiness'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('ebpa_address_house_lot_no',$appdata->ebpa_address_house_lot_no, array('class' => 'form-control ebpa_address_house_lot_no','id'=>'ebpa_address_house_lot_no')) }}
                                            </div>
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('ebpa_address_street_name',$appdata->ebpa_address_street_name, array('class' => 'form-control ebpa_address_street_name','id'=>'ebpa_address_street_name')) }}
                                            </div>
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('ebpa_address_subdivision',$appdata->ebpa_address_subdivision, array('class' => 'form-control ebpa_address_subdivision','id'=>'ebpa_address_subdivision')) }}
                                            </div>
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('ebpa_location',$appdata->ebpa_location, array('class' => 'form-control ebpa_location','id'=>'ebpa_location','required'=>'required')) }}
                                            </div>
                                       ...
                                       @foreach($arrTypeofOccupancy as  $key => $val)
                                        <div class="col-md-3">
                                               <div class="form-check form-check-inline form-group col-md-12">
                                                {{ Form::radio('ebot_id', $key,($appdata->ebot_id == $key)?true:false, array('id'=>'active','class'=>'form-check-input occupancyclass')) }}
                                                {{ Form::label('active', __($val),['class'=>'form-label']) }}
                                            </div>
                                        </div> 
                                        <div class="col-md-9">
                                 ...
                                 <div class="row" id="bldfullname">
                                    <div class="col-md-6">
                                        <div class="form-group" >
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::select('ebpa_bldg_official_name',$hremployees,$appdata->ebpa_bldg_official_name, array('class' => 'form-control','id'=>'ebpa_bldg_official_name','required'=>'required')) }}
                                            </div>
                               ...
                               <div  class="accordion accordion-flush">
                                <div class="accordion-item">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                {{ Form::label('ebfd_total_est_cost', __('Total Cost'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                                <span class="validate-err">{{ $errors->first('ebfd_total_est_cost') }}</span>
                                                <div class="form-icon-user">
                                                    <div class="form-icon-user currency">
                                                    {{ Form::text('ebfd_total_est_cost',$engfeesdata->ebfd_total_est_cost, array('class' => 'form-control numeric-double','id'=>'ebfd_total_est_cost','required'=>'required','readonly')) }}
                                                    <div class="currency-sign"><span>Php</span></div>
                                                </div>
                                                <span class="validate-err" id="err_es_id"></span>
                                            </div>
                                     ...
                                     <div class="row">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-icon-user">
                                                    {{ Form::text('ebfd_floor_area',$engfeesdata->ebfd_floor_area, array('class' => 'form-control numeric-only','id'=>'ebfd_floor_area','required'=>'required')) }}
                                                </div>
                                                <span class="validate-err" id="err_es_id"></span>
                                            </div>
                                           </div>
                                           <div class="col-md-6">
                                            <div class="form-group">
                                                {{ Form::label('ebfd_construction_date', __('Expected date of Completion'),['class'=>'form-label bold']) }}<span class="text-danger">*</span>
                                                <span class="validate-err">{{ $errors->first('ebfd_construction_date') }}</span>
                                                <div class="form-icon-user">
                                                    {{ Form::date('ebfd_construction_date',$engfeesdata->ebfd_construction_date, array('class' => 'form-control','id'=>'ebfd_construction_date','required'=>'required')) }}
                                                </div>
                                ...
                                <div class="accordion-item">
                                    <h6 class="accordion-header" id="flush-headingfive">
                                        <button class="accordion-button collapsed btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefive" aria-expanded="false" aria-controls="flush-headingfive">
                                            <h6 class="sub-title accordiantitle">{{__("Assessed Fees")}}</h6>
                                             <!-- <span class="btn_buildingrevision btn btn-primary" id="btn_buildingrevision" style="color:white;"><i class="ti-plus"></i></span> -->
                                        </button>
                                    </h6>
                                     <div class="row">
                                        <div class="col-md-3">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-3">
                                            <div class="form-group">
                                                 <div class="form-icon-user">
                                                    {{ Form::select('ebaf_zoning_assessed_by',$hremployees,$EngAssessdata->ebaf_zoning_assessed_by, array('class' => 'form-control ','id'=>'ebaf_zoning_assessed_by')) }}
                                                    <span class="validate-err" id="err_es_id"></span>
                                                </div>
                                           </div>
                                       </div>
                                ...
                                <div class="accordion-item">
                                    <h6 class="accordion-header" id="flush-headingfive">
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group" id="signidparent">
                           ...
                           <div class="col-sm-12">
                               <div  class="accordion accordion-flush">
                                <div class="accordion-item">
                                    <h6 class="accordion-header" id="flush-headingfive">
                                        <button class="accordion-button collapsed btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefive" aria-expanded="false" aria-controls="flush-headingfive">
                                            <h6 class="sub-title accordiantitle">{{__("Architecture / Civil Engineer Incharge Of Construction")}}</h6>
                                        </button>
                                    </h6>
                                     <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group" id="inchargeparent">
                                ...
                                <div class="accordion-item">
                                    <h6 class="accordion-header" id="flush-headingfive">
                                     ...
                                     <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                {{ Form::label('ebfd_consent_tctoct_no', __('TCT/OCT No.'),['class'=>'form-label bold']) }}
                                                <span class="validate-err">{{ $errors->first('ebfd_consent_tctoct_no') }}</span>
                                                <div class="form-icon-user">
                                                    {{ Form::text('ebfd_consent_tctoct_no',$engfeesdata->ebfd_consent_tctoct_no, array('class' => 'form-control','id'=>'ctcoctno')) }}
                                                <span class="validate-err" id="err_tfoc_id"></span>
                                              </div>
                                           </div>
                                       </div>
