                            ...
                            <div class="accordion-item">
                                <h6 class="accordion-header" id="flush-headingfive">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('eea_economic_act', __('Main Economic Activity/kind Bussiness'),['class'=>'form-label']) }}
                                        ...
                                        <div class="col-md-3">
                                            @php  $idsofeeetid = explode(',',$architecturalappdata->eeft_id);
                                               ...
                                               <div class="form-check form-check-inline form-group col-md-12">
                                                {{ Form::checkbox('eeft_id[]', $key,(in_array($key,$idsofeeetid))?true:false, array('id'=>'eeft_id','class'=>'form-check-input code')) }}
                                                {{ Form::label('eeft_id', __($val),['class'=>'form-label']) }}
                                            </div>
                                        </div>  
                                      @endforeach
                                     </div>
                                        ...
                                        <div class="col-md-3">
                                            @php  $idsoectfc_id = explode(',',$architecturalappdata->ectfc_id);
                                               ...
                                               <div class="form-check form-check-inline form-group col-md-12">
                                                ...
                                                {{ Form::label('ectfc_id', __($val),['class'=>'form-label']) }}
                                            </div>
                                        </div>  
                                      @endforeach
                                     </div>
                         ...
                         <div class="col-sm-6">
                               <div  class="accordion accordion-flush">
                                <div class="accordion-item">
                                    <h6 class="accordion-header" id="flush-headingfive">
                                        <button class="accordion-button collapsed btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefive" aria-expanded="false" aria-controls="flush-headingfive">
                                            <h6 class="sub-title accordiantitle">{{__("SUPERVISIOR IN CHARGE OF ARCHITECTURAL WORK")}}</h6>
                                        </button>
                                    </h6>
                                     <div class="row">
                                        <div class="col-md-4">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::select('eea_building_official',$hremployees,$architecturalappdata->eea_building_official, array('class' => 'form-control','id'=>'eea_building_official','required'=>'required')) }}
                                            </div>
