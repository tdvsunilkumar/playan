                                ...
                                <h6 class="accordion-header" id="flush-headingfive">
                                 ...
                                 <div class="row">
                                    <div class="col-md-4">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('eca_economic_act', __('Main Economic Activity / Kind Bussiness'),['class'=>'form-label']) }}
                        ...
                        <div  class="accordion accordion-flush">
                            <div class="accordion-item">
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('eca_location', __('City / Municipal of'),['class'=>'form-label']) }}
                                       ...
                                       @foreach($arrTypeofOccupancy as  $key => $val)
                                        <div class="col-md-4">
                                               <div class="form-check form-check-inline form-group col-md-12">
                                                {{ Form::checkbox('ebot_id', $key,($civilappdata->ebot_id == $key)?true:false, array('id'=>'ebot_id','class'=>'form-check-input code')) }}
                                                {{ Form::label('ebot_id', __($val),['class'=>'form-label']) }}
                                            </div>
                                        </div>  
                                      @endforeach
                                     </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::select('eca_building_official',$hremployees,$civilappdata->eca_building_official, array('class' => 'form-control','id'=>'eca_building_official','required'=>'required')) }}
                                            </div>
