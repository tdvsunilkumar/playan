                      ...
                      <div id="page1">  
                            ...
                            <div class="accordion-item">
                                <h6 class="accordion-header" id="flush-headingfive">
                                    <button class="accordion-button collapsed btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefive" aria-expanded="false" aria-controls="flush-headingfive">
                                        <h6 class="sub-title accordiantitle">{{__("Application safik")}}</h6>
                                    </button>
                                </h6>
                                 <div class="row">
                                    <div class="col-md-4">
                                ...
                                <h6 class="accordion-header" id="flush-headingfive">
                                 ...
                                 <div class="row">
                                    <div class="col-md-4">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('eeta_economic_act', __('Main Economic Activity / Kind Bussiness'),['class'=>'form-label']) }}
                        ...
                        <div  class="accordion accordion-flush">
                            <div class="accordion-item">
                                <h6 class="accordion-header" id="flush-headingfive">
                                    <button class="accordion-button collapsed btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefive" aria-expanded="false" aria-controls="flush-headingfive">
                                        <h6 class="sub-title accordiantitle">{{__("Nature of installation works / Equipments System")}}</h6>
                                    </button>
                                </h6>
                                 <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-md-4">
                                             @php  $idsofeest_id = explode(',',$electronicsappdata->eest_id);
                                               ...
                                               <div class="form-check form-check-inline form-group col-md-12">
                                                {{ Form::checkbox('eest_id[]', $key,(in_array($key,$idsofeest_id))?true:false, array('id'=>'eest_id','class'=>'form-check-input code')) }}
                                                {{ Form::label('eest_id', __($val),['class'=>'form-label']) }}
                                            </div>
                                        </div>  
                                      @endforeach
                                     </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::select('eeta_building_official',$hremployees,$electronicsappdata->eeta_building_official, array('class' => 'form-control','id'=>'eeta_building_official','required'=>'required')) }}
                                            </div>
