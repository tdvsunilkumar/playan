                                ...
                                <h6 class="accordion-header" id="flush-headingfive">
                                 ...
                                 <div class="row">
                                    <div class="col-md-4">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('kindbussiness', __('Main Economic Activity / Kind Bussiness'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                        ...
                        <div  class="accordion accordion-flush">
                                 ...
                                 <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::select('ebs_id',$arrscopeofwork,$electricappdata->ebs_id, array('class' => 'form-control','id'=>'ebs_id')) }}
                                            </div>
                                     ...
                                     <div class="col-md-8">
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::select('ebot_id',$arrTypeofOccupancy,$electricappdata->ebot_id, array('class' => 'form-control','id'=>'ebot_id')) }}
                                            </div>
                         ...
                         <div  class="accordion accordion-flush">
                            <div class="accordion-item">
                                <h6 class="accordion-header" id="flush-headingfive">
                                    <button class="accordion-button collapsed btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefive" aria-expanded="false" aria-controls="flush-headingfive">
                                        <h6 class="sub-title accordiantitle">{{__("NO Of Outlets And Equipments To Be installed")}}</h6>
                                    </button>
                                </h6>
                                 <div class="row">
                                    <div class="col-sm-6">
                                     {{ Form::label('label', __('NO Of Outlets And Equipments To Be installed'),['class'=>'form-label bold']) }}
                                      <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            @php  $idsofeeetid = explode(',',$electricappdata->eeet_id);
                                               ...
                                               <div class="form-check form-check-inline form-group col-md-12">
                                                {{ Form::checkbox('eeet_id[]', $key,(in_array($key,$idsofeeetid))?true:false, array('id'=>'eeet_id','class'=>'form-check-input code')) }}
                                                {{ Form::label('eeet_id', __($val),['class'=>'form-label']) }}
                                            </div>
                                        </div>  
                                      @endforeach
                                     </div>
                                     ...
                                     <div class="col-sm-6">
                                        <div class="row">  
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                {{ Form::label('eea_estimated_cost', __('Estimate Cost OF Electical Installation'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                       ...
                                       <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::date('eea_date_of_completion',$electricappdata->eea_date_of_completion, array('class' => 'form-control eea_date_of_completion numeric-only','id'=>'eea_date_of_completion','required'=>'required')) }}
                                            </div>
                                            <span class="validate-err" id="err_espa_no_of_storey"></span>
                                        </div>
                                     </div>
                         ...
                         <div class="col-sm-12">
                               <div  class="accordion accordion-flush">
                                <div class="accordion-item">
                                    <h6 class="accordion-header" id="flush-headingfive">
                                        <button class="accordion-button collapsed btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefive" aria-expanded="false" aria-controls="flush-headingfive">
                                            <h6 class="sub-title accordiantitle">{{__("ELECTRICAL ENGINEER/MASTER ELECTRICIAN")}}</h6>
                                        </button>
                                    </h6>
                                     <div class="row">
                                        <div class="col-md-2">
                        ...
                        <div  class="accordion accordion-flush">
                            ...
                            <div class="accordion-item">
                                <h6 class="accordion-header" id="flush-headingfive">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            {{ Form::label('muncipality', __('City / Municipal of'),['class'=>'form-label']) }}
                                ...
                                <div class="row">
                                    <div class="row">{{ Form::label('locconstruct', __('Location Of Installation'),['class'=>'form-label']) }}</div>
                                     <div class="col-md-2">
                                        <div class="form-group">
                                            {{ Form::label('lotno', __('Address'),['class'=>'form-label']) }}
                                            <span class="validate-err">{{ $errors->first('lotno') }}</span>
                                            <div class="form-icon-user">
                                                {{ Form::text('lotno',$electricappdata->lotno, array('class' => 'form-control select3 lotno','id'=>'ownerlotno')) }}
                                            </div>
                                     ...
                                     <div class="col-md-2">
                                        <div class="form-group">
                                            {{ Form::label('streetname', __('Street Name'),['class'=>'form-label']) }}
                                            <span class="validate-err">{{ $errors->first('streetname') }}</span>
                                            <div class="form-icon-user">
                                                {{ Form::text('streetname',$electricappdata->streetname, array('class' => 'form-control select3 streetname','id'=>'ownerstreetname')) }}
                                            </div>
                                            <span class="validate-err" id="err_Street"></span>
                                        </div>
                                    </div>
                                     <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('subdivision',$electricappdata->subdivision, array('class' => 'form-control select3 subdivision','id'=>'ownersubdivision')) }}
                                            </div>
                                            <span class="validate-err" id="err_Street"></span>
                                        </div>
                                    </div>
                                      <div class="col-md-3">
                                        <div class="form-group">
                                            {{ Form::label('espa_location', __('Çity Municipality OF'),['class'=>'form-label']) }}
                                            <span class="validate-err">{{ $errors->first('espa_location') }}</span>
                                            <div class="form-icon-user">
                                                {{ Form::text('ownerespa_location',$electricappdata->ownerespa_location, array('class' => 'form-control espa_location','id'=>'ownerespa_location')) }}
                                            </div>
                                            <span class="validate-err" id="err_ebpa_location"></span>
                                        </div>
                                    </div>
                         ...
                         <div  class="accordion accordion-flush">
                                <div class="accordion-item">
                                    <h6 class="accordion-header" id="flush-headingfive">
                                        <button class="accordion-button collapsed btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefive" aria-expanded="false" aria-controls="flush-headingfive">
                                            <h6 class="sub-title accordiantitle">{{__("Assessed Fee")}}</h6>

                                 <!-- <span class="btn_electricalrevision btn btn-primary" id="btn_electricalrevision" style="color:white;"><i class="ti-plus"></i></span> -->
                                        </button>
                                    </h6>
                                     <div class="row">
                                        <div class="col-md-3">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::select('eea_building_official',$hremployees,$electricappdata->eea_building_official, array('class' => 'form-control','id'=>'eea_building_official','required'=>'required')) }}
                                            </div>
