    ...
    <div class="float-end">
         <a href="#" id="filter_box" class="btn btn-sm btn-primary action-item" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="ti-filter"></i>
             ...
             <a href="#" data-size="xl" data-url="{{ url('/engoccupancyapp/store') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Manage Occupancy Permit Application')}}" class="btn btn-sm btn-primary modal-dialog-scrollable">
            <i class="ti-plus"></i>
