                       ...
                       <div class="col-md-4">
                        ...
                        <div class="col-md-3">
                         ...
                         <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="form-icon-user">
                                     {{ Form::text('rpo_address_subdivision',$data->rpo_address_subdivision, array('class' => 'form-control ','id'=>'rpo_address_subdivision','required'=>'required')) }}
                                </div>
                                <span class="validate-err" id="err_req_id"></span>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group" id="divBarngayList">
                                {{ Form::label('brgy_code', __('Brgy Code:'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                         ...
                         <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-icon-user">
                                     {{ Form::text('ebpa_location',$data->ebpa_location, array('class' => 'form-control ','id'=>'ebpa_location $data->ebpa_location','required'=>'required')) }}
                                </div>
                        ...
                        <div class="col-md-4">
                         ...
                         <div class="col-md-2">
                            <div class="form-group">
                                {{ Form::label('ebfd_floor_area', __('Total Floor Area(m)'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                ...
                <div class="accordion-item">
                    ...
                    <div class="basicinfodiv orpayment">
                         ...
                         <div class="row">  
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    {{ Form::label('eoa_lotarea', __('LOT AREA(Sq. Mtr.)'),['class'=>'form-label']) }}
                                    <span class="validate-err">{{ $errors->first('eoa_lotarea') }}</span>
                                    <div class="form-icon-user">
                                        {{ Form::text('eoa_lotarea',$data->eoa_lotarea, array('class' => 'form-control','id'=>'eoa_lotarea')) }}
                                    </div>
                             ...
                             <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="form-icon-user">
                                        {{ Form::text('eoa_perimeter',$data->eoa_perimeter, array('class' => 'form-control','id'=>'eoa_perimeter')) }}
                                    </div>
                        ...
                        <div class="row">  
                        {{ Form::label('dimension', __('FLOOR AREA'),['class'=>'form-label Bold']) }}  
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('eoa_floor_area', __('Dimension'),['class'=>'form-label']) }}
                                    <span class="validate-err">{{ $errors->first('eoa_floor_area') }}</span>
                                    <div class="form-icon-user">
                                        {{ Form::text('eoa_floor_area',$data->eoa_floor_area, array('class' => 'form-control','id'=>'eoa_floor_area')) }}
                                    </div>
                             ...
                             <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-icon-user">
                                        {{ Form::text('eoa_firstfloorarea',$data->eoa_firstfloorarea, array('class' => 'form-control','id'=>'eoa_firstfloorarea')) }}
                                    </div>
                                    <span class="validate-err" id="err_es_id"></span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-icon-user">
                                         {{ Form::text('eoa_secondfloorarea',$data->eoa_secondfloorarea, array('class' => 'form-control ','id'=>'eoa_secondfloorarea')) }}
                                    </div>
                             ...
                             <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-icon-user">
                                        ...
                                        {{ Form::text('eoa_projectcost',$data->eoa_projectcost, array('class' => 'form-control numeric-double amountpattern','id'=>'eoa_projectcost')) }}
                         ...
                         <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                     <div class="form-group">
                                        ...
                                        {{ Form::text('eoa_surcharge_fee',$data->eoa_surcharge_fee, array('class' => 'form-control numeric-double amountpattern','id'=>'eoa_surcharge_fee')) }}
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <div class="form-group">
