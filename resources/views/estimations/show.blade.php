    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Edit Estimation')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ URL::to('estimations/'.$estimation->id.'/edit') }}" data-ajax-popup="true" data-title="{{__('Edit Estimation')}}" class="btn btn-xs btn-white btn-icon-only width-auto"><i class="ti-pencil text-white"></i> {{__('Edit')}}</a>
            </div>
        @endcan
        @can('View Estimation')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                    ...
                    <div class="justify-content-between align-items-center d-flex">
                        ...
                        @can('Estimation Add Product')
                            <a href="#" class="btn btn-sm btn-white float-right add-small" data-url="{{ route('estimations.products.add',$estimation->id) }}" data-ajax-popup="true" data-title="{{__('Add Product')}}">
                                <i class="ti-plus"></i> {{__('Add Product')}}
                            </a>
                        @endcan
                    </div>
                    <div class="card">
                                    ...
                                    <tr>
                                        ...
                                        <span>
                                            @can('Estimation Edit Product')
                                                <a href="#" class="edit-icon" data-url="{{ route('estimations.products.edit',[$estimation->id,$product->pivot->id]) }}" data-ajax-popup="true" data-title="{{__('Edit Estimation Product')}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="ti-pencil text-white"></i></a>
                                            @endcan
                                            @can('Estimation Delete Product')
                                                <a href="#" class="delete-icon" data-toggle="tooltip" data-original-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$product->pivot->id}}').submit();"><i class="ti-trash"></i></a>
