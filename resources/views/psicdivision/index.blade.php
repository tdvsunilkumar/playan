...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('PSIC Division')}}</li>
@endsection
@section('action-btn')
    <div class="float-end">
            ...
            <a href="#" data-size="lg" data-url="{{ url('/psicdivision/store') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Manage PSIC Division')}}" class="btn btn-sm btn-primary">
            <i class="ti-plus"></i>
        </a>
    </div>
@endsection
...
@section('content')
 ...
 <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="Jq_datatablelist">
                            ...
                            <tr>
                                 ...
                                 <th>{{__('No.')}}</th>
                                <th>{{__('Division Code')}}</th>
                                <th>{{__('Section')}}</th>
                                <th>{{__('Division Desc')}}</th>
                                <th>{{__('Status')}}</th>
                                <th>{{__('Action')}}</th>
                            </tr>
                            </thead>
    ...
    <script src="{{ asset('js/psicdivision.js') }}?rand={{ rand(000,999) }}"></script>
@endsection
