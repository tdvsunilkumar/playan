                ...
                <a class="navbar-brand" href="#">
                    @if($mode_setting['cust_darklayout'] && $mode_setting['cust_darklayout'] == 'on' )
                        <img src="{{ $logo . '/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'new-logo.png') }}"
                             alt="{{ config('app.name', 'ERPGo-SaaS') }}" style="height: 70px" class="logo w-100">
                    @else
        ...
        <div class="auth-footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-6">
                        <p class="">
                            {{(Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright TRIX') }} {{ date('Y') }}
                        </p>
                    </div>
...
<script>
    ...
    custdarklayout.addEventListener("click", function () {
        if (custdarklayout.checked) {
            ...
            document
                .querySelector(".m-header > .b-brand > .logo-lg")
                .setAttribute("src", "{{ asset('assets/images/new-logo.png') }}");
            document
                .querySelector("#main-style-link")
