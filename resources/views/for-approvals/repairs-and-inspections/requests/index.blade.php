...
@section('page-title')
    {{__('Repairs And Inspection - Requests')}}
@endsection
...
@section('content')
    ...
    @include('for-approvals.repairs-and-inspections.requests.disapprove')
    @include('for-approvals.repairs-and-inspections.requests.create')
@endsection
...
<script src="{{ asset('js/datatables/for-approvals-repair-manage.js?v='.filemtime(getcwd().'/js/datatables/for-approvals-repair-manage.js').'') }}"></script>
@endpush