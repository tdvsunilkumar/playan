<div class="modal form fade" id="repair-modal" tabindex="-1" role="dialog" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="repairModal">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            {{ Form::open(array('url' => 'general-services/repairs-and-inspections/manage', 'class'=>'formDtls needs-validation', 'name' => 'repairForm')) }}
            @csrf
                ...
                <div class="modal-body p-4">
                    <h4 class="text-header accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseDetails" aria-expanded="true" aria-controls="collapseDetails">Pre-Repair Inspection Request Details</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group m-form__group required">
                                    ...
                                    {{
                                        Form::select('property_id', $fixed_assets, $value = '', ['id' => 'property_id', 'class' => 'form-control select3 form-control-solid', 'data-placeholder' => 'select a fixed asset'])
                                    }}  
                            ...
                            <div class="col-sm-4">
                                <div class="form-group m-form__group required">
                                    ...
                                    {{
                                        Form::select('requested_by', $employees, $value = '', ['id' => 'requested_by', 'class' => 'form-control select3 form-control-solid', 'data-placeholder' => 'select a requestor'])
                                    }}  
                                    <span class="m-form__help text-danger"></span>
                                </div>
                            </div>
                    ...
                    <h4 class="text-header accordion-button mt-1" data-bs-toggle="collapse" data-bs-target="#collapseHistory" aria-expanded="true" aria-controls="collapseHistory">Repair History Details</h4>
