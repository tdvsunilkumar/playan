    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-header pt-4 pb-4">
                <h5 class="modal-title" id="bacRFQLabel">Manage For Approval</h5>
            </div>
            <div class="modal-body">
                <h4 class="text-header mb-3">Purchase Order's Information</h4>
                <div class="row">
                    <div class="col-sm-4">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn print-btn bg-print align-middle d-flex justify-content-center">Print</button>
            </div>
            {{ Form::close() }}
        </div>
    </div>
