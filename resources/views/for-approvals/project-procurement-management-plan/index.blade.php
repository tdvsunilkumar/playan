...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('PPMP') }}</li>
@endsection
@section('content')
    <div class="row">
        <div class="col-xl-12">
    ...
    @include('for-approvals.project-procurement-management-plan.disapprove')
@endsection
...
<script src="{{ asset('js/datatables/for-approvals-ppmp.js?v='.filemtime(getcwd().'/js/datatables/for-approvals-ppmp.js').'') }}"></script>
@endpush