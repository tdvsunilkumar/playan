<div class="modal form fade" id="add-payment-modal" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="addPaymentLabel" tabindex="-1">
    ...
    <div class="modal-content">
            {{ Form::open(array('url' => 'for-approvals/disbursements', 'class'=>'formDtls needs-validation', 'name' => 'paymentsForm')) }}
            @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group m-form__group">
                                ...
                                <br/>
                                <a href="{{ asset('/')}}" target="_blank" class="text-primary">this is attachment</a>
                            </div>
                        </div>
                    </div>
                    <div class="fv-row row">
