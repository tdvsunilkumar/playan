...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table id="issuanceTable" class="display dataTable table w-100 table-striped" aria-describedby="issuanceInfo">
                                        <thead>
                                            <tr>
                                                <th>{{ __('ID') }}</th>
                                                <th>{{ __('CONTROL NO') }}</th>
    ...
    @include('for-approvals.issuance.create')
    @include('for-approvals.issuance.disapprove')
@endsection
...
<script src="{{ asset('js/datatables/for-approvals-issuance.js?v='.filemtime(getcwd().'/js/datatables/for-approvals-issuance.js').'') }}"></script>
@endpush