...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('Cemetery Application') }}</li>
@endsection
@section('content')
    <div class="row">
        <div class="col-xl-12">
    ...
    @include('for-approvals.economic-and-investment.cemetery.disapprove')
    @include('for-approvals.economic-and-investment.cemetery.create')
@endsection
...
<script src="{{ asset('js/datatables/for-approvals-cemetery-application.js?v='.filemtime(getcwd().'/js/datatables/for-approvals-cemetery-application.js').'') }}"></script>
@endpush