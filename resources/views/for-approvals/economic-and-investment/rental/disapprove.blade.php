<div class="modal form fade" id="disapprove-modal" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="accountPayableLabel" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            {{ Form::open(array('url' => 'for-approvals/economic-and-investment/rental-application', 'class' => '', 'name' => 'disapproveRentalApplicationForm')) }}
            @csrf
            <div class="modal-header bg-danger pt-4 pb-4">
                <h5 class="modal-title" id="accountPayableLabel">Rental Application Disapproval (<span class="code"></span>)</h5>
            </div>
