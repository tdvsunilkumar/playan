<div class="modal form fade" id="disapprove-modal" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="jebPayablesLabel" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            {{ Form::open(array('url' => 'for-approvals/journal-entries/payables', 'class' => '', 'name' => 'disapproveRequestJevPayablesForm')) }}
            @csrf
            <div class="modal-header pt-4 pb-4 bg-danger">
                <h5 class="modal-title" id="bacRFQLabel">Journal Entries Payables (Document) Disapproval (<span class="code"></span>)</h5>
            </div>
