...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Incomes') }}</li>
@endsection
@section('content')
    <div class="row">
        <div class="col-xl-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table id="jevIncomeTable" class="display dataTable table w-100 table-striped" aria-describedby="jevIncomeInfo">
                                        <thead>
                                            <tr>
    ...
    @include('for-approvals.journal-entries.incomes.disapprove')
@endsection
...
<script src="{{ asset('js/datatables/for-approvals-jev-incomes.js?v='.filemtime(getcwd().'/js/datatables/for-approvals-jev-incomes.js').'') }}"></script>
@endpush