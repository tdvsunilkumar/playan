...
@section('content')
    ...
    @include('for-approvals.budget-proposal.disapprove')
    @include('for-approvals.budget-proposal.create')
    @include('for-approvals.budget-proposal.add-breakdown')
@endsection
...
<script src="{{ asset('js/datatables/for-approvals-budget-proposal.js?v='.filemtime(getcwd().'/js/datatables/for-approvals-budget-proposal.js').'') }}"></script>
@endpush