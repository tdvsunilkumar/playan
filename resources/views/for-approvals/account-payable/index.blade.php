...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('Account Payable') }}</li>
@endsection
@section('content')
    <div class="row">
        <div class="col-xl-12">
    ...
    @include('for-approvals.account-payable.disapprove')
    @include('for-approvals.account-payable.create')
@endsection
...
<script src="{{ asset('js/datatables/for-approvals-account-payable.js?v='.filemtime(getcwd().'/js/datatables/for-approvals-account-payable.js').'') }}"></script>
@endpush