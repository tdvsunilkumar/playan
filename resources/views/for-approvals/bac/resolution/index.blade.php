...
@section('content')
    ...
    @include('for-approvals.bac.resolution.create')
    @include('for-approvals.bac.resolution.add-committee')
    @include('for-approvals.bac.resolution.disapprove')
@endsection
...
<script src="{{ asset('js/datatables/for-approvals-resolution.js?v='.filemtime(getcwd().'/js/datatables/for-approvals-resolution.js').'') }}"></script>
@endpush