<div class="modal form fade" id="disapprove-modal" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="bacRFQLabel" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            {{ Form::open(array('url' => 'for-approvals/request-for-quotation', 'class' => '', 'name' => 'disapproveRequestForQuotationForm')) }}
            @csrf
            <div class="modal-header pt-4 pb-4">
                <h5 class="modal-title" id="bacRFQLabel">Request For Quotation Disapproval (<span class="code"></span>)</h5>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn submit-disapprove-btn bg-print align-middle d-flex justify-content-center">Submit</button>
            </div>
            {{ Form::close() }}
        </div>
    </div>
