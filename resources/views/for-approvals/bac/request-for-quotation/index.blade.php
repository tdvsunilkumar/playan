...
@section('content')
    ...
    @include('for-approvals.bac.request-for-quotation.create')
    @include('for-approvals.bac.request-for-quotation.canvass')
    @include('for-approvals.bac.request-for-quotation.disapprove')
@endsection
...
<script src="{{ asset('js/datatables/for-approvals-request-for-quotation.js?v='.filemtime(getcwd().'/js/datatables/for-approvals-request-for-quotation.js').'') }}"></script>
@endpush