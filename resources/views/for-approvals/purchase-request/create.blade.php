    ...
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header pt-4 pb-4">
                <h5 class="modal-title" id="purchaseRequestLabel">Manage For Approval</h5>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 border-right space-right">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            @include('for-approvals.purchase-request.request-details') 
                            <!-- REQUEST DETAILS END -->

                            <!-- ALOB DETAILS START -->
                            @include('for-approvals.purchase-request.alob-details') 
                            <!-- ALOB DETAILS END -->

                            <!-- ALOB DETAILS START -->
                            @include('for-approvals.purchase-request.pr-details') 
                            <!-- ALOB DETAILS END -->
