...
@section('page-title')
    {{__('Business Permit Issuance')}}
@endsection
@push('script-page')
@endpush
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item">{{__('Business Permit Issuance')}}</li>
...
<div class="row" id="this_is_filter">
    ...
    <script src="{{ asset('js/bplobusinesspermit.js') }}?rand={{ rand(0,999)}}"></script>
@endsection
