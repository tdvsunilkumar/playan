...
@section('action-btn')
	...
	<div class="float-end">
		<a href="#" data-url="{{ route('projectstages.create') }}" data-ajax-popup="true" data-title="{{__('Create Project Stage')}}" class="btn btn-xs btn-white btn-icon-only width-auto"><i class="ti-plus"></i> {{__('Create')}} </a>
	</div>
                            ...
                            <li class="list-group-item" data-id="{{$projectstage->id}}">
                                <div class="row">
                                    ...
                                    <div class="col-2"> 
										...
										<a href="#" class="delete-icon" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$projectstage->id}}').submit();"><i class="ti-trash"></i></a>
