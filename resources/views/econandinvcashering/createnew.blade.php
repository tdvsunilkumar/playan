                        ...
                        <div id="flush-collapseone" class="accordion-collapse collapse show" aria-labelledby="flush-headingone1">
                            <div class="basicinfodiv">
                                <div class="box-border">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            {{Form::label('clientcitizenid',__('Name'),['class'=>'form-label'])}}
                                        </div>
                                        <div class="col-md-8 select-box" id="clientdiv">
                                            {{ Form::select('clientcitizenid',$arrUser,$data->client_citizen_id, array('class' => 'form-control ','id'=>'clientcitizenid','required'=>'required')) }}
                                        </div>
                                        @if($data->id <= 0 )    
                                        <div class="col-md-8 select-box hide" id="clientdivshow">
                                            {{Form::text('clientcitizenshow','',array('class'=>'form-control disabled-field','id'=>'clientcitizenshow'))}}
                                        </div>
                                        @endif
...
@if(($data->id)>0)
    {{ Form::open(array('url' => 'cemetery-cashering/cancelOr','class'=>'formDtls')) }}
