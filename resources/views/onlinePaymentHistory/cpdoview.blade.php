                            ...
                            <span class="taxfeesDetails activity-details tablestripped" id="FeesDetails">
                                ...
                                <div class="row">
                                    <div class="col-lg-1 col-md-1 col-sm-1">
                                        <div class="form-group"> <div class="form-icon-user">{{Form::text('year[]',date('Y'),array('class'=>'form-control','readonly'=>'readonly','id'=>'year'))}}</div>
                                        </div>
                                    </div>
                                    <div class="col-lg-7 col-md-7 col-sm-7">
                                        <div class="form-group">
...
<script src="{{asset('js/OnlinePayment/cpdopayment.js')}}?rand={{ rand(000,999) }}"></script>
