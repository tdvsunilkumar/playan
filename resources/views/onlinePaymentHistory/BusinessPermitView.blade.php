    ...
    <div class="modal-body payment-dtls">
                            ...
                            <div class="basicinfodiv">
                                ...
                                <div class="box-border">
                                        ...
                                        <div class="col-md-12"> 
                                            <div class="d-flex radio-check">
                                             <div class="form-check form-check-inline form-group">
                                                {{ Form::checkbox('isuserrangeCheck', '1', '', array('id'=>'isuserrangeCheck','class'=>'form-check-input ',$isDisableUserOr)) }}
                                                {{ Form::label('isuserrangeCheck', __('Manual OR-Series'),['class'=>'form-label']) }}
                                              </div>
                                            </div>
                                       </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            {{Form::text('or_num',$data->or_no,array('class'=>'form-control numeric disabled-field','id'=>'or_num','required'=>'required disabled-field',$isDisabledChkboxOr))}}
                                        </div>
                                        <span class="validate-err" id="err_or_no" style="text-align: right;"></span>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            {{Form::label('cashier_or_date',__('O.R. Date'),['class'=>'form-label'])}}
                                        </div>
                                        <div class="col-md-6">
                        ...
                        <div id="flush-collapse2" class="accordion-collapse collapse show" aria-labelledby="flush-heading2">
                            <div class="basicinfodiv">
                                <div class="box-border box-heading">
                                    <div class="row ">
                                        <div class="col-md-6">  
                                            <h4 class="wht-color" id="or_numb"><?=$data->or_no?></h4>
                                        </div>
                                        <div class="col-md-6">  
        ...
        <div id="footer-details">
            ...
            <div class="modal-footer" style="float:right;">
                ...
                <input type="submit" name="submit" id="submit" value="{{ ($data->id)>0?__('Accept'):__('Accept')}}" class="btn btn-primary" style="background: #20b7cc;padding-left: 4px;border:1px solid #20b7cc;color: #fff;padding: 9px;border-radius: 5px;">
                </div>
                @endif
            </div>
        </div>
...
<div id="hiddenChequeDtls" class="hide">
    <div class="row removeChequeData pt10">
        ...
        <div class="col-md-2">
            {{Form::text('opayment_amount3[]','0.00',array('class'=>'form-control numeric'))}}
        </div>
...
<div id="hiddenBankDtls" class="hide">
    <div class="row removeBankData pt10">
        ...
        <div class="col-md-2">
            {{Form::text('opayment_amount2[]','',array('class'=>'form-control numeric'))}}
        </div>
        <div class="col-md-1 delete-btn-dtls">
            <span class="btnCancelBank btn-sm btn-danger">
                <i class="ti-trash"></i>
...
<script src="{{asset('js/BusinessPermitView.js')}}"></script>
