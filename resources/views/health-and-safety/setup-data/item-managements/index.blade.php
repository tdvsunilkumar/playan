...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Health & Safety') }}</li>
...
@section('content')
    ...
    @include('health-and-safety.setup-data.item-managements.create')
    @include('health-and-safety.setup-data.item-managements.conversion')
@endsection
...
<script src="{{ asset('js/datatables/health-safety-item.js?v='.filemtime(getcwd().'/js/datatables/health-safety-item.js').'') }}"></script>
<script src="{{ asset('js/forms/health-safety-item.js?v='.filemtime(getcwd().'/js/forms/health-safety-item.js').'') }}"></script>
@endpush
