    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">            
            ...
            <div class="modal-body p-4">
                {{ Form::open(array('url' => 'health-and-safety/setup-data/item-managements', 'class'=>'formDtls needs-validation', 'name' => 'itemForm')) }}
                @csrf
                ...
                <div class="fv-row row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group m-form__group">
                            {{ Form::label('medical_category_id', 'Medical Item Category', ['class' => '']) }}
                            {{
                                Form::select('medical_category_id', $medical_categories, $value = '', ['id' => 'medical_category_id', 'class' => 'form-control select3', 'data-placeholder' => 'select a medical category'])
                            }}
                            <span class="m-form__help text-danger"></span>
                        </div>
                    </div>
                        ...
                        <div class="form-group m-form__group">
                            <label for="remarks" class="fs-6 fw-bold w-100">
                                ...
                                <div class="form-check form-switch float-end">
                                    <input class="form-check-input" type="checkbox" name="is_expirable" id="is_expirable">
                ...
                <div class="fv-row row hidden upload-row">
                    ...
                    <div class="col-sm-12">
                        <h4 class="text-header mb-3">Upload Information</h4>
                    </div>
                    <div class="col-sm-12">
                        {{ Form::open(array('url' => 'healthy-and-safety/setup-data/item-managements?category=items', 'class'=>'dropzone dz-clickable', 'name' => 'itemUploadForm', 'id' => 'import-item-dropzone')) }}
