{{ Form::open(array('url' => 'cashier/HealthandSafety/store','class'=>'formDtls','id'=>'mainForm')) }}
...
{{ Form::hidden('client_citizen_id','', array('id' => 'client_citizen_id')) }}
...
@endphp
<!-- <link rel="stylesheet" href="{{ asset('css/DigitalNumbers-Regular.woff') }}" /> -->
<style type="text/css">
    @font-face {
                            ...
                            <div class="basicinfodiv">
                                <div class="box-border">
                                    ...
                                    <div class="row" id="clientdiv">
                                        ...
                                        <div class="col-md-9 select-box" id="clientdivselect">
                                            {{ Form::select('clientcitizenid',$arrUser,$data->client_citizen_id, array('class' => 'form-control ','id'=>'clientcitizenid')) }}
                                            <span class="validate-err" id="err_client_citizen_id" style="text-align: right;"></span>
                                        </div>
                                        ...
                                        <div class="col-md-0 hide" style="margin-top: 0px;">
                                         ...
                                         <div class="col-md-1" style="margin-top: 0px;">    
                                           <a target="_blank" href="{{ url('/health-safety-citizens') }}" data-size="lg"  title="{{__('Manage Citizens')}}" class="btn btn-sm btn-primary"><i class="ti-plus"></i></a></div>
...
@if(($data->id)>0)
    {{ Form::open(array('url' => 'cashier/HealthandSafety/cancelOr','class'=>'formDtls','id'=>'formdtlcancelid')) }}
...
<script src="{{asset('js/HealthandSafety/add_HealthandSafetyCashering.js')}}?rand={{ rand(000,999) }}"></script>
