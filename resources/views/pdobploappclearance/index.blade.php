...
@section('action-btn')
    <div class="float-end">
        ...
        <a href="#" data-size="lg" data-url="{{ url('/pdobploappclearance/store') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Pdo App Clearance')}}" class="btn btn-sm btn-primary">
            <i class="ti-plus"></i>
        </a>
    </div>
@endsection
...
@section('content')
                        ...
                        <table class="table" id="Jq_datatablelist">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{__('Clearance Fee')}}</th>
                                    <th>{{__('Payment In CTO')}}</th>
                                    <th>{{__('Date Issued')}}</th>
                                    <th>{{__('Officer Position')}}</th>
                                    <th>{{__('Approver Position')}}</th>
                                    <th>{{__('Remarks')}}</th>
                                    <th>{{__('Action')}}</th>
                                </tr>
                            </thead>
    ...
    <script src="{{ asset('js/pdobploappclearance.js') }}"></script>
@endsection
