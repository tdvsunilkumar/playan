            ...
            @csrf
                ...
                <div class="modal-body p-0 p-4">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group m-form__group required">
                                {{ Form::label('event_title', 'Event Title', ['class' => 'required fs-6 fw-bold']) }}
                                {{ 
                                    Form::text($name = 'event_title', $value = '', 
                                    $attributes = array(
                                        'id' => 'event_title',
                                        'class' => 'form-control form-control-solid',
                                    )) 
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group m-form__group required">
                                {{ Form::label('event_start', 'Start', ['class' => 'required fs-6 fw-bold']) }}
                        ...
                        <div class="col-sm-6">
                            <div class="form-group m-form__group required">
                                {{ Form::label('event_end', 'End', ['class' => 'required fs-6 fw-bold']) }}
                                <input type="datetime-local" 
                                    id="event_end"
                                    name="event_end"
                                    class="form-control form-control-solid"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group m-form__group">
                                {{ Form::label('discount_id', 'Discount', ['class' => '']) }}
                                {{
                                    Form::select('discount_id', $discounts, $value = '', ['id' => 'discount_id', 'class' => 'form-control select3', 'data-placeholder' => 'select a discount'])
                                }}
                                <span class="m-form__help text-danger"></span>
                            </div>
                        </div>
