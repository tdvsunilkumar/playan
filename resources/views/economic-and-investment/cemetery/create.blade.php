        ...
        <div class="modal-content">
            ...
            @csrf
                ...
                <div class="modal-body p-0 p-4">
                    ...
                    <div class="row terms hidden">
                        <div class="col-sm-6">
                            <div class="form-group m-form__group">
                                {{ Form::label('terms', 'Terms', ['class' => '']) }}
                                {{
                                    Form::select('terms', $terms, $value = '', ['id' => 'terms', 'class' => 'form-control select3', 'data-placeholder' => 'select a term'])
                                }}
                                <span class="m-form__help text-danger"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group m-form__group">
                                {{ Form::label('downpayment', 'Downpayment', ['class' => 'required fs-6 fw-bold']) }}
                                {{ 
                                    Form::text($name = 'downpayment', $value = '', 
                                    $attributes = array(
                                        'id' => 'downpayment',
                                        'class' => 'form-control form-control-solid disable',
                                        'disabled' => 'disabled'
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn term-btn btn-primary hidden">Update Terms</button>
