...
@section('page-title')
    {{__('Project Procurement Management Plan')}}
@endsection
...
@section('action-btn')
    <div class="float-end">
        <a href="javascript:;" data-size="lg" data-bs-toggle="tooltip" data-bs-placement="left" title="{{__('Create PPMP')}}" class="btn btn-sm btn-primary add-btn">
            <i class="ti-plus"></i>
        </a>
    </div>
@endsection
@section('content')
                                    ...
                                    <table id="ppmpTable" class="display dataTable table w-100 table-striped" aria-describedby="ppmpInfo">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sliced">{{ __('CATEGORIES') }}</th>
    ...
    @include('general-services.project-procurement-management-plan.create')
    @include('general-services.project-procurement-management-plan.disapprove')
    @include('general-services.project-procurement-management-plan.copy')
@endsection
...
<style>
    #ppmp-modal thead tr:nth-child(even) {
        background: transparent !important;
    }
    #ppmp-modal thead tr:nth-child(even) {
        border-color: transparent !important;
    }
    #ppmp-modal thead tr:nth-child(odd) th:nth-child(n + 4) {
        border-bottom: 1px solid rgba(31,56,150, 0.3);
    }
    #ppmp-modal tbody td {
