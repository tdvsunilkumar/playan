                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group m-form__group required">
                            ...
                            {{
                                Form::select('budget_category_id', $categories, $value = '', ['id' => 'budget_category_id', 'class' => 'form-control select3 fs-3', 'data-placeholder' => 'select a budget category'])
                            }}
                            <span class="m-form__help text-danger"></span>
                        </div>
                    </div>
