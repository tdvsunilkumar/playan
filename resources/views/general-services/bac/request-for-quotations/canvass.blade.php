    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex justify-content-end">
                ...
                <button type="button" class="btn submit-btn btn-info mw-200"><span>Post</span></button>
                <button type="button" class="btn save-btn btn-secondary mw-200"><span>Draft</span></button>
                <button type="button" class="btn btn-light mw-200" data-bs-dismiss="modal"><span>Close</span></button>
            </div>
            {{ Form::close() }}
        </div>
    </div>
