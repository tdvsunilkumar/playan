    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn award-btn bg-print align-middle d-flex justify-content-center">Award</button>
                <button type="button" class="btn send-btn bg-info align-middle d-flex justify-content-center text-white hidden">Send Request</button>
