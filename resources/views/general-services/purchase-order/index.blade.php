...
@section('action-btn')
    <div class="float-end">
        <a href="javascript:;" data-size="lg" data-bs-toggle="tooltip" data-bs-placement="left" title="{{__('Create Purchase Order')}}" class="btn btn-sm btn-primary add-btn">
            <i class="ti-plus"></i>
        </a>
    </div>
@endsection
@section('content')
    ...
    @include('general-services.purchase-order.create')
@endsection
...
<script src="{{ asset('js/datatables/gso-purchase-order.js?v='.filemtime(getcwd().'/js/datatables/gso-purchase-order.js').'') }}"></script>
<script src="{{ asset('js/forms/gso-purchase-order.js?v='.filemtime(getcwd().'/js/forms/gso-purchase-order.js').'') }}"></script>
@endpush