<div class="modal form fade" id="group-menu-modal" tabindex="-1" role="dialog" data-bs-keyboard="false" data-bs-backdrop="static" aria-labelledby="issuanceRequestModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            {{ Form::open(array('url' => 'general-services/issuance', 'class'=>'formDtls needs-validation', 'name' => 'issuanceRequestForm')) }}
            @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="fv-row row">
                        <div class="col-sm-4">
                            <div class="form-group m-form__group required">
                                {{ Form::label('employee_id', 'Request By', ['class' => '']) }}
                                {{
                        ...
                        <div class="col-sm-4">
                            <div class="form-group m-form__group required">
                                {{ Form::label('issue_requestor_date', 'Request Date', ['class' => 'required fs-6 fw-bold']) }}
                                {{ 
