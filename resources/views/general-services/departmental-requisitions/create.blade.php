                ...
                <div class="row">
                    ...
                    <div class="col-md-5 border-right space-right">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            @include('general-services.departmental-requisitions.request-details') 
                            <!-- REQUEST DETAILS END -->

                            <!-- ALOB DETAILS START -->
                            @include('general-services.departmental-requisitions.alob-details') 
                            <!-- ALOB DETAILS END -->

                            <!-- ALOB DETAILS START -->
                            @include('general-services.departmental-requisitions.pr-details') 
                            <!-- ALOB DETAILS END -->
                                        ...
                                        <table id="itemRequisitionTable" class="display dataTable table w-100 table-striped mt-4" aria-describedby="itemRequisition_info">
                                            ...
                                            <tfooter>
                                                <tr>
                                                    ...
                                                    <th colspan="3" class="text-start fs-5">{{ __('TOTAL AMOUNT') }}</th>
                                                </tr>
                                            </tfooter>
                                        </table>
                                    </div>
