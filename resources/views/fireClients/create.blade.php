{{ Form::open(array('url' => 'fireclients','id'=>'storePropertyOwnerForm')) }}
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseone" class="accordion-collapse collapse show" aria-labelledby="flush-headingone1" data-bs-parent="#accordionFlushExample">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="form-group">
                                            {{Form::label('owner name',__('Owner Name'),['class'=>'form-label'])}}
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                             ...
                             <div class="col-md-4" id="countryID">
                               <div class="form-group">
...
<script src="{{ asset('js/Bplo/add_bploclients.js') }}?rand={{ rand(000,999) }}"></script>
...
function uploadAttachmentonly(){
	...
	showLoader();
	$.ajax({
	   url : DIR+'fireclients-uploadDocument',
	   type : 'POST',
	   data : formData,
	   ...
	   swalWithBootstrapButtons.fire({
		   ...
		   reverseButtons: true
			...
			if(result.isConfirmed){
				showLoader();
				$.ajax({
				   url :DIR+'fireclients-deleteAttachment', // json datasource
				   type: "POST", 
				   data: {
