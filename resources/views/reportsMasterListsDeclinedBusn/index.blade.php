...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Declined Applications')}}</li>
@endsection
@section('content')
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-auto float-end ms-2"><br>
                                ...
                                <a href="{{ url('export-declined-business') }}" class="btn btn-sm btn-primary" id="btn_download_spreadsheet" title="Download Spreadsheet">
    ...
    <script src="{{ asset('js/ReportsMasterlistsDeclinedBusn.js') }}"></script>
@endsection
