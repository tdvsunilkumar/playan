...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Health Certificate')}}</li>
...
@section('action-btn')
    <div class="float-end">
        ...
        <a href="#" data-size="lg" data-url="{{ url('/healthy-and-safety/health-certificate/store') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Health Certificate')}}" class="btn btn-sm btn-primary">
            <i class="ti-plus"></i>
        </a>
    </div>
@endsection
...
@section('content')
    ...
    <script src="{{ asset('js/hoapphealthcert.js') }}?rand={{ rand(000,999) }}"></script>
@endsection
