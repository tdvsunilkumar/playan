                            ...
                            <div class="px-3 py-2 row align-items-center">
                                ...
                                <div class="col-auto card-meta d-inline-flex align-items-center ml-sm-auto">
                                    <a href="#" class="action-item delete-checklist" data-url="{{route('checklist.destroy',[$task->project_id,$checklist->id])}}">
                                        <i class="ti-trash-alt text-danger"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    @foreach($task->comments as $comment)
                        <div class="list-group-item px-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <a href="#" class="delete-comment" data-url="{{route('comment.destroy',[$task->project_id,$task->id,$comment->id])}}"><i class="ti-trash-alt text-danger"></i></a>
                                </div>
                            </div>
                        </div>
                    @endforeach
