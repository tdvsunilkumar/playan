    ...
    <div class="float-end">
        ...
        <div class="row">
            ...
            <div class="col-md-2 float-end"><br>
                <a href="#" data-size="xxl" data-url="{{ url('/human-resource/employees/store2') }}" data-ajax-popup="true" data-bs-toggle="tooltip" id="addCitizen" title="{{__('Add Employee')}}" class="btn btn-sm btn-primary" data-controls-modal="your_div_id" data-backdrop="static" data-keyboard="false">
                    <i class="ti-plus"></i>
                </a>
            </div>
        </div>
...
<!-- <script src="{{ asset('js/forms/hr-employee.js?v='.filemtime(getcwd().'/js/forms/hr-employee.js').'') }}"></script> -->
@endpush