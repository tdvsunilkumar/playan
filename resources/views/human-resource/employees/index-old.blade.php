    ...
    <div class="float-end">
        ...
        <div class="row">
            ...
            <div class="col-md-2 float-end"><br>
                <a href="javascript:;" data-size="lg" id="addEmployee"  data-bs-toggle="tooltip" data-bs-placement="left" title="{{__('Create Employee')}}" class="btn btn-sm btn-primary add-btn float-end" >
                    <i class="ti-plus"></i>
                </a>
            </div>
        </div>
