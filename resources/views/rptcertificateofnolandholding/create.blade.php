{{ Form::open(array('url' => 'rptcertificateofnolandholding')) }}
    ...
    <div class="modal-body">
                                   ...
                                   <div class="col-xl-12">
                                    <div class="card">
                                        ...
                                        <tr id="ownerdetails"  class="clientdata" style="border: 1px solid #ccc;">
                                            <th style="width: 20px;background:#3ec9d6;color:#fff;">Select</th>
                                            <th style="width: 100px;text-align: left;background:#3ec9d6;color:#fff;">Owner Name</th>
                                            <th style="width: 200px;text-align: left;background:#3ec9d6;color:#fff;">Owner Address</th>
                                        ...
                                        <tr id="ownerdetails"  class="clientdata" style="border: 1px solid #ccc;">
                                           ...
                                           <td style="width: 20px;"><input type="radio" name="rpc_owner_code2" value="{{$val->clientsId}}" class="clientdata" checked></td>
                                            <td style="width: 20px;">{{$val->full_name}}</td>
                                            <td style="width: 100px;text-align: left;">{{$val->rpo_address_house_lot_no}} {{$val->rpo_address_street_name}} {{$val->rpo_address_subdivision}}</td>
                                            <td style="width: 200px;text-align: left;">{{$val->p_mobile_no}}</td>
                                            <td style="width: 200px;text-align: left;">{{$val->p_email_address}}</td>
                                        </tr>
                                        @endforeach
                                       @endif
                                       </tbody>  
       ...
       <style>
        table tr:hover {
                ...
                select[name="new_Property_details_length"] {
                                        ...
                                        <div class="card-body table-border-style">
                                            <div class="table-responsive" style="width: 1278px;">
                                                <table class="table" id="new_Property_details" width="100%">
                                                    <thead>
                                                        <tr id="partial"  style="border: 1px solid #ccc;background:#3ec9d6;color:#fff;">
                                                            <th>No.</th>
    ...
    function ShowHideDiv(chkPassport) {
     ...
     <div id="myDiv" >
        ...
        <div class="row" style="margin-top: 10px;padding-top: 10px;background: #e6d4d4;">
            <div class="col-md-11" style="width: 95.86667%;">
              <div class="form-group" id="rpc_owner_code_group">
                    {{ Form::label('rpc_owner_code', __('Taxpayer Name'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                    <div class="form-icon-user">
                       {{ Form::select('rpc_owner_code',$arrRequestorTaxpayer,$data->rpc_owner_code, array('class' => 'form-control 
                        ','id'=>'rpc_owner_code','required'=>'required')) }}
                      
                    </div>
                    <span class="validate-err" id="err_rpc_owner_code"></span>
                </div>
            </div> 
            <div class="col-md-1" style="display: contents;">
              <div class="form-group">
                    ...
                    <div class="form-icon-user">
                        <!-- <a href="#" class="btn btn-sm btn-primary" id="refresh" style="font-size: 16px;padding: 4px 8px;margin-top: 9px;">
            ...
            <div class="col-md-7" style="width: 62.84333%;">
              <div class="form-group" id="rpc_requestor_code_group">
                    ...
                    <div class="form-icon-user">
                        {{ Form::select('rpc_requestor_code',$arrRequestor,$data->rpc_requestor_code, array('class' => 'form-control 
                        ','id'=>'rpc_requestor_code','required'=>'required','style'=>'padding:5px;')) }}
            ...
            <div class="col-md-2" style="padding-left: 27px;width: 17.67%;">
              <div class="form-group">
            ...
            <div class="col-md-4">
              <div class="form-group" id="rpc_or_no_group">
                    ...
                    <div class="form-icon-user">
                        {{ Form::select('rpc_or_no',$arrOrnumber,$data->rpc_or_no, array('class' => 'form-control 
            ...
            <div class="col-md-4">
              <div class="form-group">
                    {{ Form::label('rpc_or_amount', __('O.R. Amount'),['class'=>'form-label']) }}
                    <div class="form-icon-user">
...
<script type="text/javascript">
    ...
    $("form").submit(function (event) {
            var selectField = $("#rpc_owner_code");
            var errorSpan = $("#err_rpc_owner_code");
            if (selectField.val() === "") {
