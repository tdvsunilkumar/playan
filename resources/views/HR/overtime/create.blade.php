	...
	<div class="row">
		 ...
		 <div class="col-md-4">
			<div class="form-group">
				...
				<div class="form-icon-user">
					{{ Form::text('hrot_application_no',
						$data->hrot_application_no, 
						array(
							'class' => 'form-control disabled-field',
							(($data->hro_status) >= 1 ) ? 'readonly':'',
							'id'=>'hrot_application_no'
							)) }}
				</div>
	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<div class="form-icon-user">
					{{ Form::time('hrot_start_time',
						$data->hrot_start_time, 
						array(
							'class' => 'form-control ',
							'id'=>'hrot_start_time',
							(($data->hro_status) >= 1 ) ? 'readonly':'',
	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<div class="form-icon-user">
					{{ Form::text('hrot_considered_hours',
						$data->hrot_considered_hours, 
						array(
							'class' => 'form-control disabled-field',
							'id'=>'hrot_considered_hours',
							(($data->hro_status) >= 1 ) ? 'readonly':'',
							'required'=>'required'
							)) }}
				</div>
	   ...
	   <div class="col-md-4">
			<div class="form-group">
				...
				<div class="form-icon-user">
					{{ Form::select('hrot_following_day',
						$arrDaystype,
						$data->hrot_following_day, 
						array(
							'class' => 'form-control select3',
							'id'=>'hrot_following_day',
							(($data->hro_status) >= 1 ) ? 'readonly':'',
							'required'=>'required'
							)) }}
				</div>
