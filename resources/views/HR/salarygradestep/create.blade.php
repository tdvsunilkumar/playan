{{ Form::open(array('url' => 'hr-salary-grade-step','class'=>'formDtls','id'=>'submitLandUnitValueForm')) }}
...
<div class="modal-body">
                    <div class="row">
                         <div class="col-md-12">
                            <div class="form-group">
                                {{ Form::label('hrsgs_description', __('Salary Grade Step'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                <span class="validate-err">{{ $errors->first('hrsgs_description') }}</span>
                                <div class="form-icon-user">
                                    {{ Form::text('hrsgs_description',$data->hrsgs_description, array('class' => 'form-control','id'=>'hrsgs_description','required'=>'required')) }}
                                </div>
                                <span class="validate-err" id="err_hrsgs_description"></span>
                            </div>
                        </div>
                    </div>
 ...
 <script type="text/javascript">
    ...
    $('#savechanges').click(function (e) {
        ...
        $.ajax({
            url :DIR+'hr-salary-grade-step/formValidation', // json datasource
            type: "POST", 
