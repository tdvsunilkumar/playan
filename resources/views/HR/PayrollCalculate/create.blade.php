<div class="container-fluid">
    {{ Form::open(array('url' => 'hr-payroll-calculate/store','class'=>'formDtls create-form', 'files' => true)) }}
                        ...
                        <div class="accordion-item">
                            <div id="flush-employee" class="accordion-collapse collapse show">
                                <table class="table" id="employee_list">
                                    ...
                                    <tbody>
                                        @if(isset($data->processed_emp))
                                            @foreach($data->processed_emp as $emp)
                                            <tr data-emp_id="{{$emp->appointment->hr_emp_id}}">
                                                <td >{{$emp->appointment->employee->fullname}}</td>
                                            </tr>
                                            @endforeach
                                        @endif
                                    </tbody>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                {{ Form::text('hr_designation','', array('class' => 'form-control','id'=>'hr_designation','disabled')) }}
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                            {{ Form::text('hrpr_monthly_rate','', array('class' => 'form-control','id'=>'hrpr_monthly_rate','disabled')) }}
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="form-icon-user col-md-6">
                                                    {{ Form::text('hrpr_aut','', array('class' => 'form-control','id'=>'hrpr_aut','disabled')) }}
                                                </div>
                                                <div class="form-icon-user col-md-6">
                                                    {{ Form::text('hrpr_aut_compute','', array('class' => 'form-control','id'=>'hrpr_aut_compute','disabled')) }}
                                                </div>
                                            </div>
        ...
        <div class="modal-footer">
                @if($data->hrpr_is_processed)
                <a href="{{route('hr.payroll.calculate.print.general',['payroll'=>$data->id])}}" class="btn btn-primary" target="_blank">
                        <i class="fa fa-print icon" ></i>
                        {{ ($data->id)>0?__('Print'):__('Print')}}
                    </a>
                @endif
                @if($data->hrpr_is_processed != 1)
                    @if($data->id)
                    <button class="btn btn-primary" id="process_btn" type="submit" value="submit"  >
                        <i class="fa fa-save icon" ></i>
                        {{ ($data->id)>0?__('Process'):__('Process')}}
                    </button>
                    @endif
                    <button class="btn btn-primary " type="submit" value="save">
                        <i class="fa fa-save icon" ></i>
                        {{ ($data->id)>0?__('Save'):__('Save')}}
                    </button>
                @endif
