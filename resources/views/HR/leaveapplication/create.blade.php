{{ Form::open(array('url' => 'hr-leave-application','class'=>'formDtls','id'=>'submitLandUnitValueForm')) }}
                    ...
                    <div class="row">
                         <div class="col-md-12">
                            <div class="form-group">
                                {{ Form::label('hrla_description', __('Leave Code'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                <span class="validate-err">{{ $errors->first('hrla_description') }}</span>
                                <div class="form-icon-user">
                                    {{ Form::text('hrla_description',$data->hrla_description, array('class' => 'form-control','id'=>'hrla_description','required'=>'required')) }}
                                </div>
                                <span class="validate-err" id="err_hrla_description"></span>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $('#savechanges').click(function (e) {
        ...
        $.ajax({
            url :DIR+'hr-leave-application/formValidation', // json datasource
            type: "POST", 
