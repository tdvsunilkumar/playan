{{ Form::open(array('url' => 'hr-occupation-level','class'=>'formDtls','id'=>'submitLandUnitValueForm')) }}
...
<div class="modal-body">
                    <div class="row">
                         <div class="col-md-12">
                            <div class="form-group">
                                {{ Form::label('hrol_description', __('Occupation Level'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                <span class="validate-err">{{ $errors->first('hrol_description') }}</span>
                                <div class="form-icon-user">
                                    {{ Form::text('hrol_description',$data->hrol_description, array('class' => 'form-control','id'=>'hrol_description','required'=>'required')) }}
                                </div>
                                <span class="validate-err" id="err_hrol_description"></span>
                            </div>
                        </div>
                    </div>
 ...
 <script type="text/javascript">
    ...
    $('#savechanges').click(function (e) {
        ...
        $.ajax({
            url :DIR+'hr-occupation-level/formValidation', // json datasource
            type: "POST", 
