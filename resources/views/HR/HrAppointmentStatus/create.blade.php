{{ Form::open(array('url' => 'hr-appointment-status','class'=>'formDtls','id'=>'submitLandUnitValueForm')) }}
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				{{ Form::label('hras_description', __('Description'),['class'=>'form-label']) }}<span class="text-danger">*</span>
				<div class="form-icon-user">
					{{ Form::text('hras_description',$data->hras_description, array('class' => 'form-control','id'=>'hras_description','required'=>'required')) }}
				</div>
				<span class="validate-err" id="err_hras_description"></span>
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group">
...
<script type="text/javascript">
    ...
    $('#savechanges').click(function (e) {
        ...
        $.ajax({
            url :DIR+'hr-appointment-status/formValidation', // json datasource
            type: "POST", 
