{{ Form::open(array('url' => 'hr-employee-status','class'=>'formDtls','id'=>'submitLandUnitValueForm')) }}
                    ...
                    <div class="row">
                         <div class="col-md-12">
                            <div class="form-group">
                                {{ Form::label('hres_description', __('Employee Status'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                <span class="validate-err">{{ $errors->first('hres_description') }}</span>
                                <div class="form-icon-user">
                                    {{ Form::text('hres_description',$data->hres_description, array('class' => 'form-control','id'=>'hres_description','required'=>'required')) }}
                                </div>
                                <span class="validate-err" id="err_hres_description"></span>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $('#savechanges').click(function (e) {
        ...
        $.ajax({
            url :DIR+'hr-employee-status/formValidation', // json datasource
            type: "POST", 
