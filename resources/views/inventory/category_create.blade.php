{{ Form::open(array('url' => 'inventory-category/store','id'=>'inventorycat')) }}
<style>
.modal-content {
   position: absolute;
   float: left;
                       ...
                       <div class="col-md-12">
                          <div class="form-group">
                             ...
                             <div class="form-icon-user">
                                {{ Form::text('inv_category','', array('class' => 'form-control', 'placeholder' => 'Category Name','required'=>'required')) }}
                             </div>
