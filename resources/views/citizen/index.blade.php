...
@section('action-btn')
    <div class="float-end">
        <a href="javascript:;" data-size="lg" data-bs-toggle="tooltip" title="{{__('Create Citizen')}}" class="btn btn-sm btn-primary add-btn">
            <i class="ti-plus"></i>
        </a>
    </div>
@endsection
...
@section('content')
    ...
    @include('citizen.create')
@endsection

@push('scripts')
    <script src="{{ asset('js/datatables/citizen.js') }}" type="text/javascript"></script>
    <script src="{{ asset('js/forms/acctg-fund-code.js') }}" type="text/javascript"></script>
@endpush